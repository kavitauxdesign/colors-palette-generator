var Jo=Object.defineProperty;var Qo=(n,e,t)=>e in n?Jo(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var F=(n,e,t)=>Qo(n,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(o){if(o.ep)return;o.ep=!0;const r=t(o);fetch(o.href,r)}})();const L={DISALLOWED_COLORS:new Set,HEX_6_REGEX:/^#[0-9A-F]{6}$/,MAX_UNIQUE_COLOR_ATTEMPTS:500,MAX_PALETTE_COLORS:24,DEFAULT_TARGET_COLORS:["#9EBB89","#6EC5CE","#E7AA6E","#B1BDCD","#6BBDB6","#B88965","#DCC9B3","#A8AA98","#6B8F71","#29A9CA","#B86346","#5BAB9C"],CARD_COPY_TOOLTIP_DEFAULT:"Copiar HEX",HISTORY_COPY_TOOLTIP_DEFAULT:"Copiar paleta",ADD_DISABLED_LABEL:"Esperemos, que con 24 colores la paleta esté completa☝️",DEFAULT_PALETTE_SIZE:9,DEFAULT_PALETTE_BASE_MODE:"color",DEFAULT_TEMPERATURE:{warm:!0,cool:!1},DEFAULT_COLOR_BASE:"#9EBB89",DEFAULT_COLOR_PALETTE_TYPE:"monochromatic",DEFAULT_MONOCHROMATIC_GENERATION_MODE:"automatic",DEFAULT_ANALOGOUS_SEPARATION_MODE:"medium",DEFAULT_BRIGHTNESS:65,DEFAULT_SATURATION:100,LOW_SATURATION_FALLBACK_THRESHOLD:15,LOW_SATURATION_TEMPERATURE_UNLOCK_BRIGHTNESS:30};window.AppConstants=L;const Oe=new Map;function Ha(n,e){var t;return Oe.has(n)||Oe.set(n,new Set),(t=Oe.get(n))==null||t.add(e),()=>{za(n,e)}}function za(n,e){const t=Oe.get(n);t&&(t.delete(e),t.size===0&&Oe.delete(n))}function Fa(n,e={}){const t=Oe.get(n);!t||t.size===0||t.forEach(a=>{try{a(e)}catch(o){console.error(`AppEventBus listener failed for "${n}".`,o)}})}const Da={on:Ha,off:za,emit:Fa};window.AppEventBus=Da;const it=new Map;function er(n,e={}){if(!n||typeof n!="string")throw new Error("AppRegistry.register requires a string id.");const t={id:n,...e||{}};return it.set(n,t),t}function nr(n){return it.get(n)||null}function tr(){return Array.from(it.values())}const lt={register:er,get:nr,list:tr};window.AppRegistry=lt;async function Na(n){const e=String(n??"");if(navigator.clipboard&&typeof navigator.clipboard.writeText=="function")try{await navigator.clipboard.writeText(e);return}catch{}const t=document.createElement("textarea");t.value=e,t.style.position="fixed",t.style.left="-9999px",t.style.top="0",t.style.opacity="0",document.body.appendChild(t),t.focus(),t.select();const a=document.execCommand("copy");if(t.remove(),!a)throw new Error("Clipboard copy failed")}const _a={writeText:Na};window.AppClipboard=_a;window.copyTextToClipboard=Na;function Ue(n,e){let t=n.length,a,o,r=!1,s=!1;Array.isArray(n[0])?a=n:(a=[n],t=a.length,r=!0),Array.isArray(e[0])?o=e:(o=e.length>0?e.map(d=>[d]):[[]],s=!0);let i=o[0].length,l=o[0].map((d,u)=>o.map(m=>m[u])),c=a.map(d=>l.map(u=>{let m=0;if(!Array.isArray(d)){for(let p of u)m+=d*p;return m}for(let p=0;p<d.length;p++)m+=d[p]*(u[p]||0);return m}));return t===1&&r&&(c=c[0]),i===1&&s?t===1&&r?c[0]:c.map(d=>d[0]):c}function On(n,e){return n[0]*e[0]+n[1]*e[1]+n[2]*e[2]}function O(n,e,t=[0,0,0]){const a=On(n,e[0]),o=On(n,e[1]),r=On(n,e[2]);return t[0]=a,t[1]=o,t[2]=r,t}function Ne(n){return pe(n)==="string"}function pe(n){return(Object.prototype.toString.call(n).match(/^\[object\s+(.*?)\]$/)[1]||"").toLowerCase()}function ct(n,{precision:e=16,unit:t}){return v(n)?"none":(n=+dt(n,e),n+(t??""))}function v(n){return n===null}function k(n){return v(n)?0:n}function dt(n,e){if(n===0)return 0;let t=~~n,a=0;t&&e&&(a=~~Math.log10(Math.abs(t))+1);const o=10**(e-a);return Math.floor(n*o+.5)/o}function Ke(n,e,t){return isNaN(n)?e:isNaN(e)?n:n+(e-n)*t}function Va(n,e,t){return(t-n)/(e-n)}function qn(n,e,t){return!n||!e||n===e||n[0]===e[0]&&n[1]===e[1]||isNaN(t)||t===null?t:Ke(e[0],e[1],Va(n[0],n[1],t))}function In(n,e,t){return Math.max(Math.min(t,e),n)}function An(n,e){return Math.sign(n)===Math.sign(e)?n:-n}function H(n,e){return An(Math.abs(n)**e,n)}function ut(n,e){return e===0?0:n/e}function Ga(n,e,t=0,a=n.length){for(;t<a;){const o=t+a>>1;n[o]<e?t=o+1:a=o}return t}function ke(n,e){var a;if(n instanceof e)return!0;const t=e.name;for(;n;){const o=Object.getPrototypeOf(n),r=(a=o==null?void 0:o.constructor)==null?void 0:a.name;if(r===t)return!0;if(!r||r==="Object")return!1;n=o}return!1}var ar=Object.freeze({__proto__:null,bisectLeft:Ga,clamp:In,copySign:An,interpolate:Ke,interpolateInv:Va,isInstance:ke,isNone:v,isString:Ne,mapRange:qn,multiplyMatrices:Ue,multiply_v3_m3x3:O,serializeNumber:ct,skipNone:k,spow:H,toPrecision:dt,type:pe,zdiv:ut});class or{add(e,t,a){if(typeof arguments[0]!="string"){for(var e in arguments[0])this.add(e,arguments[0][e],arguments[1]);return}(Array.isArray(e)?e:[e]).forEach(function(o){this[o]=this[o]||[],t&&this[o][a?"unshift":"push"](t)},this)}run(e,t){this[e]=this[e]||[],this[e].forEach(function(a){a.call(t&&t.context?t.context:t,t)})}}const ge=new or;var wa,La,Oa,Q={gamut_mapping:"css",precision:5,deltaE:"76",verbose:((Oa=(La=(wa=globalThis==null?void 0:globalThis.process)==null?void 0:wa.env)==null?void 0:La.NODE_ENV)==null?void 0:Oa.toLowerCase())!=="test",warn:function(e){var t,a;this.verbose&&((a=(t=globalThis==null?void 0:globalThis.console)==null?void 0:t.warn)==null||a.call(t,e))}};class Tt{constructor(e,t){F(this,"type");F(this,"coordMeta");F(this,"coordRange");F(this,"range");if(typeof e=="object"&&(this.coordMeta=e),t&&(this.coordMeta=t,this.coordRange=t.range??t.refRange),typeof e=="string"){let a=e.trim().match(/^(?<type><[a-z]+>)(\[(?<min>-?[.\d]+),\s*(?<max>-?[.\d]+)\])?$/);if(!a)throw new TypeError(`Cannot parse ${e} as a type definition.`);this.type=a.groups.type;let{min:o,max:r}=a.groups;(o||r)&&(this.range=[+o,+r])}}get computedRange(){return this.range?this.range:this.type==="<percentage>"?this.percentageRange():this.type==="<angle>"?[0,360]:null}get unit(){return this.type==="<percentage>"?"%":this.type==="<angle>"?"deg":""}resolve(e){if(this.type==="<angle>")return e;let t=this.computedRange,a=this.coordRange;return this.type==="<percentage>"&&(a??(a=this.percentageRange())),qn(t,a,e)}serialize(e,t){let a=this.type==="<percentage>"?this.percentageRange(100):this.computedRange,o=this.unit;return e=qn(this.coordRange,a,e),ct(e,{unit:o,precision:t})}toString(){let e=this.type;if(this.range){let[t="",a=""]=this.range;e+=`[${t},${a}]`}return e}percentageRange(e=1){let t;return this.coordMeta&&this.coordMeta.range||this.coordRange&&this.coordRange[0]>=0?t=[0,1]:t=[-1,1],[t[0]*e,t[1]*e]}static get(e,t){return ke(e,this)?e:new this(e,t)}}const Rn=Symbol("instance");class pn{constructor(e,t=e.space){F(this,"type");F(this,"name");F(this,"spaceCoords");F(this,"coords");F(this,"id");F(this,"alpha");e[Rn]=this,this.type="function",this.name="color",Object.assign(this,e),this.space=t,this.type!=="custom"&&(this.spaceCoords=Object.values(t.coords),this.coords||(this.coords=this.spaceCoords.map(a=>{let o=["<number>","<percentage>"];return a.type==="angle"&&o.push("<angle>"),o})),this.coords=this.coords.map((a,o)=>{let r=this.spaceCoords[o];return typeof a=="string"&&(a=a.trim().split(/\s*\|\s*/)),a.map(s=>Tt.get(s,r))}))}serializeCoords(e,t,a){return a=e.map((o,r)=>Tt.get((a==null?void 0:a[r])??this.coords[r][0],this.spaceCoords[r])),e.map((o,r)=>a[r].serialize(o,t))}coerceCoords(e,t){return Object.entries(this.space.coords).map(([a,o],r)=>{let s=e[r];if(v(s)||isNaN(s))return s;let i=t[r],l=this.coords[r].find(c=>c.type==i);if(!l){let c=o.name||a;throw new TypeError(`${i??(s==null?void 0:s.raw)??s} not allowed for ${c} in ${this.name}()`)}return s=l.resolve(s),l.range&&(t[r]=l.toString()),s})}canSerialize(){return this.type==="function"||this.serialize}parse(e){return null}static get(e,...t){return!e||ke(e,this)?e:e[Rn]?e[Rn]:new pn(e,...t)}}const W={D50:[.3457/.3585,1,(1-.3457-.3585)/.3585],D65:[.3127/.329,1,(1-.3127-.329)/.329]};function Wn(n){return Array.isArray(n)?n:W[n]}function hn(n,e,t,a={}){if(n=Wn(n),e=Wn(e),!n||!e)throw new TypeError(`Missing white point to convert ${n?"":"from"}${!n&&!e?"/":""}${e?"":"to"}`);if(n===e)return t;let o={W1:n,W2:e,XYZ:t,options:a};if(ge.run("chromatic-adaptation-start",o),o.M||(o.W1===W.D65&&o.W2===W.D50?o.M=[[1.0479297925449969,.022946870601609652,-.05019226628920524],[.02962780877005599,.9904344267538799,-.017073799063418826],[-.009243040646204504,.015055191490298152,.7518742814281371]]:o.W1===W.D50&&o.W2===W.D65&&(o.M=[[.955473421488075,-.02309845494876471,.06325924320057072],[-.0283697093338637,1.0099953980813041,.021041441191917323],[.012314014864481998,-.020507649298898964,1.330365926242124]])),ge.run("chromatic-adaptation-end",o),o.M)return O(o.XYZ,o.M);throw new TypeError("Only Bradford CAT with white points D50 and D65 supported for now.")}function ja(n,e){var r,s,i;let t={str:(r=String(n))==null?void 0:r.trim(),options:e};if(ge.run("parse-start",t),t.color)return t.color;t.parsed=sr(t.str);let a,o=t.options?t.options.parseMeta??t.options.meta:null;if(t.parsed){let l=t.parsed.name,c,d,u=t.parsed.args,m=u.map((f,g)=>{var C;return(C=t.parsed.argMeta[g])==null?void 0:C.type});if(l==="color"){let f=u.shift();m.shift();let g=f.startsWith("--")?f.substring(2):`--${f}`,C=[f,g];if(c=b.findFormat({name:l,id:C,type:"function"}),!c){let x,S=f in b.registry?f:g;if(S in b.registry){let I=(i=(s=b.registry[S].formats)==null?void 0:s.color)==null?void 0:i.id;I&&(x=`Did you mean ${n.replace("color("+f,"color("+I)}?`)}throw new TypeError(`Cannot parse ${t.str}. `+(x??"Missing a plugin?"))}d=c.space,c.id.startsWith("--")&&!f.startsWith("--")&&Q.warn(`${d.name} is a non-standard space and not currently supported in the CSS spec. Use prefixed color(${c.id}) instead of color(${f}).`),f.startsWith("--")&&!c.id.startsWith("--")&&Q.warn(`${d.name} is a standard space and supported in the CSS spec. Use color(${c.id}) instead of prefixed color(${f}).`)}else c=b.findFormat({name:l,type:"function"}),d=c.space;o&&Object.assign(o,{format:c,formatId:c.name,types:m,commas:t.parsed.commas});let p=1;t.parsed.lastAlpha&&(p=t.parsed.args.pop(),o&&(o.alphaType=m.pop()));let h=c.coords.length;if(u.length!==h)throw new TypeError(`Expected ${h} coordinates for ${d.id} in ${t.str}), got ${u.length}`);u=c.coerceCoords(u,m),a={spaceId:d.id,coords:u,alpha:p}}else e:for(let l of b.all)for(let c in l.formats){let d=l.formats[c];if(d.type!=="custom"||d.test&&!d.test(t.str))continue;let u=l.getFormat(d),m=u.parse(t.str);if(m){o&&Object.assign(o,{format:u,formatId:c}),a=m;break e}}if(!a)throw new TypeError(`Could not parse ${n} as a color. Missing a plugin?`);return a.alpha=v(a.alpha)?a.alpha:a.alpha===void 0?1:In(0,a.alpha,1),a}const Ua={"%":.01,deg:1,grad:.9,rad:180/Math.PI,turn:360},gn={function:/^([a-z]+)\(((?:calc\(NaN\)|.)+?)\)$/i,number:/^([-+]?(?:[0-9]*\.)?[0-9]+(e[-+]?[0-9]+)?)$/i,unitValue:RegExp(`(${Object.keys(Ua).join("|")})$`),singleArgument:/\/?\s*(none|NaN|calc\(NaN\)|[-+\w.]+(?:%|deg|g?rad|turn)?)/g};function rr(n){var o;let e={},t=(o=n.match(gn.unitValue))==null?void 0:o[0],a=e.raw=n;return t?(e.type=t==="%"?"<percentage>":"<angle>",e.unit=t,e.unitless=Number(a.slice(0,-t.length)),a=e.unitless*Ua[t]):gn.number.test(a)?(a=Number(a),e.type="<number>"):a==="none"?a=null:a==="NaN"||a==="calc(NaN)"?(a=NaN,e.type="<number>"):e.type="<ident>",{value:a,meta:e}}function sr(n){if(!n)return;n=n.trim();let e=n.match(gn.function);if(e){let t=[],a=[],o=!1,r=e[1].toLowerCase(),s=e[2].replace(gn.singleArgument,(i,l)=>{let{value:c,meta:d}=rr(l);return(i.startsWith("/")||r!=="color"&&t.length===3)&&(o=!0),t.push(c),a.push(d),""});return{name:r,args:t,argMeta:a,lastAlpha:o,commas:s.includes(","),rawName:e[1],rawArgs:e[2]}}}function A(n,e){if(Array.isArray(n))return n.map(a=>A(a,e));if(!n)throw new TypeError("Empty color reference");Ne(n)&&(n=ja(n,e));let t=n.space||n.spaceId;return typeof t=="string"&&(n.space=b.get(t)),n.alpha===void 0&&(n.alpha=1),n}const ir=75e-6,Z=class Z{constructor(e){var o;this.id=e.id,this.name=e.name,this.base=e.base?Z.get(e.base):null,this.aliases=e.aliases,this.base&&(this.fromBase=e.fromBase,this.toBase=e.toBase);let t=e.coords??this.base.coords;for(let r in t)"name"in t[r]||(t[r].name=r);this.coords=t;let a=e.white??this.base.white??"D65";this.white=Wn(a),this.formats=e.formats??{};for(let r in this.formats){let s=this.formats[r];s.type||(s.type="function"),s.name||(s.name=r)}(o=this.formats.color)!=null&&o.id||(this.formats.color={...this.formats.color??{},id:e.cssId||this.id}),e.gamutSpace?this.gamutSpace=e.gamutSpace==="self"?this:Z.get(e.gamutSpace):this.isPolar?this.gamutSpace=this.base:this.gamutSpace=this,this.gamutSpace.isUnbounded&&(this.inGamut=(r,s)=>!0),this.referred=e.referred,Object.defineProperty(this,"path",{value:lr(this).reverse(),writable:!1,enumerable:!0,configurable:!0}),ge.run("colorspace-init-end",this)}inGamut(e,{epsilon:t=ir}={}){if(!this.equals(this.gamutSpace))return e=this.to(this.gamutSpace,e),this.gamutSpace.inGamut(e,{epsilon:t});let a=Object.values(this.coords);return e.every((o,r)=>{let s=a[r];if(s.type!=="angle"&&s.range){if(v(o))return!0;let[i,l]=s.range;return(i===void 0||o>=i-t)&&(l===void 0||o<=l+t)}return!0})}get isUnbounded(){return Object.values(this.coords).every(e=>!("range"in e))}get cssId(){var e,t;return((t=(e=this.formats)==null?void 0:e.color)==null?void 0:t.id)||this.id}get isPolar(){for(let e in this.coords)if(this.coords[e].type==="angle")return!0;return!1}getFormat(e){if(!e)return null;e==="default"?e=Object.values(this.formats)[0]:typeof e=="string"&&(e=this.formats[e]);let t=pn.get(e,this);return t!==e&&e.name in this.formats&&(this.formats[e.name]=t),t}equals(e){return e?this===e||this.id===e||this.id===e.id:!1}to(e,t){if(arguments.length===1){const i=A(e);[e,t]=[i.space,i.coords]}if(e=Z.get(e),this.equals(e))return t;t=t.map(i=>v(i)?0:i);let a=this.path,o=e.path,r,s;for(let i=0;i<a.length&&a[i].equals(o[i]);i++)r=a[i],s=i;if(!r)throw new Error(`Cannot convert between color spaces ${this} and ${e}: no connection space was found`);for(let i=a.length-1;i>s;i--)t=a[i].toBase(t);for(let i=s+1;i<o.length;i++)t=o[i].fromBase(t);return t}from(e,t){if(arguments.length===1){const a=A(e);[e,t]=[a.space,a.coords]}return e=Z.get(e),e.to(this,t)}toString(){return`${this.name} (${this.id})`}getMinCoords(){let e=[];for(let t in this.coords){let a=this.coords[t],o=a.range||a.refRange;e.push((o==null?void 0:o.min)??0)}return e}static get all(){return[...new Set(Object.values(Z.registry))]}static register(e,t){if(arguments.length===1&&(t=arguments[0],e=t.id),t=this.get(t),this.registry[e]&&this.registry[e]!==t)throw new Error(`Duplicate color space registration: '${e}'`);if(this.registry[e]=t,arguments.length===1&&t.aliases)for(let a of t.aliases)this.register(a,t);return t}static get(e,...t){if(!e||ke(e,this))return e;if(pe(e)==="string"){let o=Z.registry[e.toLowerCase()];if(!o)throw new TypeError(`No color space found with id = "${e}"`);return o}if(t.length)return Z.get(...t);throw new TypeError(`${e} is not a valid color space`)}static findFormat(e,t=Z.all){if(!e)return null;typeof e=="string"&&(e={name:e});for(let a of t)for(let[o,r]of Object.entries(a.formats)){r.name??(r.name=o),r.type??(r.type="function");let s=(!e.name||r.name===e.name)&&(!e.type||r.type===e.type);if(e.id){let i=r.ids||[r.id],l=Array.isArray(e.id)?e.id:[e.id];s&&(s=l.some(c=>i.includes(c)))}if(s){let i=pn.get(r,a);return i!==r&&(a.formats[r.name]=i),i}}return null}static resolveCoord(e,t){var l;let a=pe(e),o,r;if(a==="string"?e.includes(".")?[o,r]=e.split("."):[o,r]=[,e]:Array.isArray(e)?[o,r]=e:(o=e.space,r=e.coordId),o=Z.get(o),o||(o=t),!o)throw new TypeError(`Cannot resolve coordinate reference ${e}: No color space specified and relative references are not allowed here`);if(a=pe(r),a==="number"||a==="string"&&r>=0){let c=Object.entries(o.coords)[r];if(c)return{space:o,id:c[0],index:r,...c[1]}}o=Z.get(o);let s=r.toLowerCase(),i=0;for(let c in o.coords){let d=o.coords[c];if(c.toLowerCase()===s||((l=d.name)==null?void 0:l.toLowerCase())===s)return{space:o,id:c,index:i,...d};i++}throw new TypeError(`No "${r}" coordinate found in ${o.name}. Its coordinates are: ${Object.keys(o.coords).join(", ")}`)}};F(Z,"registry",{}),F(Z,"DEFAULT_FORMAT",{type:"functions",name:"color"});let b=Z;function lr(n){let e=[n];for(let t=n;t=t.base;)e.push(t);return e}var V=new b({id:"xyz-d65",name:"XYZ D65",coords:{x:{refRange:[0,1],name:"X"},y:{refRange:[0,1],name:"Y"},z:{refRange:[0,1],name:"Z"}},white:"D65",formats:{color:{ids:["xyz-d65","xyz"]}},aliases:["xyz"]});class U extends b{constructor(e){e.coords||(e.coords={r:{range:[0,1],name:"Red"},g:{range:[0,1],name:"Green"},b:{range:[0,1],name:"Blue"}}),e.base||(e.base=V),e.toXYZ_M&&e.fromXYZ_M&&(e.toBase??(e.toBase=t=>{let a=O(t,e.toXYZ_M);return this.white!==this.base.white&&(a=hn(this.white,this.base.white,a)),a}),e.fromBase??(e.fromBase=t=>(t=hn(this.base.white,this.white,t),O(t,e.fromXYZ_M)))),e.referred??(e.referred="display"),super(e)}}function $a(n,e={}){if(Array.isArray(n))return n.map(l=>$a(l,e));let{cssProperty:t="background-color",element:a,...o}=e,r=null;try{return A(n,o)}catch(l){r=l}let{CSS:s,getComputedStyle:i}=globalThis;if(Ne(n)&&a&&s&&i&&s.supports(t,n)){let l=a.style[t];n!==l&&(a.style[t]=n);let c=i(a).getPropertyValue(t);if(n!==l&&(a.style[t]=l),c!==n)try{return A(c,o)}catch(d){r=d}else r={message:"Color value is a valid CSS color, but it could not be resolved :("}}return e.errorMeta&&(e.errorMeta.error=r),null}function nn(n,e){n=A(n);let t=b.get(e,e==null?void 0:e.space),a=e==null?void 0:e.precision,o;return!t||n.space.equals(t)?o=n.coords.slice():o=t.from(n),a===void 0?o:o.map(r=>dt(r,a))}function K(n,e){if(n=A(n),e==="alpha")return n.alpha??1;let{space:t,index:a}=b.resolveCoord(e,n.space);return nn(n,t)[a]}function mt(n,e,t,a){return n=A(n),Array.isArray(e)&&([e,t,a]=[n.space,e,t]),e=b.get(e),n.coords=e===n.space?t.slice():e.to(n.space,t),a!==void 0&&(n.alpha=a),n}mt.returns="color";function de(n,e,t){if(n=A(n),arguments.length===2&&pe(arguments[1])==="object"){let a=arguments[1];for(let o in a)de(n,o,a[o])}else if(typeof t=="function"&&(t=t(K(n,e))),e==="alpha")n.alpha=t;else{let{space:a,index:o}=b.resolveCoord(e,n.space),r=nn(n,a);r[o]=t,mt(n,a,r)}return n}de.returns="color";var pt=new b({id:"xyz-d50",name:"XYZ D50",white:"D50",base:V,fromBase:n=>hn(V.white,"D50",n),toBase:n=>hn("D50",V.white,n)});const cr=216/24389,Et=24/116,an=24389/27;let kn=W.D50;var J=new b({id:"lab",name:"Lab",coords:{l:{refRange:[0,100],name:"Lightness"},a:{refRange:[-125,125]},b:{refRange:[-125,125]}},white:kn,base:pt,fromBase(n){let t=n.map((s,i)=>s/kn[i]).map(s=>s>cr?Math.cbrt(s):(an*s+16)/116),a=116*t[1]-16,o=500*(t[0]-t[1]),r=200*(t[1]-t[2]);return[a,o,r]},toBase(n){let[e,t,a]=n,o=[];return o[1]=(e+16)/116,o[0]=t/500+o[1],o[2]=o[1]-a/200,[o[0]>Et?Math.pow(o[0],3):(116*o[0]-16)/an,n[0]>8?Math.pow((n[0]+16)/116,3):n[0]/an,o[2]>Et?Math.pow(o[2],3):(116*o[2]-16)/an].map((s,i)=>s*kn[i])},formats:{lab:{coords:["<percentage> | <number>","<number> | <percentage>","<number> | <percentage>"]}}});function te(n){return typeof n!="number"?n:(n%360+360)%360}function qa(n,e){let[t,a]=e,o=v(t),r=v(a);if(o&&r)return[t,a];if(o?t=a:r&&(a=t),n==="raw")return e;t=te(t),a=te(a);let s=a-t;return n==="increasing"?s<0&&(a+=360):n==="decreasing"?s>0&&(t+=360):n==="longer"?-180<s&&s<180&&(s>0?t+=360:a+=360):n==="shorter"&&(s>180?t+=360:s<-180&&(a+=360)),[t,a]}var ee=new b({id:"lch",name:"LCH",coords:{l:{refRange:[0,100],name:"Lightness"},c:{refRange:[0,150],name:"Chroma"},h:{refRange:[0,360],type:"angle",name:"Hue"}},base:J,fromBase(n){if(this.ε===void 0){let i=Object.values(this.base.coords)[1].refRange,l=i[1]-i[0];this.ε=l/1e5}let[e,t,a]=n,o=Math.abs(t)<this.ε&&Math.abs(a)<this.ε,r=o?null:te(Math.atan2(a,t)*180/Math.PI),s=o?0:Math.sqrt(t**2+a**2);return[e,s,r]},toBase(n){let[e,t,a]=n,o=null,r=null;return v(a)||(t=t<0?0:t,o=t*Math.cos(a*Math.PI/180),r=t*Math.sin(a*Math.PI/180)),[e,o,r]},formats:{lch:{coords:["<percentage> | <number>","<number> | <percentage>","<number> | <angle>"]}}});const wt=25**7,fn=Math.PI,Lt=180/fn,Te=fn/180;function Ot(n){const e=n*n;return e*e*e*n}function Wa(n,e,{kL:t=1,kC:a=1,kH:o=1}={}){[n,e]=A([n,e]);let[r,s,i]=J.from(n),l=ee.from(J,[r,s,i])[1],[c,d,u]=J.from(e),m=ee.from(J,[c,d,u])[1];l<0&&(l=0),m<0&&(m=0);let p=(l+m)/2,h=Ot(p),f=.5*(1-Math.sqrt(h/(h+wt))),g=(1+f)*s,C=(1+f)*d,x=Math.sqrt(g**2+i**2),S=Math.sqrt(C**2+u**2),I=g===0&&i===0?0:Math.atan2(i,g),B=C===0&&u===0?0:Math.atan2(u,C);I<0&&(I+=2*fn),B<0&&(B+=2*fn),I*=Lt,B*=Lt;let z=c-r,y=S-x,P=B-I,M=I+B,$=Math.abs(P),j;x*S===0?j=0:$<=180?j=P:P>180?j=P-360:P<-180?j=P+360:Q.warn("the unthinkable has happened");let ae=2*Math.sqrt(S*x)*Math.sin(j*Te/2),se=(r+c)/2,oe=(x+S)/2,be=Ot(oe),q;x*S===0?q=M:$<=180?q=M/2:M<360?q=(M+360)/2:q=(M-360)/2;let Ae=(se-50)**2,Me=1+.015*Ae/Math.sqrt(20+Ae),ue=1+.045*oe,ie=1;ie-=.17*Math.cos((q-30)*Te),ie+=.24*Math.cos(2*q*Te),ie+=.32*Math.cos((3*q+6)*Te),ie-=.2*Math.cos((4*q-63)*Te);let me=1+.015*oe*ie,_e=30*Math.exp(-1*((q-275)/25)**2),ve=2*Math.sqrt(be/(be+wt)),le=-1*Math.sin(2*_e*Te)*ve,Y=(z/(t*Me))**2;return Y+=(y/(a*ue))**2,Y+=(ae/(o*me))**2,Y+=le*(y/(a*ue))*(ae/(o*me)),Math.sqrt(Y)}const dr=[[.819022437996703,.3619062600528904,-.1288737815209879],[.0329836539323885,.9292868615863434,.0361446663506424],[.0481771893596242,.2642395317527308,.6335478284694309]],ur=[[1.2268798758459243,-.5578149944602171,.2813910456659647],[-.0405757452148008,1.112286803280317,-.0717110580655164],[-.0763729366746601,-.4214933324022432,1.5869240198367816]],mr=[[.210454268309314,.7936177747023054,-.0040720430116193],[1.9779985324311684,-2.42859224204858,.450593709617411],[.0259040424655478,.7827717124575296,-.8086757549230774]],he=[[1,.3963377773761749,.2158037573099136],[1,-.1055613458156586,-.0638541728258133],[1,-.0894841775298119,-1.2914855480194092]];var re=new b({id:"oklab",name:"Oklab",coords:{l:{refRange:[0,1],name:"Lightness"},a:{refRange:[-.4,.4]},b:{refRange:[-.4,.4]}},white:"D65",base:V,fromBase(n){let e=O(n,dr);return e[0]=Math.cbrt(e[0]),e[1]=Math.cbrt(e[1]),e[2]=Math.cbrt(e[2]),O(e,mr,e)},toBase(n){let e=O(n,he);return e[0]=e[0]**3,e[1]=e[1]**3,e[2]=e[2]**3,O(e,ur,e)},formats:{oklab:{coords:["<percentage> | <number>","<number> | <percentage>","<number> | <percentage>"]}}});function Yn(n,e){[n,e]=A([n,e]);let[t,a,o]=re.from(n),[r,s,i]=re.from(e),l=t-r,c=a-s,d=o-i;return Math.sqrt(l**2+c**2+d**2)}const pr=75e-6;function Se(n,e,{epsilon:t=pr}={}){n=A(n),e||(e=n.space),e=b.get(e);let a=n.coords;return e!==n.space&&(a=e.from(n)),e.inGamut(a,{epsilon:t})}function He(n){return{space:n.space,coords:n.coords.slice(),alpha:n.alpha}}function Ya(n,e,t="lab"){t=b.get(t);let a=t.from(n),o=t.from(e);return Math.sqrt(a.reduce((r,s,i)=>{let l=o[i];return v(s)||v(l)?r:r+(l-s)**2},0))}function hr(n,e){return Ya(n,e,"lab")}const gr=Math.PI,Rt=gr/180;function fr(n,e,{l:t=2,c:a=1}={}){[n,e]=A([n,e]);let[o,r,s]=J.from(n),[,i,l]=ee.from(J,[o,r,s]),[c,d,u]=J.from(e),m=ee.from(J,[c,d,u])[1];i<0&&(i=0),m<0&&(m=0);let p=o-c,h=i-m,f=r-d,g=s-u,C=f**2+g**2-h**2,x=.511;o>=16&&(x=.040975*o/(1+.01765*o));let S=.0638*i/(1+.0131*i)+.638,I;v(l)&&(l=0),l>=164&&l<=345?I=.56+Math.abs(.2*Math.cos((l+168)*Rt)):I=.36+Math.abs(.4*Math.cos((l+35)*Rt));let B=Math.pow(i,4),z=Math.sqrt(B/(B+1900)),y=S*(z*I+1-z),P=(p/(t*x))**2;return P+=(h/(a*S))**2,P+=C/y**2,Math.sqrt(P)}const kt=203;var ht=new b({id:"xyz-abs-d65",cssId:"--xyz-abs-d65",name:"Absolute XYZ D65",coords:{x:{refRange:[0,9504.7],name:"Xa"},y:{refRange:[0,1e4],name:"Ya"},z:{refRange:[0,10888.3],name:"Za"}},base:V,fromBase(n){return n.map(e=>e*kt)},toBase(n){return n.map(e=>e/kt)}});const on=1.15,rn=.66,Ht=2610/2**14,Cr=2**14/2610,zt=3424/2**12,Ft=2413/2**7,Dt=2392/2**7,xr=1.7*2523/2**5,Nt=2**5/(1.7*2523),sn=-.56,Hn=16295499532821565e-27,br=[[.41478972,.579999,.014648],[-.20151,1.120649,.0531008],[-.0166008,.2648,.6684799]],yr=[[1.9242264357876067,-1.0047923125953657,.037651404030618],[.35031676209499907,.7264811939316552,-.06538442294808501],[-.09098281098284752,-.3127282905230739,1.5227665613052603]],Sr=[[.5,.5,0],[3.524,-4.066708,.542708],[.199076,1.096799,-1.295875]],Pr=[[1,.13860504327153927,.05804731615611883],[1,-.1386050432715393,-.058047316156118904],[1,-.09601924202631895,-.811891896056039]];var Xa=new b({id:"jzazbz",name:"Jzazbz",coords:{jz:{refRange:[0,1],name:"Jz"},az:{refRange:[-.21,.21]},bz:{refRange:[-.21,.21]}},base:ht,fromBase(n){let[e,t,a]=n,o=on*e-(on-1)*a,r=rn*t-(rn-1)*e,i=O([o,r,a],br).map(function(m){let p=zt+Ft*H(m/1e4,Ht),h=1+Dt*H(m/1e4,Ht);return H(p/h,xr)}),[l,c,d]=O(i,Sr);return[(1+sn)*l/(1+sn*l)-Hn,c,d]},toBase(n){let[e,t,a]=n,o=(e+Hn)/(1+sn-sn*(e+Hn)),s=O([o,t,a],Pr).map(function(m){let p=zt-H(m,Nt),h=Dt*H(m,Nt)-Ft;return 1e4*H(p/h,Cr)}),[i,l,c]=O(s,yr),d=(i+(on-1)*c)/on,u=(l+(rn-1)*d)/rn;return[d,u,c]},formats:{jzazbz:{coords:["<percentage> | <number>","<number> | <percentage>","<number> | <percentage>"]}}}),Xn=new b({id:"jzczhz",name:"JzCzHz",coords:{jz:{refRange:[0,1],name:"Jz"},cz:{refRange:[0,.26],name:"Chroma"},hz:{refRange:[0,360],type:"angle",name:"Hue"}},base:Xa,fromBase:ee.fromBase,toBase:ee.toBase,formats:{jzczhz:{coords:["<percentage> | <number>","<number> | <percentage>","<number> | <angle>"]}}});function Ir(n,e){[n,e]=A([n,e]);let[t,a,o]=Xn.from(n),[r,s,i]=Xn.from(e),l=t-r,c=a-s;v(o)&&v(i)?(o=0,i=0):v(o)?o=i:v(i)&&(i=o);let d=o-i,u=2*Math.sqrt(a*s)*Math.sin(d/2*(Math.PI/180));return Math.sqrt(l**2+c**2+u**2)}const Za=3424/4096,Ka=2413/128,Ja=2392/128,_t=2610/16384,Ar=2523/32,Mr=16384/2610,Vt=32/2523,vr=[[.3592832590121217,.6976051147779502,-.035891593232029],[-.1920808463704993,1.100476797037432,.0753748658519118],[.0070797844607479,.0748396662186362,.8433265453898765]],Br=[[2048/4096,2048/4096,0],[6610/4096,-13613/4096,7003/4096],[17933/4096,-17390/4096,-543/4096]],Tr=[[.9999999999999998,.0086090370379328,.111029625003026],[.9999999999999998,-.0086090370379328,-.1110296250030259],[.9999999999999998,.5600313357106791,-.3206271749873188]],Er=[[2.0701522183894223,-1.3263473389671563,.2066510476294053],[.3647385209748072,.6805660249472273,-.0453045459220347],[-.0497472075358123,-.0492609666966131,1.1880659249923042]];var Zn=new b({id:"ictcp",name:"ICTCP",coords:{i:{refRange:[0,1],name:"I"},ct:{refRange:[-.5,.5],name:"CT"},cp:{refRange:[-.5,.5],name:"CP"}},base:ht,fromBase(n){let e=O(n,vr);return wr(e)},toBase(n){let e=Lr(n);return O(e,Er)},formats:{ictcp:{coords:["<percentage> | <number>","<number> | <percentage>","<number> | <percentage>"]}}});function wr(n){let e=n.map(function(t){let a=Za+Ka*(t/1e4)**_t,o=1+Ja*(t/1e4)**_t;return(a/o)**Ar});return O(e,Br)}function Lr(n){return O(n,Tr).map(function(a){let o=Math.max(a**Vt-Za,0),r=Ka-Ja*a**Vt;return 1e4*(o/r)**Mr})}function Or(n,e){[n,e]=A([n,e]);let[t,a,o]=Zn.from(n),[r,s,i]=Zn.from(e);return 720*Math.sqrt((t-r)**2+.25*(a-s)**2+(o-i)**2)}function Rr(n,e){[n,e]=A([n,e]);let t=2,[a,o,r]=re.from(n),[s,i,l]=re.from(e),c=a-s,d=t*(o-i),u=t*(r-l);return Math.sqrt(c**2+d**2+u**2)}const kr=W.D65,Qa=.42,Gt=1/Qa,zn=2*Math.PI,eo=[[.401288,.650173,-.051461],[-.250268,1.204414,.045854],[-.002079,.048952,.953127]],Hr=[[1.8620678550872327,-1.0112546305316843,.14918677544445175],[.38752654323613717,.6214474419314753,-.008973985167612518],[-.015841498849333856,-.03412293802851557,1.0499644368778496]],zr=[[460,451,288],[460,-891,-261],[460,-220,-6300]],Fr={dark:[.8,.525,.8],dim:[.9,.59,.9],average:[1,.69,1]},ye={h:[20.14,90,164.25,237.53,380.14],e:[.8,.7,1,1.2,.8],H:[0,100,200,300,400]},Dr=180/Math.PI,jt=Math.PI/180;function no(n,e){return n.map(a=>{const o=H(e*Math.abs(a)*.01,Qa);return 400*An(o,a)/(o+27.13)})}function Nr(n,e){const t=100/e*27.13**Gt;return n.map(a=>{const o=Math.abs(a);return An(t*H(o/(400-o),Gt),a)})}function _r(n){let e=te(n);e<=ye.h[0]&&(e+=360);const t=Ga(ye.h,e)-1,[a,o]=ye.h.slice(t,t+2),[r,s]=ye.e.slice(t,t+2),i=ye.H[t],l=(e-a)/r;return i+100*l/(l+(o-e)/s)}function Vr(n){let e=(n%400+400)%400;const t=Math.floor(.01*e);e=e%100;const[a,o]=ye.h.slice(t,t+2),[r,s]=ye.e.slice(t,t+2);return te((e*(s*a-r*o)-100*a*s)/(e*(s-r)-100*s))}function to(n,e,t,a,o){const r={};r.discounting=o,r.refWhite=n,r.surround=a;const s=n.map(g=>g*100);r.la=e,r.yb=t;const i=s[1],l=O(s,eo);let c=Fr[r.surround];const d=c[0];r.c=c[1],r.nc=c[2];const m=(1/(5*r.la+1))**4;r.fl=m*r.la+.1*(1-m)*(1-m)*Math.cbrt(5*r.la),r.flRoot=r.fl**.25,r.n=r.yb/i,r.z=1.48+Math.sqrt(r.n),r.nbb=.725*r.n**-.2,r.ncb=r.nbb;const p=Math.max(Math.min(d*(1-1/3.6*Math.exp((-r.la-42)/92)),1),0);r.dRgb=l.map(g=>Ke(1,i/g,p)),r.dRgbInv=r.dRgb.map(g=>1/g);const h=l.map((g,C)=>g*r.dRgb[C]),f=no(h,r.fl);return r.aW=r.nbb*(2*f[0]+f[1]+.05*f[2]),r}const Ut=to(kr,64/Math.PI*.2,20,"average",!1);function Kn(n,e){if(!(n.J!==void 0^n.Q!==void 0))throw new Error("Conversion requires one and only one: 'J' or 'Q'");if(!(n.C!==void 0^n.M!==void 0^n.s!==void 0))throw new Error("Conversion requires one and only one: 'C', 'M' or 's'");if(!(n.h!==void 0^n.H!==void 0))throw new Error("Conversion requires one and only one: 'h' or 'H'");if(n.J===0||n.Q===0)return[0,0,0];let t=0;n.h!==void 0?t=te(n.h)*jt:t=Vr(n.H)*jt;const a=Math.cos(t),o=Math.sin(t);let r=0;n.J!==void 0?r=H(n.J,1/2)*.1:n.Q!==void 0&&(r=.25*e.c*n.Q/((e.aW+4)*e.flRoot));let s=0;n.C!==void 0?s=n.C/r:n.M!==void 0?s=n.M/e.flRoot/r:n.s!==void 0&&(s=4e-4*n.s**2*(e.aW+4)/e.c);const i=H(s*Math.pow(1.64-Math.pow(.29,e.n),-.73),10/9),l=.25*(Math.cos(t+2)+3.8),c=e.aW*H(r,2/e.c/e.z),d=5e4/13*e.nc*e.ncb*l,u=c/e.nbb,m=23*(u+.305)*ut(i,23*d+i*(11*a+108*o)),p=m*a,h=m*o,f=Nr(O([u,p,h],zr).map(g=>g*1/1403),e.fl);return O(f.map((g,C)=>g*e.dRgbInv[C]),Hr).map(g=>g/100)}function ao(n,e){const t=n.map(S=>S*100),a=no(O(t,eo).map((S,I)=>S*e.dRgb[I]),e.fl),o=a[0]+(-12*a[1]+a[2])/11,r=(a[0]+a[1]-2*a[2])/9,s=(Math.atan2(r,o)%zn+zn)%zn,i=.25*(Math.cos(s+2)+3.8),l=5e4/13*e.nc*e.ncb*ut(i*Math.sqrt(o**2+r**2),a[0]+a[1]+1.05*a[2]+.305),c=H(l,.9)*Math.pow(1.64-Math.pow(.29,e.n),.73),d=e.nbb*(2*a[0]+a[1]+.05*a[2]),u=H(d/e.aW,.5*e.c*e.z),m=100*H(u,2),p=4/e.c*u*(e.aW+4)*e.flRoot,h=c*u,f=h*e.flRoot,g=te(s*Dr),C=_r(g),x=50*H(e.c*c/(e.aW+4),1/2);return{J:m,C:h,h:g,s:x,Q:p,M:f,H:C}}var Gr=new b({id:"cam16-jmh",cssId:"--cam16-jmh",name:"CAM16-JMh",coords:{j:{refRange:[0,100],name:"J"},m:{refRange:[0,105],name:"Colorfulness"},h:{refRange:[0,360],type:"angle",name:"Hue"}},base:V,fromBase(n){this.ε===void 0&&(this.ε=Object.values(this.coords)[1].refRange[1]/1e5);const e=ao(n,Ut),t=Math.abs(e.M)<this.ε;return[e.J,t?0:e.M,t?null:e.h]},toBase(n){return Kn({J:n[0],M:n[1],h:n[2]},Ut)}});const jr=W.D65,Ur=216/24389,oo=24389/27;function $r(n){return 116*(n>Ur?Math.cbrt(n):(oo*n+16)/116)-16}function Jn(n){return n>8?Math.pow((n+16)/116,3):n/oo}function qr(n,e){let[t,a,o]=n,r=[],s=0;if(o===0)return[0,0,0];let i=Jn(o);o>0?s=.00379058511492914*o**2+.608983189401032*o+.9155088574762233:s=9514440756550361e-21*o**2+.08693057439788597*o-21.928975842194614;const l=2e-12,c=15;let d=0,u=1/0;for(;d<=c;){r=Kn({J:s,C:a,h:t},e);const m=Math.abs(r[1]-i);if(m<u){if(m<=l)return r;u=m}s=s-(r[1]-i)*s/(2*r[1]),d+=1}return Kn({J:s,C:a,h:t},e)}function Wr(n,e){const t=$r(n[1]);if(t===0)return[0,0,0];const a=ao(n,gt);return[te(a.h),a.C,t]}const gt=to(jr,200/Math.PI*Jn(50),Jn(50)*100,"average",!1);var Je=new b({id:"hct",name:"HCT",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},c:{refRange:[0,145],name:"Colorfulness"},t:{refRange:[0,100],name:"Tone"}},base:V,fromBase(n){this.ε===void 0&&(this.ε=Object.values(this.coords)[1].refRange[1]/1e5);let e=Wr(n);return e[1]<this.ε&&(e[1]=0,e[0]=null),e},toBase(n){return qr(n,gt)},formats:{color:{id:"--hct",coords:["<number> | <angle>","<percentage> | <number>","<percentage> | <number>"]}}});const Yr=Math.PI/180,$t=[1,.007,.0228];function qt(n){n[1]<0&&(n=Je.fromBase(Je.toBase(n)));const e=Math.log(Math.max(1+$t[2]*n[1]*gt.flRoot,1))/$t[2],t=n[0]*Yr,a=e*Math.cos(t),o=e*Math.sin(t);return[n[2],a,o]}function Xr(n,e){[n,e]=A([n,e]);let[t,a,o]=qt(Je.from(n)),[r,s,i]=qt(Je.from(e));return Math.sqrt((t-r)**2+(a-s)**2+(o-i)**2)}var ze={deltaE76:hr,deltaECMC:fr,deltaE2000:Wa,deltaEJz:Ir,deltaEITP:Or,deltaEOK:Yn,deltaEOK2:Rr,deltaEHCT:Xr};function Zr(n){const e=n?Math.floor(Math.log10(Math.abs(n))):0;return Math.max(parseFloat(`1e${e-2}`),1e-6)}const Wt={hct:{method:"hct.c",jnd:2,deltaEMethod:"hct",blackWhiteClamp:{}},"hct-tonal":{method:"hct.c",jnd:0,deltaEMethod:"hct",blackWhiteClamp:{channel:"hct.t",min:0,max:100}}};function fe(n,{method:e=Q.gamut_mapping,space:t=void 0,deltaEMethod:a="",jnd:o=2,blackWhiteClamp:r=void 0}={}){if(n=A(n),Ne(arguments[1])?t=arguments[1]:t||(t=n.space),t=b.get(t),Se(n,t,{epsilon:0}))return n;let s;if(e==="css")s=Kr(n,{space:t});else{if(e!=="clip"&&!Se(n,t)){Object.prototype.hasOwnProperty.call(Wt,e)&&({method:e,jnd:o,deltaEMethod:a,blackWhiteClamp:r}=Wt[e]);let i=Wa;if(a!==""){for(let c in ze)if("deltae"+a.toLowerCase()===c.toLowerCase()){i=ze[c];break}}o===0&&(o=1e-16);let l=fe(w(n,t),{method:"clip",space:t});if(i(n,l)>o){if(r&&Object.keys(r).length===3){let x=b.resolveCoord(r.channel),S=K(w(n,x.space),x.id);if(v(S)&&(S=0),S>=r.max)return w({space:"xyz-d65",coords:W.D65},n.space);if(S<=r.min)return w({space:"xyz-d65",coords:[0,0,0]},n.space)}let c=b.resolveCoord(e),d=c.space,u=c.id,m=w(n,d);m.coords.forEach((x,S)=>{v(x)&&(m.coords[S]=0)});let h=(c.range||c.refRange)[0],f=Zr(o),g=h,C=K(m,u);for(;C-g>f;){let x=He(m);x=fe(x,{space:t,method:"clip"}),i(m,x)-o<f?g=K(m,u):C=K(m,u),de(m,u,(g+C)/2)}s=w(m,t)}else s=l}else s=w(n,t);if(e==="clip"||!Se(s,t,{epsilon:0})){let i=Object.values(t.coords).map(l=>l.range||[]);s.coords=s.coords.map((l,c)=>{let[d,u]=i[c];return d!==void 0&&(l=Math.max(d,l)),u!==void 0&&(l=Math.min(l,u)),l})}}return t!==n.space&&(s=w(s,n.space)),n.coords=s.coords,n}fe.returns="color";const Yt={WHITE:{space:re,coords:[1,0,0],alpha:1},BLACK:{space:re,coords:[0,0,0],alpha:1}};function Kr(n,{space:e}={}){n=A(n),e||(e=n.space),e=b.get(e);const o=b.get("oklch");if(e.isUnbounded)return w(n,e);const r=w(n,o);let s=r.coords[0];if(s>=1){const h=w(Yt.WHITE,e);return h.alpha=n.alpha,w(h,e)}if(s<=0){const h=w(Yt.BLACK,e);return h.alpha=n.alpha,w(h,e)}if(Se(r,e,{epsilon:0}))return w(r,e);function i(h){const f=w(h,e),g=Object.values(e.coords);return f.coords=f.coords.map((C,x)=>{if("range"in g[x]){const[S,I]=g[x].range;return In(S,C,I)}return C}),f}let l=0,c=r.coords[1],d=!0,u=He(r),m=i(u),p=Yn(m,u);if(p<.02)return m;for(;c-l>1e-4;){const h=(l+c)/2;if(u.coords[1]=h,d&&Se(u,e,{epsilon:0}))l=h;else if(m=i(u),p=Yn(m,u),p<.02){if(.02-p<1e-4)break;d=!1,l=h}else c=h}return m}function w(n,e,{inGamut:t}={}){n=A(n),e=b.get(e);let a=e.from(n),o={space:e,coords:a,alpha:n.alpha};return t&&(o=fe(o,t===!0?void 0:t)),o}w.returns="color";function We(n,e={}){var p;let{precision:t=Q.precision,format:a,inGamut:o=!0,coords:r,alpha:s,commas:i}=e,l,c=A(n),d=a,u=c.parseMeta;u&&!a&&(u.format.canSerialize()&&(a=u.format,d=u.formatId),r??(r=u.types),s??(s=u.alphaType),i??(i=u.commas)),d&&(a=c.space.getFormat(a)??b.findFormat(d)),a||(a=c.space.getFormat("default")??b.DEFAULT_FORMAT,d=a.name),a&&a.space&&a.space!==c.space&&(c=w(c,a.space));let m=c.coords.slice();if(o||(o=a.toGamut),o&&!Se(c)&&(m=fe(He(c),o===!0?void 0:o).coords),a.type==="custom")if(a.serialize)l=a.serialize(m,c.alpha,e);else throw new TypeError(`format ${d} can only be used to parse colors, not for serialization`);else{let h=a.name||"color",f=a.serializeCoords(m,t,r);if(h==="color"){let I=a.id||((p=a.ids)==null?void 0:p[0])||c.space.cssId||c.space.id;f.unshift(I)}let g=c.alpha;s!==void 0&&typeof s!="object"&&(s=typeof s=="string"?{type:s}:{include:s});let C=(s==null?void 0:s.type)??"<number>",x=(s==null?void 0:s.include)===!0||a.alpha===!0||(s==null?void 0:s.include)!==!1&&a.alpha!==!1&&g<1,S="";if(i??(i=a.commas),x){if(t!==null){let I;C==="<percentage>"&&(I="%",g*=100),g=ct(g,{precision:t,unit:I})}S=`${i?",":" /"} ${g}`}l=`${h}(${f.join(i?", ":" ")}${S})`}return l}const Jr=[[.6369580483012914,.14461690358620832,.1688809751641721],[.2627002120112671,.6779980715188708,.05930171646986196],[0,.028072693049087428,1.060985057710791]],Qr=[[1.716651187971268,-.355670783776392,-.25336628137366],[-.666684351832489,1.616481236634939,.0157685458139111],[.017639857445311,-.042770613257809,.942103121235474]];var Qe=new U({id:"rec2020-linear",cssId:"--rec2020-linear",name:"Linear REC.2020",white:"D65",toXYZ_M:Jr,fromXYZ_M:Qr}),ro=new U({id:"rec2020",name:"REC.2020",base:Qe,toBase(n){return n.map(function(e){let t=e<0?-1:1,a=e*t;return t*Math.pow(a,2.4)})},fromBase(n){return n.map(function(e){let t=e<0?-1:1,a=e*t;return t*Math.pow(a,1/2.4)})}});const es=[[.4865709486482162,.26566769316909306,.1982172852343625],[.2289745640697488,.6917385218365064,.079286914093745],[0,.04511338185890264,1.043944368900976]],ns=[[2.493496911941425,-.9313836179191239,-.40271078445071684],[-.8294889695615747,1.7626640603183463,.023624685841943577],[.03584583024378447,-.07617238926804182,.9568845240076872]];var so=new U({id:"p3-linear",cssId:"display-p3-linear",name:"Linear P3",white:"D65",toXYZ_M:es,fromXYZ_M:ns});const ts=[[.41239079926595934,.357584339383878,.1804807884018343],[.21263900587151027,.715168678767756,.07219231536073371],[.01933081871559182,.11919477979462598,.9505321522496607]],D=[[3.2409699419045226,-1.537383177570094,-.4986107602930034],[-.9692436362808796,1.8759675015077202,.04155505740717559],[.05563007969699366,-.20397695888897652,1.0569715142428786]];var io=new U({id:"srgb-linear",name:"Linear sRGB",white:"D65",toXYZ_M:ts,fromXYZ_M:D}),Xt={aliceblue:[240/255,248/255,1],antiquewhite:[250/255,235/255,215/255],aqua:[0,1,1],aquamarine:[127/255,1,212/255],azure:[240/255,1,1],beige:[245/255,245/255,220/255],bisque:[1,228/255,196/255],black:[0,0,0],blanchedalmond:[1,235/255,205/255],blue:[0,0,1],blueviolet:[138/255,43/255,226/255],brown:[165/255,42/255,42/255],burlywood:[222/255,184/255,135/255],cadetblue:[95/255,158/255,160/255],chartreuse:[127/255,1,0],chocolate:[210/255,105/255,30/255],coral:[1,127/255,80/255],cornflowerblue:[100/255,149/255,237/255],cornsilk:[1,248/255,220/255],crimson:[220/255,20/255,60/255],cyan:[0,1,1],darkblue:[0,0,139/255],darkcyan:[0,139/255,139/255],darkgoldenrod:[184/255,134/255,11/255],darkgray:[169/255,169/255,169/255],darkgreen:[0,100/255,0],darkgrey:[169/255,169/255,169/255],darkkhaki:[189/255,183/255,107/255],darkmagenta:[139/255,0,139/255],darkolivegreen:[85/255,107/255,47/255],darkorange:[1,140/255,0],darkorchid:[153/255,50/255,204/255],darkred:[139/255,0,0],darksalmon:[233/255,150/255,122/255],darkseagreen:[143/255,188/255,143/255],darkslateblue:[72/255,61/255,139/255],darkslategray:[47/255,79/255,79/255],darkslategrey:[47/255,79/255,79/255],darkturquoise:[0,206/255,209/255],darkviolet:[148/255,0,211/255],deeppink:[1,20/255,147/255],deepskyblue:[0,191/255,1],dimgray:[105/255,105/255,105/255],dimgrey:[105/255,105/255,105/255],dodgerblue:[30/255,144/255,1],firebrick:[178/255,34/255,34/255],floralwhite:[1,250/255,240/255],forestgreen:[34/255,139/255,34/255],fuchsia:[1,0,1],gainsboro:[220/255,220/255,220/255],ghostwhite:[248/255,248/255,1],gold:[1,215/255,0],goldenrod:[218/255,165/255,32/255],gray:[128/255,128/255,128/255],green:[0,128/255,0],greenyellow:[173/255,1,47/255],grey:[128/255,128/255,128/255],honeydew:[240/255,1,240/255],hotpink:[1,105/255,180/255],indianred:[205/255,92/255,92/255],indigo:[75/255,0,130/255],ivory:[1,1,240/255],khaki:[240/255,230/255,140/255],lavender:[230/255,230/255,250/255],lavenderblush:[1,240/255,245/255],lawngreen:[124/255,252/255,0],lemonchiffon:[1,250/255,205/255],lightblue:[173/255,216/255,230/255],lightcoral:[240/255,128/255,128/255],lightcyan:[224/255,1,1],lightgoldenrodyellow:[250/255,250/255,210/255],lightgray:[211/255,211/255,211/255],lightgreen:[144/255,238/255,144/255],lightgrey:[211/255,211/255,211/255],lightpink:[1,182/255,193/255],lightsalmon:[1,160/255,122/255],lightseagreen:[32/255,178/255,170/255],lightskyblue:[135/255,206/255,250/255],lightslategray:[119/255,136/255,153/255],lightslategrey:[119/255,136/255,153/255],lightsteelblue:[176/255,196/255,222/255],lightyellow:[1,1,224/255],lime:[0,1,0],limegreen:[50/255,205/255,50/255],linen:[250/255,240/255,230/255],magenta:[1,0,1],maroon:[128/255,0,0],mediumaquamarine:[102/255,205/255,170/255],mediumblue:[0,0,205/255],mediumorchid:[186/255,85/255,211/255],mediumpurple:[147/255,112/255,219/255],mediumseagreen:[60/255,179/255,113/255],mediumslateblue:[123/255,104/255,238/255],mediumspringgreen:[0,250/255,154/255],mediumturquoise:[72/255,209/255,204/255],mediumvioletred:[199/255,21/255,133/255],midnightblue:[25/255,25/255,112/255],mintcream:[245/255,1,250/255],mistyrose:[1,228/255,225/255],moccasin:[1,228/255,181/255],navajowhite:[1,222/255,173/255],navy:[0,0,128/255],oldlace:[253/255,245/255,230/255],olive:[128/255,128/255,0],olivedrab:[107/255,142/255,35/255],orange:[1,165/255,0],orangered:[1,69/255,0],orchid:[218/255,112/255,214/255],palegoldenrod:[238/255,232/255,170/255],palegreen:[152/255,251/255,152/255],paleturquoise:[175/255,238/255,238/255],palevioletred:[219/255,112/255,147/255],papayawhip:[1,239/255,213/255],peachpuff:[1,218/255,185/255],peru:[205/255,133/255,63/255],pink:[1,192/255,203/255],plum:[221/255,160/255,221/255],powderblue:[176/255,224/255,230/255],purple:[128/255,0,128/255],rebeccapurple:[102/255,51/255,153/255],red:[1,0,0],rosybrown:[188/255,143/255,143/255],royalblue:[65/255,105/255,225/255],saddlebrown:[139/255,69/255,19/255],salmon:[250/255,128/255,114/255],sandybrown:[244/255,164/255,96/255],seagreen:[46/255,139/255,87/255],seashell:[1,245/255,238/255],sienna:[160/255,82/255,45/255],silver:[192/255,192/255,192/255],skyblue:[135/255,206/255,235/255],slateblue:[106/255,90/255,205/255],slategray:[112/255,128/255,144/255],slategrey:[112/255,128/255,144/255],snow:[1,250/255,250/255],springgreen:[0,1,127/255],steelblue:[70/255,130/255,180/255],tan:[210/255,180/255,140/255],teal:[0,128/255,128/255],thistle:[216/255,191/255,216/255],tomato:[1,99/255,71/255],turquoise:[64/255,224/255,208/255],violet:[238/255,130/255,238/255],wheat:[245/255,222/255,179/255],white:[1,1,1],whitesmoke:[245/255,245/255,245/255],yellow:[1,1,0],yellowgreen:[154/255,205/255,50/255]};let Zt=Array(3).fill("<percentage> | <number>[0, 255]"),Kt=Array(3).fill("<number>[0, 255]");var Pe=new U({id:"srgb",name:"sRGB",base:io,fromBase:n=>n.map(e=>{let t=e<0?-1:1,a=e*t;return a>.0031308?t*(1.055*a**(1/2.4)-.055):12.92*e}),toBase:n=>n.map(e=>{let t=e<0?-1:1,a=e*t;return a<=.04045?e/12.92:t*((a+.055)/1.055)**2.4}),formats:{rgb:{coords:Zt},rgb_number:{name:"rgb",commas:!0,coords:Kt,alpha:!1},color:{},rgba:{coords:Zt,commas:!0,alpha:!0},rgba_number:{name:"rgba",commas:!0,coords:Kt},hex:{type:"custom",toGamut:!0,test:n=>/^#(([a-f0-9]{2}){3,4}|[a-f0-9]{3,4})$/i.test(n),parse(n){n.length<=5&&(n=n.replace(/[a-f0-9]/gi,"$&$&"));let e=[];return n.replace(/[a-f0-9]{2}/gi,t=>{e.push(parseInt(t,16)/255)}),{spaceId:"srgb",coords:e.slice(0,3),alpha:e.slice(3)[0]}},serialize:(n,e,{collapse:t=!0,alpha:a}={})=>{(a!==!1&&e<1||a===!0)&&n.push(e),n=n.map(s=>Math.round(s*255));let o=t&&n.every(s=>s%17===0);return"#"+n.map(s=>o?(s/17).toString(16):s.toString(16).padStart(2,"0")).join("")}},keyword:{type:"custom",test:n=>/^[a-z]+$/i.test(n),parse(n){n=n.toLowerCase();let e={spaceId:"srgb",coords:null,alpha:1};if(n==="transparent"?(e.coords=Xt.black,e.alpha=0):e.coords=Xt[n],e.coords)return e}}}}),lo=new U({id:"p3",cssId:"display-p3",name:"P3",base:so,fromBase:Pe.fromBase,toBase:Pe.toBase});Q.display_space=Pe;let as;if(typeof CSS<"u"&&CSS.supports)for(let n of[J,ro,lo]){let e=n.getMinCoords(),a=We({space:n,coords:e,alpha:1});if(CSS.supports("color",a)){Q.display_space=n;break}}function os(n,{space:e=Q.display_space,...t}={}){n=A(n);let a=We(n,t);if(typeof CSS>"u"||CSS.supports("color",a)||!Q.display_space)a=new String(a),a.color=n;else{let o=n;if((n.coords.some(v)||v(n.alpha))&&!(as??(as=CSS.supports("color","hsl(none 50% 50%)")))&&(o=He(n),o.coords=o.coords.map(k),o.alpha=k(o.alpha),a=We(o,t),CSS.supports("color",a)))return a=new String(a),a.color=o,a;o=w(o,e),a=new String(We(o,t)),a.color=o}return a}function rs(n,e,{space:t,hue:a="shorter"}={}){n=A(n),t||(t=n.space),t=b.get(t);let o=Object.values(t.coords);[n,e]=[n,e].map(c=>w(c,t));let[r,s]=[n,e].map(c=>c.coords),i=r.map((c,d)=>{let u=o[d],m=s[d];return u.type==="angle"&&([c,m]=qa(a,[c,m])),Jt(c,m)}),l=Jt(n.alpha,e.alpha);return{space:t,coords:i,alpha:l}}function Jt(n,e){return v(n)||v(e)?n===e?null:0:n-e}function ss(n,e){return n=A(n),e=A(e),n.space===e.space&&n.alpha===e.alpha&&n.coords.every((t,a)=>t===e.coords[a])}function Ce(n){return K(n,[V,"y"])}function co(n,e){de(n,[V,"y"],e)}function is(n){Object.defineProperty(n.prototype,"luminance",{get(){return Ce(this)},set(e){co(this,e)}})}var ls=Object.freeze({__proto__:null,getLuminance:Ce,register:is,setLuminance:co});function cs(n,e){n=A(n),e=A(e);let t=Math.max(Ce(n),0),a=Math.max(Ce(e),0);return a>t&&([t,a]=[a,t]),(t+.05)/(a+.05)}const ds=.56,us=.57,ms=.62,ps=.65,Qt=.022,hs=1.414,gs=.1,fs=5e-4,Cs=1.14,ea=.027,xs=1.14;function na(n){return n>=Qt?n:n+(Qt-n)**hs}function Ee(n){let e=n<0?-1:1,t=Math.abs(n);return e*Math.pow(t,2.4)}function bs(n,e){e=A(e),n=A(n);let t,a,o,r,s,i;e=w(e,"srgb"),[r,s,i]=e.coords.map(p=>v(p)?0:p);let l=Ee(r)*.2126729+Ee(s)*.7151522+Ee(i)*.072175;n=w(n,"srgb"),[r,s,i]=n.coords.map(p=>v(p)?0:p);let c=Ee(r)*.2126729+Ee(s)*.7151522+Ee(i)*.072175,d=na(l),u=na(c),m=u>d;return Math.abs(u-d)<fs?a=0:m?(t=u**ds-d**us,a=t*Cs):(t=u**ps-d**ms,a=t*xs),Math.abs(a)<gs?o=0:a>0?o=a-ea:o=a+ea,o*100}function ys(n,e){n=A(n),e=A(e);let t=Math.max(Ce(n),0),a=Math.max(Ce(e),0);a>t&&([t,a]=[a,t]);let o=t+a;return o===0?0:(t-a)/o}const Ss=5e4;function Ps(n,e){n=A(n),e=A(e);let t=Math.max(Ce(n),0),a=Math.max(Ce(e),0);return a>t&&([t,a]=[a,t]),a===0?Ss:(t-a)/a}function Is(n,e){n=A(n),e=A(e);let t=K(n,[J,"l"]),a=K(e,[J,"l"]);return Math.abs(t-a)}const As=216/24389,ta=24/116,ln=24389/27;let Fn=W.D65;var Qn=new b({id:"lab-d65",name:"Lab D65",coords:{l:{refRange:[0,100],name:"Lightness"},a:{refRange:[-125,125]},b:{refRange:[-125,125]}},white:Fn,base:V,fromBase(n){let t=n.map((a,o)=>a/Fn[o]).map(a=>a>As?Math.cbrt(a):(ln*a+16)/116);return[116*t[1]-16,500*(t[0]-t[1]),200*(t[1]-t[2])]},toBase(n){let e=[];return e[1]=(n[0]+16)/116,e[0]=n[1]/500+e[1],e[2]=e[1]-n[2]/200,[e[0]>ta?Math.pow(e[0],3):(116*e[0]-16)/ln,n[0]>8?Math.pow((n[0]+16)/116,3):n[0]/ln,e[2]>ta?Math.pow(e[2],3):(116*e[2]-16)/ln].map((a,o)=>a*Fn[o])},formats:{"lab-d65":{coords:["<number> | <percentage>","<number> | <percentage>","<number> | <percentage>"]}}});const Dn=Math.pow(5,.5)*.5+.5;function Ms(n,e){n=A(n),e=A(e);let t=K(n,[Qn,"l"]),a=K(e,[Qn,"l"]),o=Math.abs(Math.pow(t,Dn)-Math.pow(a,Dn)),r=Math.pow(o,1/Dn)*Math.SQRT2-40;return r<7.5?0:r}var mn=Object.freeze({__proto__:null,contrastAPCA:bs,contrastDeltaPhi:Ms,contrastLstar:Is,contrastMichelson:ys,contrastWCAG21:cs,contrastWeber:Ps});function vs(n,e,t){Ne(t)&&(t={algorithm:t});let{algorithm:a,...o}=t||{};if(!a){let r=Object.keys(mn).map(s=>s.replace(/^contrast/,"")).join(", ");throw new TypeError(`contrast() function needs a contrast algorithm. Please specify one of: ${r}`)}n=A(n),e=A(e);for(let r in mn)if("contrast"+a.toLowerCase()===r.toLowerCase())return mn[r](n,e,o);throw new TypeError(`Unknown contrast algorithm: ${a}`)}function Mn(n){let[e,t,a]=nn(n,V),o=e+15*t+3*a;return[4*e/o,9*t/o]}function uo(n){let[e,t,a]=nn(n,V),o=e+t+a;return[e/o,t/o]}function Bs(n){Object.defineProperty(n.prototype,"uv",{get(){return Mn(this)}}),Object.defineProperty(n.prototype,"xy",{get(){return uo(this)}})}var Ts=Object.freeze({__proto__:null,register:Bs,uv:Mn,xy:uo});function $e(n,e,t={}){Ne(t)&&(t={method:t});let{method:a=Q.deltaE,...o}=t;for(let r in ze)if("deltae"+a.toLowerCase()===r.toLowerCase())return ze[r](n,e,o);throw new TypeError(`Unknown deltaE method: ${a}`)}function mo(n,e=.25){let a=[b.get("oklch","lch"),"l"];return de(n,a,o=>o*(1+e))}function po(n,e=.25){let a=[b.get("oklch","lch"),"l"];return de(n,a,o=>o*(1-e))}mo.returns="color";po.returns="color";var Es=Object.freeze({__proto__:null,darken:po,lighten:mo});function ho(n,e,t,a={}){return[n,e]=[A(n),A(e)],pe(t)==="object"&&([t,a]=[.5,t]),tn(n,e,a)(t??.5)}function go(n,e,t={}){let a;ft(n)&&([a,t]=[n,e],[n,e]=a.rangeArgs.colors);let{maxDeltaE:o,deltaEMethod:r,steps:s=2,maxSteps:i=1e3,...l}=t;a||([n,e]=[A(n),A(e)],a=tn(n,e,l));let c=$e(n,e),d=o>0?Math.max(s,Math.ceil(c/o)+1):s,u=[];if(i!==void 0&&(d=Math.min(d,i)),d===1)u=[{p:.5,color:a(.5)}];else{let m=1/(d-1);u=Array.from({length:d},(p,h)=>{let f=h*m;return{p:f,color:a(f)}})}if(o>0){let m=u.reduce((p,h,f)=>{if(f===0)return 0;let g=$e(h.color,u[f-1].color,r);return Math.max(p,g)},0);for(;m>o;){m=0;for(let p=1;p<u.length&&u.length<i;p++){let h=u[p-1],f=u[p],g=(f.p+h.p)/2,C=a(g);m=Math.max(m,$e(C,h.color),$e(C,f.color)),u.splice(p,0,{p:g,color:a(g)}),p++}}}return u=u.map(m=>m.color),u}function tn(n,e,t={}){if(ft(n)){let[l,c]=[n,e];return tn(...l.rangeArgs.colors,{...l.rangeArgs.options,...c})}let{space:a,outputSpace:o,progression:r,premultiplied:s}=t;n=A(n),e=A(e),n=He(n),e=He(e);let i={colors:[n,e],options:t};if(a?a=b.get(a):a=b.registry[Q.interpolationSpace]||n.space,o=o?b.get(o):a,n=w(n,a),e=w(e,a),n=fe(n),e=fe(e),a.coords.h&&a.coords.h.type==="angle"){let l=t.hue=t.hue||"shorter",c=[a,"h"],[d,u]=[K(n,c),K(e,c)];v(d)&&!v(u)?d=u:v(u)&&!v(d)&&(u=d),[d,u]=qa(l,[d,u]),de(n,c,d),de(e,c,u)}return s&&(n.coords=n.coords.map(l=>l*n.alpha),e.coords=e.coords.map(l=>l*e.alpha)),Object.assign(l=>{l=r?r(l):l;let c=n.coords.map((m,p)=>{let h=e.coords[p];return Ke(m,h,l)}),d=Ke(n.alpha,e.alpha,l),u={space:a,coords:c,alpha:d};return s&&(u.coords=u.coords.map(m=>m/d)),o!==a&&(u=w(u,o)),u},{rangeArgs:i})}function ft(n){return pe(n)==="function"&&!!n.rangeArgs}Q.interpolationSpace="lab";function ws(n){n.defineFunction("mix",ho,{returns:"color"}),n.defineFunction("range",tn,{returns:"function<color>"}),n.defineFunction("steps",go,{returns:"array<color>"})}var Ls=Object.freeze({__proto__:null,isRange:ft,mix:ho,range:tn,register:ws,steps:go}),Os=new b({id:"hsl",name:"HSL",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},s:{range:[0,100],name:"Saturation"},l:{range:[0,100],name:"Lightness"}},base:Pe,fromBase:n=>{let e=Math.max(...n),t=Math.min(...n),[a,o,r]=n,[s,i,l]=[null,0,(t+e)/2],c=e-t;if(c!==0){switch(i=l===0||l===1?0:(e-l)/Math.min(l,1-l),e){case a:s=(o-r)/c+(o<r?6:0);break;case o:s=(r-a)/c+2;break;case r:s=(a-o)/c+4}s=s*60}return i<0&&(s+=180,i=Math.abs(i)),s>=360&&(s-=360),[s,i*100,l*100]},toBase:n=>{let[e,t,a]=n;e=e%360,e<0&&(e+=360),t/=100,a/=100;function o(r){let s=(r+e/30)%12,i=t*Math.min(a,1-a);return a-i*Math.max(-1,Math.min(s-3,9-s,1))}return[o(0),o(8),o(4)]},formats:{hsl:{coords:["<number> | <angle>","<percentage> | <number>","<percentage> | <number>"]},hsla:{coords:["<number> | <angle>","<percentage> | <number>","<percentage> | <number>"],commas:!0,alpha:!0}}}),fo=new b({id:"hsv",name:"HSV",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},s:{range:[0,100],name:"Saturation"},v:{range:[0,100],name:"Value"}},base:Pe,fromBase(n){let e=Math.max(...n),t=Math.min(...n),[a,o,r]=n,[s,i,l]=[null,0,e],c=e-t;if(c!==0){switch(e){case a:s=(o-r)/c+(o<r?6:0);break;case o:s=(r-a)/c+2;break;case r:s=(a-o)/c+4}s=s*60}return l&&(i=c/l),s>=360&&(s-=360),[s,i*100,l*100]},toBase(n){let[e,t,a]=n;e=e%360,e<0&&(e+=360),t/=100,a/=100;function o(r){let s=(r+e/60)%6;return a-a*t*Math.max(0,Math.min(s,4-s,1))}return[o(5),o(3),o(1)]},formats:{color:{id:"--hsv",coords:["<number> | <angle>","<percentage> | <number>","<percentage> | <number>"]}}}),Rs=new b({id:"hwb",name:"HWB",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},w:{range:[0,100],name:"Whiteness"},b:{range:[0,100],name:"Blackness"}},base:fo,fromBase(n){let[e,t,a]=n;return[e,a*(100-t)/100,100-a]},toBase(n){let[e,t,a]=n;t/=100,a/=100;let o=t+a;if(o>=1){let i=t/o;return[e,0,i*100]}let r=1-a,s=r===0?0:1-t/r;return[e,s*100,r*100]},formats:{hwb:{coords:["<number> | <angle>","<percentage> | <number>","<percentage> | <number>"]}}});const ks=[[.5766690429101305,.1855582379065463,.1882286462349947],[.29734497525053605,.6273635662554661,.07529145849399788],[.02703136138641234,.07068885253582723,.9913375368376388]],Hs=[[2.0415879038107465,-.5650069742788596,-.34473135077832956],[-.9692436362808795,1.8759675015077202,.04155505740717557],[.013444280632031142,-.11836239223101838,1.0151749943912054]];var Co=new U({id:"a98rgb-linear",cssId:"--a98-rgb-linear",name:"Linear Adobe® 98 RGB compatible",white:"D65",toXYZ_M:ks,fromXYZ_M:Hs}),zs=new U({id:"a98rgb",cssId:"a98-rgb",name:"Adobe® 98 RGB compatible",base:Co,toBase:n=>n.map(e=>Math.pow(Math.abs(e),563/256)*Math.sign(e)),fromBase:n=>n.map(e=>Math.pow(Math.abs(e),256/563)*Math.sign(e))});const Fs=[[.7977666449006423,.13518129740053308,.0313477341283922],[.2880748288194013,.711835234241873,8993693872564e-17],[0,0,.8251046025104602]],Ds=[[1.3457868816471583,-.25557208737979464,-.05110186497554526],[-.5446307051249019,1.5082477428451468,.02052744743642139],[0,0,1.2119675456389452]];var xo=new U({id:"prophoto-linear",cssId:"--prophoto-rgb-linear",name:"Linear ProPhoto",white:"D50",base:pt,toXYZ_M:Fs,fromXYZ_M:Ds});const Ns=1/512,_s=16/512;var Vs=new U({id:"prophoto",cssId:"prophoto-rgb",name:"ProPhoto",base:xo,toBase(n){return n.map(e=>{let t=e<0?-1:1,a=e*t;return a<_s?e/16:t*a**1.8})},fromBase(n){return n.map(e=>{let t=e<0?-1:1,a=e*t;return a>=Ns?t*a**(1/1.8):16*e})}});const cn=1.09929682680944,aa=.018053968510807;var Gs=new U({id:"--rec2020-oetf",name:"REC.2020_Scene_Referred",base:Qe,referred:"scene",toBase(n){return n.map(function(e){let t=e<0?-1:1,a=e*t;return a<aa*4.5?e/4.5:t*Math.pow((a+cn-1)/cn,1/.45)})},fromBase(n){return n.map(function(e){let t=e<0?-1:1,a=e*t;return a>=aa?t*(cn*Math.pow(a,.45)-(cn-1)):4.5*e})}}),js=new b({id:"oklch",name:"OkLCh",coords:{l:{refRange:[0,1],name:"Lightness"},c:{refRange:[0,.4],name:"Chroma"},h:{refRange:[0,360],type:"angle",name:"Hue"}},white:"D65",base:re,fromBase:ee.fromBase,toBase:ee.toBase,formats:{oklch:{coords:["<percentage> | <number>","<number> | <percentage>","<number> | <angle>"]}}});const Fe=2*Math.PI,Cn=[[4.076741636075958,-3.307711539258063,.2309699031821043],[-1.2684379732850315,2.609757349287688,-.341319376002657],[-.0041960761386756,-.7034186179359362,1.7076146940746117]],xn=[[[-1.8817031,-.80936501],[1.19086277,1.76576728,.59662641,.75515197,.56771245]],[[1.8144408,-1.19445267],[.73956515,-.45954404,.08285427,.12541073,-.14503204]],[[.13110758,1.81333971],[1.35733652,-.00915799,-1.1513021,-.50559606,.00692167]]],Nn=Number.MAX_VALUE,Ye=.206,Ct=.03,qe=(1+Ye)/(1+Ct);function N(n,e){let t=n.length;if(t!==e.length)throw new Error(`Vectors of size ${t} and ${e.length} are not aligned`);let a=0;return n.forEach((o,r)=>{a+=o*e[r]}),a}function Xe(n){return .5*(qe*n-Ye+Math.sqrt((qe*n-Ye)*(qe*n-Ye)+4*Ct*qe*n))}function Re(n){return(n**2+Ye*n)/(qe*(n+Ct))}function xt(n){let[e,t]=n;return[t/e,t/(1-e)]}function Us(n,e){let t=.11516993+1/(7.4477897+4.1590124*e+n*(-2.19557347+1.75198401*e+n*(-2.13704948-10.02301043*e+n*(-4.24894561+5.38770819*e+4.69891013*n)))),a=.11239642+1/(1.6132032-.68124379*e+n*(.40370612+.90148123*e+n*(-.27087943+.6122399*e+n*(.00299215-.45399568*e-.14661872*n))));return[t,a]}function bt(n,e){let t=O(n,he);return t[0]=t[0]**3,t[1]=t[1]**3,t[2]=t[2]**3,O(t,e,t)}function vn(n,e,t,a){let o=qs(n,e,t,a),r=bt([1,o*n,o*e],t),s=H(1/Math.max(...r),1/3),i=s*o;return[s,i]}function $s(n,e,t,a,o,r,s,i){let l;if(i===void 0&&(i=vn(n,e,r,s)),(t-o)*i[1]-(i[0]-o)*a<=0)l=i[1]*o/(a*i[0]+i[1]*(o-t));else{l=i[1]*(o-1)/(a*(i[0]-1)+i[1]*(o-t));let c=t-o,d=a,u=N(he[0].slice(1),[n,e]),m=N(he[1].slice(1),[n,e]),p=N(he[2].slice(1),[n,e]),h=c+d*u,f=c+d*m,g=c+d*p,C=o*(1-l)+l*t,x=l*a,S=C+x*u,I=C+x*m,B=C+x*p,z=S**3,y=I**3,P=B**3,M=3*h*S**2,$=3*f*I**2,j=3*g*B**2,ae=6*h**2*S,se=6*f**2*I,oe=6*g**2*B,be=N(r[0],[z,y,P])-1,q=N(r[0],[M,$,j]),Ae=N(r[0],[ae,se,oe]),Me=q/(q*q-.5*be*Ae),ue=-be*Me,ie=N(r[1],[z,y,P])-1,me=N(r[1],[M,$,j]),_e=N(r[1],[ae,se,oe]),ve=me/(me*me-.5*ie*_e),le=-ie*ve,Y=N(r[2],[z,y,P])-1,Ve=N(r[2],[M,$,j]),Ln=N(r[2],[ae,se,oe]),ce=Ve/(Ve*Ve-.5*Y*Ln),Ge=-Y*ce;ue=Me>=0?ue:Nn,le=ve>=0?le:Nn,Ge=ce>=0?Ge:Nn,l+=Math.min(ue,Math.min(le,Ge))}return l}function bo(n,e,t){let[a,o,r]=n,s=vn(o,r,e,t),i=$s(o,r,a,1,a,e,t,s),l=xt(s),c=i/Math.min(a*l[0],(1-a)*l[1]),d=Us(o,r),u=a*d[0],m=(1-a)*d[1],p=.9*c*Math.sqrt(Math.sqrt(1/(1/u**4+1/m**4)));return u=a*.4,m=(1-a)*.8,[Math.sqrt(1/(1/u**2+1/m**2)),p,i]}function qs(n,e,t,a){let o,r,s,i,l,c,d,u;N(a[0][0],[n,e])>1?([o,r,s,i,l]=a[0][1],[c,d,u]=t[0]):N(a[1][0],[n,e])>1?([o,r,s,i,l]=a[1][1],[c,d,u]=t[1]):([o,r,s,i,l]=a[2][1],[c,d,u]=t[2]);let m=o+r*n+s*e+i*n**2+l*n*e,p=N(he[0].slice(1),[n,e]),h=N(he[1].slice(1),[n,e]),f=N(he[2].slice(1),[n,e]),g=1+m*p,C=1+m*h,x=1+m*f,S=g**3,I=C**3,B=x**3,z=3*p*g**2,y=3*h*C**2,P=3*f*x**2,M=6*p**2*g,$=6*h**2*C,j=6*f**2*x,ae=c*S+d*I+u*B,se=c*z+d*y+u*P,oe=c*M+d*$+u*j;return m=m-ae*se/(se**2-.5*ae*oe),m}function Ws(n,e,t){let[a,o,r]=n,s=Re(r),i=null,l=null;if(a=te(a)/360,s!==0&&s!==1&&o!==0){let c=Math.cos(Fe*a),d=Math.sin(Fe*a),[u,m,p]=bo([s,c,d],e,t),h=.8,f=1.25,g,C,x,S;o<h?(g=f*o,C=0,x=h*u,S=1-x/m):(g=5*(o-.8),C=m,x=.2*m**2*1.25**2/u,S=1-x/(p-m));let I=C+g*x/(1-S*g);i=I*c,l=I*d}return[s,i,l]}function Ys(n,e,t){let a=1e-7,o=1e-4,r=n[0],s=0,i=Xe(r),l=Math.sqrt(n[1]**2+n[2]**2),c=.5+Math.atan2(-n[2],-n[1])/Fe;if(i!==0&&i!==1&&l!==0){let u=n[1]/l,m=n[2]/l,[p,h,f]=bo([r,u,m],e,t),g=.8,C=1.25,x,S,I,B;l<h?(S=g*p,I=1-S/h,B=l/(S+I*l),s=B*g):(x=h,S=.2*h**2*C**2/p,I=1-S/(f-h),B=(l-x)/(S+I*(l-x)),s=g+.2*B)}const d=Math.abs(s)<o;return d||i===0||Math.abs(1-i)<a?(c=null,d||(s=0)):c=te(c*360),[c,s,i]}var Xs=new b({id:"okhsl",name:"Okhsl",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},s:{range:[0,1],name:"Saturation"},l:{range:[0,1],name:"Lightness"}},base:re,gamutSpace:"self",fromBase(n){return Ys(n,Cn,xn)},toBase(n){return Ws(n,Cn,xn)},formats:{color:{id:"--okhsl",coords:["<number> | <angle>","<percentage> | <number>","<percentage> | <number>"]}}}),yo=new b({id:"oklrab",name:"Oklrab",coords:{l:{refRange:[0,1],name:"Lightness"},a:{refRange:[-.4,.4]},b:{refRange:[-.4,.4]}},white:"D65",base:re,fromBase(n){return[Xe(n[0]),n[1],n[2]]},toBase(n){return[Re(n[0]),n[1],n[2]]},formats:{color:{coords:["<percentage> | <number>","<number> | <percentage>[-1,1]","<number> | <percentage>[-1,1]"]}}}),Zs=new b({id:"oklrch",name:"Oklrch",coords:{l:{refRange:[0,1],name:"Lightness"},c:{refRange:[0,.4],name:"Chroma"},h:{refRange:[0,360],type:"angle",name:"Hue"}},white:"D65",base:yo,fromBase:ee.fromBase,toBase:ee.toBase,formats:{color:{coords:["<percentage> | <number>","<number> | <percentage>[0,1]","<number> | <angle>"]}}});function Ks(n,e,t){let[a,o,r]=n;a=te(a)/360;let s=Re(r),i=null,l=null;if(s!==0&&o!==0){let c=Math.cos(Fe*a),d=Math.sin(Fe*a),u=vn(c,d,e,t),[m,p]=xt(u),h=.5,f=1-h/m,g=1-o*h/(h+p-p*f*o),C=o*p*h/(h+p-p*f*o);s=r*g;let x=r*C,S=Re(g),I=C*S/g,B=Re(s);x=x*B/s,s=B;let[z,y,P]=bt([S,c*I,d*I],e),M=H(1/Math.max(Math.max(z,y),Math.max(P,0)),1/3);s=s*M,x=x*M,i=x*c,l=x*d}return[s,i,l]}function Js(n,e,t){let a=1e-4,o=n[0],r=0,s=Xe(o),i=Math.sqrt(n[1]**2+n[2]**2),l=.5+Math.atan2(-n[2],-n[1])/Fe;if(o!==0&&o!==1&&i!==0){let c=n[1]/i,d=n[2]/i,u=vn(c,d,e,t),[m,p]=xt(u),h=.5,f=1-h/m,g=p/(i+o*p),C=g*o,x=g*i,S=Re(C),I=x*S/C,[B,z,y]=bt([S,c*I,d*I],e),P=H(1/Math.max(Math.max(B,z),Math.max(y,0)),1/3);o=o/P,i=i/P,i=i*Xe(o)/o,o=Xe(o),s=o/C,r=(h+p)*x/(p*h+p*f*x)}return Math.abs(r)<a||s===0?l=null:l=te(l*360),[l,r,s]}var Qs=new b({id:"okhsv",name:"Okhsv",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},s:{range:[0,1],name:"Saturation"},v:{range:[0,1],name:"Value"}},base:re,gamutSpace:"self",fromBase(n){return Js(n,Cn,xn)},toBase(n){return Ks(n,Cn,xn)},formats:{color:{id:"--okhsv",coords:["<number> | <angle>","<percentage> | <number>","<percentage> | <number>"]}}});let So=W.D65;const ei=216/24389,oa=24389/27,[ra,sa]=Mn({space:V,coords:So});var Po=new b({id:"luv",name:"Luv",coords:{l:{refRange:[0,100],name:"Lightness"},u:{refRange:[-215,215]},v:{refRange:[-215,215]}},white:So,base:V,fromBase(n){let e=[k(n[0]),k(n[1]),k(n[2])],t=e[1],[a,o]=Mn({space:V,coords:e});if(!Number.isFinite(a)||!Number.isFinite(o))return[0,0,0];let r=t<=ei?oa*t:116*Math.cbrt(t)-16;return[r,13*r*(a-ra),13*r*(o-sa)]},toBase(n){let[e,t,a]=n;if(e===0||v(e))return[0,0,0];t=k(t),a=k(a);let o=t/(13*e)+ra,r=a/(13*e)+sa,s=e<=8?e/oa:Math.pow((e+16)/116,3);return[s*(9*o/(4*r)),s,s*((12-3*o-20*r)/(4*r))]},formats:{color:{id:"--luv",coords:["<number> | <percentage>","<number> | <percentage>","<number> | <percentage>"]}}}),yt=new b({id:"lchuv",name:"LChuv",coords:{l:{refRange:[0,100],name:"Lightness"},c:{refRange:[0,220],name:"Chroma"},h:{refRange:[0,360],type:"angle",name:"Hue"}},base:Po,fromBase:ee.fromBase,toBase:ee.toBase,formats:{color:{id:"--lchuv",coords:["<number> | <percentage>","<number> | <percentage>","<number> | <angle>"]}}});const ni=216/24389,ti=24389/27,ia=D[0][0],la=D[0][1],_n=D[0][2],ca=D[1][0],da=D[1][1],Vn=D[1][2],ua=D[2][0],ma=D[2][1],Gn=D[2][2];function we(n,e,t){const a=e/(Math.sin(t)-n*Math.cos(t));return a<0?1/0:a}function bn(n){const e=Math.pow(n+16,3)/1560896,t=e>ni?e:n/ti,a=t*(284517*ia-94839*_n),o=t*(838422*_n+769860*la+731718*ia),r=t*(632260*_n-126452*la),s=t*(284517*ca-94839*Vn),i=t*(838422*Vn+769860*da+731718*ca),l=t*(632260*Vn-126452*da),c=t*(284517*ua-94839*Gn),d=t*(838422*Gn+769860*ma+731718*ua),u=t*(632260*Gn-126452*ma);return{r0s:a/r,r0i:o*n/r,r1s:a/(r+126452),r1i:(o-769860)*n/(r+126452),g0s:s/l,g0i:i*n/l,g1s:s/(l+126452),g1i:(i-769860)*n/(l+126452),b0s:c/u,b0i:d*n/u,b1s:c/(u+126452),b1i:(d-769860)*n/(u+126452)}}function pa(n,e){const t=e/360*Math.PI*2,a=we(n.r0s,n.r0i,t),o=we(n.r1s,n.r1i,t),r=we(n.g0s,n.g0i,t),s=we(n.g1s,n.g1i,t),i=we(n.b0s,n.b0i,t),l=we(n.b1s,n.b1i,t);return Math.min(a,o,r,s,i,l)}var ai=new b({id:"hsluv",name:"HSLuv",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},s:{range:[0,100],name:"Saturation"},l:{range:[0,100],name:"Lightness"}},base:yt,gamutSpace:Pe,fromBase(n){let[e,t,a]=[k(n[0]),k(n[1]),k(n[2])],o;if(e>99.9999999)o=0,e=100;else if(e<1e-8)o=0,e=0;else{let r=bn(e),s=pa(r,a);o=t/s*100}return[a,o,e]},toBase(n){let[e,t,a]=[k(n[0]),k(n[1]),k(n[2])],o;if(a>99.9999999)a=100,o=0;else if(a<1e-8)a=0,o=0;else{let r=bn(a);o=pa(r,e)/100*t}return[a,o,e]},formats:{color:{id:"--hsluv",coords:["<number> | <angle>","<percentage> | <number>","<percentage> | <number>"]}}});D[0][0];D[0][1];D[0][2];D[1][0];D[1][1];D[1][2];D[2][0];D[2][1];D[2][2];function Le(n,e){return Math.abs(e)/Math.sqrt(Math.pow(n,2)+1)}function ha(n){let e=Le(n.r0s,n.r0i),t=Le(n.r1s,n.r1i),a=Le(n.g0s,n.g0i),o=Le(n.g1s,n.g1i),r=Le(n.b0s,n.b0i),s=Le(n.b1s,n.b1i);return Math.min(e,t,a,o,r,s)}var oi=new b({id:"hpluv",name:"HPLuv",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},s:{range:[0,100],name:"Saturation"},l:{range:[0,100],name:"Lightness"}},base:yt,gamutSpace:"self",fromBase(n){let[e,t,a]=[k(n[0]),k(n[1]),k(n[2])],o;if(e>99.9999999)o=0,e=100;else if(e<1e-8)o=0,e=0;else{let r=bn(e),s=ha(r);o=t/s*100}return[a,o,e]},toBase(n){let[e,t,a]=[k(n[0]),k(n[1]),k(n[2])],o;if(a>99.9999999)a=100,o=0;else if(a<1e-8)a=0,o=0;else{let r=bn(a);o=ha(r)/100*t}return[a,o,e]},formats:{color:{id:"--hpluv",coords:["<number> | <angle>","<percentage> | <number>","<percentage> | <number>"]}}}),St=new U({id:"rec2100-linear",name:"Linear REC.2100",white:"D65",toBase:Qe.toBase,fromBase:Qe.fromBase});const ga=203,fa=2610/2**14,ri=2**14/2610,si=2523/2**5,Ca=2**5/2523,xa=3424/2**12,ba=2413/2**7,ya=2392/2**7;var ii=new U({id:"rec2100pq",cssId:"rec2100-pq",name:"REC.2100-PQ",base:St,toBase(n){return n.map(function(e){return(Math.max(e**Ca-xa,0)/(ba-ya*e**Ca))**ri*1e4/ga})},fromBase(n){return n.map(function(e){let t=Math.max(e*ga/1e4,0),a=xa+ba*t**fa,o=1+ya*t**fa;return(a/o)**si})}});const Sa=.17883277,Pa=.28466892,Ia=.55991073,jn=3.7743;var li=new U({id:"rec2100hlg",cssId:"rec2100-hlg",name:"REC.2100-HLG",referred:"scene",base:St,toBase(n){return n.map(function(e){return e<=.5?e**2/3*jn:(Math.exp((e-Ia)/Sa)+Pa)/12*jn})},fromBase(n){return n.map(function(e){return e/=jn,e<=1/12?H(3*e,.5):Sa*Math.log(12*e-Pa)+Ia})}});const Io={};ge.add("chromatic-adaptation-start",n=>{n.options.method&&(n.M=Ao(n.W1,n.W2,n.options.method))});ge.add("chromatic-adaptation-end",n=>{n.M||(n.M=Ao(n.W1,n.W2,n.options.method))});function Bn({id:n,toCone_M:e,fromCone_M:t}){Io[n]=arguments[0]}function Ao(n,e,t="Bradford"){let a=Io[t],[o,r,s]=Ue(a.toCone_M,n),[i,l,c]=Ue(a.toCone_M,e),d=[[i/o,0,0],[0,l/r,0],[0,0,c/s]],u=Ue(d,a.toCone_M);return Ue(a.fromCone_M,u)}Bn({id:"von Kries",toCone_M:[[.40024,.7076,-.08081],[-.2263,1.16532,.0457],[0,0,.91822]],fromCone_M:[[1.8599363874558397,-1.1293816185800916,.21989740959619328],[.3611914362417676,.6388124632850422,-6370596838649899e-21],[0,0,1.0890636230968613]]});Bn({id:"Bradford",toCone_M:[[.8951,.2664,-.1614],[-.7502,1.7135,.0367],[.0389,-.0685,1.0296]],fromCone_M:[[.9869929054667121,-.14705425642099013,.15996265166373122],[.4323052697233945,.5183602715367774,.049291228212855594],[-.00852866457517732,.04004282165408486,.96848669578755]]});Bn({id:"CAT02",toCone_M:[[.7328,.4296,-.1624],[-.7036,1.6975,.0061],[.003,.0136,.9834]],fromCone_M:[[1.0961238208355142,-.27886900021828726,.18274517938277307],[.4543690419753592,.4735331543074117,.07209780371722911],[-.009627608738429355,-.00569803121611342,1.0153256399545427]]});Bn({id:"CAT16",toCone_M:[[.401288,.650173,-.051461],[-.250268,1.204414,.045854],[-.002079,.048952,.953127]],fromCone_M:[[1.862067855087233,-1.0112546305316845,.14918677544445172],[.3875265432361372,.6214474419314753,-.008973985167612521],[-.01584149884933386,-.03412293802851557,1.0499644368778496]]});Object.assign(W,{A:[1.0985,1,.35585],C:[.98074,1,1.18232],D55:[.95682,1,.92149],D75:[.94972,1,1.22638],E:[1,1,1],F2:[.99186,1,.67393],F7:[.95041,1,1.08747],F11:[1.00962,1,.6435]});W.ACES=[.32168/.33767,1,(1-.32168-.33767)/.33767];const ci=[[.6624541811085053,.13400420645643313,.1561876870049078],[.27222871678091454,.6740817658111484,.05368951740793705],[-.005574649490394108,.004060733528982826,1.0103391003129971]],di=[[1.6410233796943257,-.32480329418479,-.23642469523761225],[-.6636628587229829,1.6153315916573379,.016756347685530137],[.011721894328375376,-.008284441996237409,.9883948585390215]];var Mo=new U({id:"acescg",cssId:"--acescg",name:"ACEScg",coords:{r:{range:[0,65504],name:"Red"},g:{range:[0,65504],name:"Green"},b:{range:[0,65504],name:"Blue"}},referred:"scene",white:W.ACES,toXYZ_M:ci,fromXYZ_M:di});const dn=2**-16,Un=-.35828683,un=(Math.log2(65504)+9.72)/17.52;var ui=new U({id:"acescc",cssId:"--acescc",name:"ACEScc",coords:{r:{range:[Un,un],name:"Red"},g:{range:[Un,un],name:"Green"},b:{range:[Un,un],name:"Blue"}},referred:"scene",base:Mo,toBase(n){const e=-.3013698630136986;return n.map(function(t){return t<=e?(2**(t*17.52-9.72)-dn)*2:t<un?2**(t*17.52-9.72):65504})},fromBase(n){return n.map(function(e){return e<=0?(Math.log2(dn)+9.72)/17.52:e<dn?(Math.log2(dn+e*.5)+9.72)/17.52:(Math.log2(e)+9.72)/17.52})}}),Aa=Object.freeze({__proto__:null,A98RGB:zs,A98RGB_Linear:Co,ACEScc:ui,ACEScg:Mo,CAM16_JMh:Gr,HCT:Je,HPLuv:oi,HSL:Os,HSLuv:ai,HSV:fo,HWB:Rs,ICTCP:Zn,JzCzHz:Xn,Jzazbz:Xa,LCH:ee,LCHuv:yt,Lab:J,Lab_D65:Qn,Luv:Po,OKLCH:js,OKLab:re,OKLrCH:Zs,OKLrab:yo,Okhsl:Xs,Okhsv:Qs,P3:lo,P3_Linear:so,ProPhoto:Vs,ProPhoto_Linear:xo,REC_2020:ro,REC_2020_Linear:Qe,REC_2020_Scene_Referred:Gs,REC_2100_HLG:li,REC_2100_Linear:St,REC_2100_PQ:ii,XYZ_ABS_D65:ht,XYZ_D50:pt,XYZ_D65:V,sRGB:Pe,sRGB_Linear:io});let R=class X{constructor(...e){let t;if(e.length===1){let s={};typeof e[0]=="object"&&Object.getPrototypeOf(e[0]).constructor===Object&&(e[0]={...e[0]}),t=A(e[0],{parseMeta:s}),s.format&&(this.parseMeta=s)}let a,o,r;t?(a=t.space||t.spaceId,o=t.coords,r=t.alpha):[a,o,r]=e,Object.defineProperty(this,"space",{value:b.get(a),writable:!1,enumerable:!0,configurable:!0}),this.coords=o?o.slice():[0,0,0],this.alpha=v(r)?r:r===void 0?1:In(0,r,1);for(let s in this.space.coords)Object.defineProperty(this,s,{get:()=>this.get(s),set:i=>this.set(s,i)})}get spaceId(){return this.space.id}clone(){return new X(this.space,this.coords,this.alpha)}toJSON(){return{spaceId:this.spaceId,coords:this.coords,alpha:this.alpha}}display(...e){let t=os(this,...e);return t.color=new X(t.color),t}static get(e,...t){return ke(e,this)?e:new X(e,...t)}static try(e,t){if(ke(e,this))return e;let a=$a(e,t);return a?new X(a):null}static defineFunction(e,t,a=t){let{instance:o=!0,returns:r}=a,s=function(...i){let l=t(...i);if(r==="color")l=X.get(l);else if(r==="function<color>"){let c=l;l=function(...d){let u=c(...d);return X.get(u)},Object.assign(l,c)}else r==="array<color>"&&(l=l.map(c=>X.get(c)));return l};e in X||(X[e]=s),o&&(X.prototype[e]=function(...i){return s(this,...i)})}static defineFunctions(e){for(let t in e)X.defineFunction(t,e[t],e[t])}static extend(e){if(e.register)e.register(X);else for(let t in e)X.defineFunction(t,e[t])}};R.defineFunctions({get:K,getAll:nn,set:de,setAll:mt,to:w,equals:ss,inGamut:Se,toGamut:fe,distance:Ya,deltas:rs,toString:We});Object.assign(R,{util:ar,hooks:ge,WHITES:W,Space:b,spaces:b.registry,parse:ja,defaults:Q});for(let n of Object.keys(Aa))b.register(Aa[n]);for(let n in b.registry)et(n,b.registry[n]);ge.add("colorspace-init-end",n=>{var e;et(n.id,n),(e=n.aliases)==null||e.forEach(t=>{et(t,n)})});function et(n,e){let t=n.replace(/-/g,"_");Object.defineProperty(R.prototype,t,{get(){let a=this.getAll(n);if(typeof Proxy>"u")return a;let o=new Proxy(a,{has:(r,s)=>{try{return b.resolveCoord([e,s]),!0}catch{}return Reflect.has(r,s)},get:(r,s,i)=>{if(s&&typeof s!="symbol"&&!(s in r)&&s in o){let{index:l}=b.resolveCoord([e,s]);if(l>=0)return r[l]}return Reflect.get(r,s,i)},set:(r,s,i,l)=>{if(s&&typeof s!="symbol"&&!(s in r)||Number(s)>=0){let{index:c}=b.resolveCoord([e,s]);if(c>=0)return r[c]=i,this.setAll(n,r),!0}return Reflect.set(r,s,i,l)}});return o},set(a){this.setAll(n,a)},configurable:!0,enumerable:!0})}R.extend(ze);R.extend({deltaE:$e});Object.assign(R,{deltaEMethods:ze});R.extend(Es);R.extend({contrast:vs});R.extend(Ts);R.extend(ls);R.extend(Ls);R.extend(mn);function Tn(n){return String(n??"").trim().toUpperCase()}function T(n,e,t){return Math.min(t,Math.max(e,n))}function Ie(n,e=0){const t=Number.isFinite(Number(n))?Number(n):Number(e);return Number.isFinite(t)?(t%360+360)%360:0}function G(n){if(n instanceof R)return n;if(n&&typeof n=="object"&&Number.isFinite(n.r)&&Number.isFinite(n.g)&&Number.isFinite(n.b))try{return new R("srgb",[T((n.r||0)/255,0,1),T((n.g||0)/255,0,1),T((n.b||0)/255,0,1)])}catch{return null}if(n&&typeof n=="object"&&Number.isFinite(n.h)&&Number.isFinite(n.s)&&Number.isFinite(n.l))try{return new R("hsl",[Ie(n.h),T(n.s,0,100),T(n.l,0,100)])}catch{return null}if(n&&typeof n=="object"&&typeof n.hex=="string")return G(n.hex);if(n&&typeof n=="object"&&typeof n.space<"u"&&Array.isArray(n.coords))try{return new R(n)}catch{return null}const e=String(n??"").trim();if(!e)return null;try{return new R(e)}catch{return null}}function xe(n){const e=G(n);if(!e)return null;try{return Tn(e.to("srgb").toString({format:"hex",alpha:!1,collapse:!1}))}catch{return null}}function mi(n){const e=Tn(n);return L.HEX_6_REGEX.test(e)&&xe(e)===e}function pi(n){const e=String(n??"").trim();if(!e)return null;const t=G(e),a=xe(t);if(!t||!a)return null;const o=t.to("srgb"),r=t.to("hsl"),s=t.to("oklch"),[i=0,l=0,c=0]=o.coords||[],[d=0,u=0,m=0]=r.coords||[],[p=0,h=0,f=Number.NaN]=s.coords||[];return{color:t,inputValue:e,css:a,hex:a,rgb:[Math.round(T(i,0,1)*255),Math.round(T(l,0,1)*255),Math.round(T(c,0,1)*255)],hsl:{h:Ie(d),s:T(u,0,100),l:T(m,0,100)},oklch:{l:T(p,0,1),c:T(h,0,.4),h:Ie(f,d)}}}function yn(n){var r;if(n&&typeof n=="object"&&Number.isFinite(n.r)&&Number.isFinite(n.g)&&Number.isFinite(n.b))return{r:Math.round(T(n.r,0,255)),g:Math.round(T(n.g,0,255)),b:Math.round(T(n.b,0,255))};const e=(r=G(n))==null?void 0:r.to("srgb"),[t=0,a=0,o=0]=(e==null?void 0:e.coords)||[];return{r:Math.round(T(t,0,1)*255),g:Math.round(T(a,0,1)*255),b:Math.round(T(o,0,1)*255)}}function hi(n){return n&&typeof n=="object"&&Number.isFinite(n.r)&&Number.isFinite(n.g)&&Number.isFinite(n.b)?Tn(`#${[n.r,n.g,n.b].map(e=>T(Math.round(e),0,255).toString(16).padStart(2,"0")).join("")}`):xe(n)}function gi(n,e,t){return xe(new R("hsl",[Ie(n),T(Number(e),0,100),T(Number(t),0,100)]))}function fi(n){var r;const e=(r=G(n))==null?void 0:r.to("hsl"),[t=0,a=0,o=0]=(e==null?void 0:e.coords)||[];return{h:Ie(t),s:T(a,0,100),l:T(o,0,100)}}function Pt(n,e={}){var r,s,i;const t=G(n);if(!t)return null;const a=Number.isFinite(e.maxChroma)?Number(e.maxChroma):.4,o=Number.isFinite(e.fallbackHue)?Number(e.fallbackHue):((i=(s=(r=G(n))==null?void 0:r.to("hsl"))==null?void 0:s.coords)==null?void 0:i[0])||0;try{const l=t.to("oklch"),[c=0,d=0,u=Number.NaN]=l.coords||[];return{l:T(c,0,1),c:T(d,0,a),h:Ie(u,o)}}catch{return null}}function Ci(n,e={}){return Pt(n,e)}function xi(n,e,t,a={}){const o=Number.isFinite(a.minLightness)?Number(a.minLightness):0,r=Number.isFinite(a.maxLightness)?Number(a.maxLightness):1,s=Number.isFinite(a.maxChroma)?Number(a.maxChroma):.4,i=a.outputSpace||"srgb",l=a.gamutMethod||"oklch.c";let c=null;try{c=new R("oklch",[T(Number(n),o,r),T(Number(e),0,s),Ie(t,a.fallbackHue)])}catch{return null}if(typeof c.toGamut=="function")try{c=c.toGamut({space:i,method:l})}catch{return null}return xe(c)}function bi(n){const e=G(n);return e?e.luminance:0}function yi(n){const e=Pt(n);if(e)return e.l;const{r:t,g:a,b:o}=yn(n);return(t*299+a*587+o*114)/2550}function vo(n,e){const t=yn(n),a=yn(e),o=t.r-a.r,r=t.g-a.g,s=t.b-a.b;return Math.sqrt(o*o+r*r+s*s)}function Si(n,e,t={}){const a=String(t.method||"deltae76").toLowerCase();if(a==="rgb")return vo(n,e);const o=G(n),r=G(e);return!o||!r?Number.POSITIVE_INFINITY:a==="deltae2000"||a==="2000"?o.deltaE(r,"2000"):o.deltaE(r,"76")}function nt(n,e){const t=G(n),a=G(e);return!t||!a?1:t.contrast(a,"WCAG21")}function Pi(n,e={}){const t=e.lightColor||"#FFFFFF",a=e.darkColor||"#000000",o=nt(t,n),r=nt(a,n);return o>=r?t:a}function Ii(n,e,t,a={}){const o=G(n),r=G(e);if(!o||!r)return null;const s=o.range(r,{space:a.space||"srgb",outputSpace:"srgb"});return xe(s(T(Number(t),0,1)))}function Ai(n,e,t,a={}){const o=G(n),r=G(e),s=Math.max(2,Math.round(Number(t)||0));return!o||!r?[]:o.steps(r,{space:a.space||"oklch",outputSpace:a.outputSpace||"srgb",steps:s}).map(i=>xe(i)).filter(Boolean)}const en={Color:R,createColor:G,parseCssColor:pi,colorToHex:xe,normalizeHexColor:Tn,isValidHexColor:mi,hexToRgb:yn,rgbToHex:hi,hslToHex:gi,hexToHsl:fi,colorToOklch:Pt,hexToOklch:Ci,oklchToHex:xi,getRelativeLuminance:bi,getPerceivedLightness:yi,getRgbDistance:vo,getColorDistance:Si,getContrastRatio:nt,getReadableTextColor:Pi,mixHexColors:Ii,getHexColorSteps:Ai};window.Color=R;window.AppColorUtils=en;const{normalizeHexColor:En,isValidHexColor:wn}=en,$n=Array.isArray(L.DEFAULT_TARGET_COLORS)?L.DEFAULT_TARGET_COLORS.map(n=>En(n)).filter(n=>wn(n)):[],Ma=En(L.DEFAULT_COLOR_BASE||""),Bo=$n.length>0?$n[Math.floor(Math.random()*$n.length)]:wn(Ma)?Ma:null;let ne={palette:[],activeColor:Bo,lastSource:null};function De(){return{palette:[...ne.palette],activeColor:ne.activeColor,lastSource:ne.lastSource}}function To(n,e={}){Fa("shared-colors:changed",{type:n,state:De(),metadata:e})}function Mi(n){return Array.isArray(n)?n.map(e=>En(e)).filter(e=>wn(e)):[]}function vi(n,e={}){const t=Mi(n);return(t.length!==ne.palette.length||t.some((o,r)=>o!==ne.palette[r]))&&(ne={...ne,palette:t,lastSource:String(e.source||ne.lastSource||"")},To("palette",e)),De()}function Bi(n,e={}){const t=En(n),a=wn(t)?t:null;return a===ne.activeColor||(ne={...ne,activeColor:a,lastSource:String(e.source||ne.lastSource||"")},To("activeColor",e)),De()}function Ti(n){return Ha("shared-colors:changed",n)}const _={getState:De,getDefaultActiveColor(){return Bo},setPalette:vi,setActiveColor:Bi,subscribe:Ti};window.AppSharedColors=_;const Ei=new Set(["automatic","monochromatic","complementary","analogous","triad","tetrad"]),wi=new Set(["color","temperature","image"]),Li=new Set(["automatic","shades","tints"]),Oi=new Set(["soft","medium","intense"]),{normalizeHexColor:Ze,isValidHexColor:It}=en,tt=new Set;function Sn(n,e){return Number.isFinite(n)?Math.min(100,Math.max(0,Number(n))):e}function at(n){return Array.isArray(n)?n.map(e=>Ze(e)).filter(e=>It(e)):[]}function Eo(n){return wi.has(n)?n:L.DEFAULT_PALETTE_BASE_MODE}function ot(n,e=L.DEFAULT_COLOR_PALETTE_TYPE){return Ei.has(n)?n:e}function wo(n){return Li.has(n)?n:L.DEFAULT_MONOCHROMATIC_GENERATION_MODE}function Lo(n){return Oi.has(n)?n:L.DEFAULT_ANALOGOUS_SEPARATION_MODE}function Oo(n,e){const t=!!(n!=null&&n.warm),a=!!(n!=null&&n.cool);return!t&&!a?{...e}:{warm:t,cool:a}}function Ri(n){if(!n||typeof n!="object")return null;const e=String(n.dataUrl||"").trim();return e?{name:String(n.name||""),type:String(n.type||""),dataUrl:e,analysisCache:n.analysisCache??null}:null}function ki(n){if(Array.isArray(n)){const r=at(n);return r.length===0?null:{colors:r,createdAt:null,isAlternative:!1,pinnedIndexes:[],settings:null}}if(!n||typeof n!="object")return null;const e=n,t=at(e.colors);if(t.length===0)return null;const a=e.createdAt,o=a instanceof Date?new Date(a.getTime()):typeof a=="string"?a:null;return{colors:t,createdAt:o,isAlternative:!!e.isAlternative,pinnedIndexes:Array.isArray(e.pinnedIndexes)?e.pinnedIndexes.map(r=>Number(r)).filter(r=>Number.isFinite(r)&&r>=0):[],settings:e.settings&&typeof e.settings=="object"?{...e.settings}:null}}function Hi(n){return Array.isArray(n)?n.map(ki).filter(e=>!!e):[]}function zi(n){return n?{...n,analysisCache:n.analysisCache&&typeof n.analysisCache=="object"?{...n.analysisCache}:n.analysisCache}:null}function Fi(n){return{colors:[...n.colors],createdAt:n.createdAt instanceof Date?new Date(n.createdAt.getTime()):n.createdAt??null,isAlternative:!!n.isAlternative,pinnedIndexes:[...n.pinnedIndexes],settings:n.settings&&typeof n.settings=="object"?{...n.settings}:null}}function Di(n){return{...n,paletteHistory:n.paletteHistory.map(Fi),uploadedBaseImage:zi(n.uploadedBaseImage),temperature:{...n.temperature},currentPalette:[...n.currentPalette],adjustments:{...n.adjustments}}}function Ni(n={}){const e=Pn();tt.forEach(t=>{t(e,n)})}var Ra,ka;const va=((Ra=_.getDefaultActiveColor)==null?void 0:Ra.call(_))||((ka=_.getState)==null?void 0:ka.call(_).activeColor)||L.DEFAULT_COLOR_BASE;let E={paletteSize:Number(L.DEFAULT_PALETTE_SIZE)||0,paletteHistory:[],paletteHistoryIndex:-1,paletteBaseMode:Eo(L.DEFAULT_PALETTE_BASE_MODE),uploadedBaseImage:null,prioritizeImageDominantColors:!0,imagePaletteVariantIndex:0,imageInspirationVariantIndex:0,colorPaletteVariantIndex:0,selectedPaletteBaseColor:It(Ze(va))?Ze(va):Ze(L.DEFAULT_COLOR_BASE),selectedColorPaletteType:ot(L.DEFAULT_COLOR_PALETTE_TYPE),selectedMonochromaticGenerationMode:wo(L.DEFAULT_MONOCHROMATIC_GENERATION_MODE),selectedAnalogousSeparationMode:Lo(L.DEFAULT_ANALOGOUS_SEPARATION_MODE),resolvedAutomaticColorPaletteType:"triad",temperature:Oo(L.DEFAULT_TEMPERATURE,{warm:!0,cool:!1}),currentPalette:[],adjustments:{brightness:Sn(L.DEFAULT_BRIGHTNESS,L.DEFAULT_BRIGHTNESS),saturation:Sn(L.DEFAULT_SATURATION,L.DEFAULT_SATURATION)}};function je(n,e={}){var a,o;if(!n||typeof n!="object")return Pn();const t={...E,paletteSize:Number.isFinite(n.paletteSize)?Math.max(0,Number(n.paletteSize)):E.paletteSize,paletteHistory:Object.prototype.hasOwnProperty.call(n,"paletteHistory")?Hi(n.paletteHistory):E.paletteHistory,paletteHistoryIndex:Number.isFinite(n.paletteHistoryIndex)?Number(n.paletteHistoryIndex):E.paletteHistoryIndex,paletteBaseMode:Object.prototype.hasOwnProperty.call(n,"paletteBaseMode")?Eo(n.paletteBaseMode):E.paletteBaseMode,uploadedBaseImage:Object.prototype.hasOwnProperty.call(n,"uploadedBaseImage")?Ri(n.uploadedBaseImage):E.uploadedBaseImage,prioritizeImageDominantColors:Object.prototype.hasOwnProperty.call(n,"prioritizeImageDominantColors")?!!n.prioritizeImageDominantColors:E.prioritizeImageDominantColors,imagePaletteVariantIndex:Number.isFinite(n.imagePaletteVariantIndex)?Math.max(0,Number(n.imagePaletteVariantIndex)):E.imagePaletteVariantIndex,imageInspirationVariantIndex:Number.isFinite(n.imageInspirationVariantIndex)?Math.max(0,Number(n.imageInspirationVariantIndex)):E.imageInspirationVariantIndex,colorPaletteVariantIndex:Number.isFinite(n.colorPaletteVariantIndex)?Math.max(0,Number(n.colorPaletteVariantIndex)):E.colorPaletteVariantIndex,selectedPaletteBaseColor:Object.prototype.hasOwnProperty.call(n,"selectedPaletteBaseColor")?(()=>{const r=Ze(n.selectedPaletteBaseColor);return It(r)?r:E.selectedPaletteBaseColor})():E.selectedPaletteBaseColor,selectedColorPaletteType:Object.prototype.hasOwnProperty.call(n,"selectedColorPaletteType")?ot(n.selectedColorPaletteType,E.selectedColorPaletteType):E.selectedColorPaletteType,selectedMonochromaticGenerationMode:Object.prototype.hasOwnProperty.call(n,"selectedMonochromaticGenerationMode")?wo(n.selectedMonochromaticGenerationMode):E.selectedMonochromaticGenerationMode,selectedAnalogousSeparationMode:Object.prototype.hasOwnProperty.call(n,"selectedAnalogousSeparationMode")?Lo(n.selectedAnalogousSeparationMode):E.selectedAnalogousSeparationMode,resolvedAutomaticColorPaletteType:Object.prototype.hasOwnProperty.call(n,"resolvedAutomaticColorPaletteType")?ot(n.resolvedAutomaticColorPaletteType,E.resolvedAutomaticColorPaletteType):E.resolvedAutomaticColorPaletteType,temperature:Object.prototype.hasOwnProperty.call(n,"temperature")?Oo(n.temperature,E.temperature):{...E.temperature},currentPalette:Object.prototype.hasOwnProperty.call(n,"currentPalette")?at(n.currentPalette):E.currentPalette,adjustments:{brightness:Object.prototype.hasOwnProperty.call(n,"adjustments")?Sn((a=n.adjustments)==null?void 0:a.brightness,E.adjustments.brightness):E.adjustments.brightness,saturation:Object.prototype.hasOwnProperty.call(n,"adjustments")?Sn((o=n.adjustments)==null?void 0:o.saturation,E.adjustments.saturation):E.adjustments.saturation}};return t.paletteHistory.length===0?t.paletteHistoryIndex=-1:t.paletteHistoryIndex=Math.max(-1,Math.min(t.paletteHistoryIndex,t.paletteHistory.length-1)),E=t,Ni(e),Pn()}function Pn(){return Di(E)}function _i(n){return typeof n!="function"?()=>{}:(tt.add(n),()=>{tt.delete(n)})}const Vi={getState:Pn,patchState:je,syncFromLegacy(n,e={}){return je(n,{...e,source:e.source||"legacy"})},syncCurrentPalette(n,e={}){return je({currentPalette:n},e)},syncHistory(n,e,t={}){return je({paletteHistory:n,paletteHistoryIndex:e},t)},syncAdjustments(n,e={}){return je({adjustments:n},e)},subscribe:_i};window.PaletteGeneratorStore=Vi;function Gi(){if(window.AppDom)return window.AppDom;const n=document.getElementById("palette"),e=document.querySelector(".controls"),t=document.querySelector(".palette-section"),a=document.getElementById("history"),o=document.getElementById("paletteBaseControlGroup"),r=document.getElementById("paletteBaseModeSelect"),s=document.getElementById("colorBasePanel"),i=document.getElementById("temperatureBasePanel"),l=document.getElementById("imageBasePanel"),c=document.getElementById("paletteColorSwatchBtn"),d=document.getElementById("paletteColorSwatchFill"),u=document.getElementById("paletteColorTextInput"),m=document.getElementById("paletteColorInputFeedback"),p=document.getElementById("paletteColorPicker"),h=document.getElementById("paletteTypeOptions"),f=document.getElementById("paletteTypeResolvedLabel"),g=document.getElementById("monochromaticModeControl"),C=document.getElementById("monochromaticModeSelect"),x=document.getElementById("analogousSeparationControl"),S=document.getElementById("analogousSeparationSelect"),I=document.getElementById("paletteImageInput"),B=document.getElementById("paletteImageDropzonePanel"),z=document.getElementById("paletteImageDropzone"),y=document.getElementById("paletteImagePreview"),P=document.getElementById("paletteImagePreviewImg"),M=document.getElementById("paletteImageName"),$=document.getElementById("paletteImageDominantToggle"),j=document.getElementById("paletteImageReplaceBtn"),ae=document.getElementById("paletteIntensityControlGroup"),se=document.getElementById("brightnessControlGroup"),oe=document.getElementById("brightness"),be=document.getElementById("saturation"),q=document.getElementById("saturationControlGroup"),Ae=document.getElementById("paletteAdjustBtn"),Me=document.getElementById("paletteAdjustPanel"),ue=document.getElementById("paletteUndoBtn"),ie=document.getElementById("paletteRedoBtn"),me=document.getElementById("paletteViewport"),_e=document.getElementById("paletteLoadingOverlay"),ve=document.getElementById("paletteImageExtractionAlert"),le=document.getElementById("addColorBtn"),Y=document.getElementById("colorPicker"),Ve=document.querySelector(".add-color"),Ln=document.getElementById("paletteGenerationButtons"),ce=document.getElementById("copyHexBtn"),Ge=document.getElementById("paletteRegenerateBtn"),zo=document.getElementById("paletteInspirationBtn"),Fo=document.getElementById("generateBtn"),Do=document.getElementById("surpriseBtn"),No=(ce==null?void 0:ce.querySelector(".tooltip"))??null,_o=(ce==null?void 0:ce.querySelector("span"))??null,Vo=document.getElementById("resetPaletteBtn"),Go=document.getElementById("warmBtn"),jo=document.getElementById("coolBtn"),Uo=document.querySelectorAll(".size"),$o=(le==null?void 0:le.querySelector("span"))??null,qo=document.getElementById("brightnessValue"),Mt=document.querySelectorAll(".brightness-labels .brightness-icon"),Wo=Mt[0]||null,Yo=Mt[1]||null,Xo=document.getElementById("saturationValue"),vt=document.querySelectorAll(".saturation-labels .saturation-icon"),Zo=vt[0]||null,Ko=vt[1]||null;let Be=document.querySelector(".card-edit-input");Be||(Be=document.createElement("input"),Be.type="color",Be.className="card-edit-input",document.body.appendChild(Be)),Y&&(Y.disabled=!0,Y.tabIndex=-1,Y.style.pointerEvents="none",Y.setAttribute("aria-hidden","true"));const Bt={paletteContainer:n,controlsPanel:e,paletteSection:t,historyContainer:a,paletteBaseControlGroup:o,paletteBaseModeSelect:r,colorBasePanel:s,temperatureBasePanel:i,imageBasePanel:l,paletteColorSwatchBtn:c,paletteColorSwatchFill:d,paletteColorTextInput:u,paletteColorInputFeedback:m,paletteColorPicker:p,paletteTypeOptions:h,paletteTypeResolvedLabel:f,monochromaticModeControl:g,monochromaticModeSelect:C,analogousSeparationControl:x,analogousSeparationSelect:S,paletteImageInput:I,paletteImageDropzonePanel:B,paletteImageDropzone:z,paletteImagePreview:y,paletteImagePreviewImg:P,paletteImageName:M,paletteImageDominantToggle:$,paletteImageReplaceBtn:j,paletteIntensityControlGroup:ae,brightnessControlGroup:se,brightnessInput:oe,saturationInput:be,saturationControlGroup:q,paletteAdjustBtn:Ae,paletteAdjustPanel:Me,paletteUndoBtn:ue,paletteRedoBtn:ie,paletteViewport:me,paletteLoadingOverlay:_e,paletteImageExtractionAlert:ve,addColorBtn:le,colorPicker:Y,addColorElement:Ve,paletteGenerationButtons:Ln,copyHexBtn:ce,paletteRegenerateBtn:Ge,paletteInspirationBtn:zo,generateBtn:Fo,surpriseBtn:Do,copyHexBtnTooltip:No,copyHexBtnLabel:_o,resetPaletteBtn:Vo,warmBtn:Go,coolBtn:jo,sizeButtons:Uo,addColorLabel:$o,brightnessValueLabel:qo,darkBrightnessIcon:Wo,lightBrightnessIcon:Yo,saturationValueLabel:Xo,lowSaturationIcon:Zo,highSaturationIcon:Ko,globalEditPicker:Be};return window.AppDom=Bt,Bt}let Ba=!1;function ji(){if(Ba)return window.AppShell;const n="palette_generator",e=Array.from(document.querySelectorAll(".view-tab")),t=Array.from(document.querySelectorAll("nav button")),a=document.querySelector(".logo img");function o(c){const d=String(c??"").trim();return e.some(m=>m.id===d)?d:n}function r(c){t.forEach(d=>{d.classList.toggle("active",d.getAttribute("data-view")===c)})}function s(c,d={}){const u=o(c);return e.forEach(m=>{m.classList.toggle("active",m.id===u)}),r(u),Da.emit("app:view-changed",{view:u,metadata:d}),u}function i(){return s(location.hash.replace("#",""),{source:"location"})}if(t.forEach(c=>{c.addEventListener("click",()=>{const d=c.getAttribute("data-view");if(!d)return;const u=s(d,{source:"nav"});history.replaceState(null,"",`#${u}`),window.scrollTo({top:0,behavior:"auto"})})}),window.addEventListener("hashchange",i),i(),a&&!matchMedia("(prefers-reduced-motion: reduce)").matches){const c=()=>{a.style.setProperty("--scroll-rotate",`${window.scrollY*.2}deg`)};window.addEventListener("scroll",c,{passive:!0}),c()}const l={showView:s,getCurrentView(){var c;return((c=document.querySelector(".view-tab.active"))==null?void 0:c.id)||n}};return window.AppShell=l,Ba=!0,l}function Ui(){lt.list().forEach(e=>{typeof(e==null?void 0:e.initialize)=="function"&&e.initialize()})}class At{constructor(e,t,a){F(this,"r");F(this,"g");F(this,"b");this.r=0,this.g=0,this.b=0,this.set(e,t,a)}set(e,t,a){this.r=this.clamp(e),this.g=this.clamp(t),this.b=this.clamp(a)}copyFrom(e){return this.set(e.r,e.g,e.b),this}toCssRgb(){return`rgb(${Math.round(this.r)}, ${Math.round(this.g)}, ${Math.round(this.b)})`}hueRotate(e=0){const t=e/180*Math.PI,a=Math.sin(t),o=Math.cos(t);this.multiply([.213+o*.787-a*.213,.715-o*.715-a*.715,.072-o*.072+a*.928,.213-o*.213+a*.143,.715+o*.285+a*.14,.072-o*.072-a*.283,.213-o*.213-a*.787,.715-o*.715+a*.715,.072+o*.928+a*.072])}grayscale(e=1){this.multiply([.2126+.7874*(1-e),.7152-.7152*(1-e),.0722-.0722*(1-e),.2126-.2126*(1-e),.7152+.2848*(1-e),.0722-.0722*(1-e),.2126-.2126*(1-e),.7152-.7152*(1-e),.0722+.9278*(1-e)])}sepia(e=1){this.multiply([.393+.607*(1-e),.769-.769*(1-e),.189-.189*(1-e),.349-.349*(1-e),.686+.314*(1-e),.168-.168*(1-e),.272-.272*(1-e),.534-.534*(1-e),.131+.869*(1-e)])}saturate(e=1){this.multiply([.213+.787*e,.715-.715*e,.072-.072*e,.213-.213*e,.715+.285*e,.072-.072*e,.213-.213*e,.715-.715*e,.072+.928*e])}brightness(e=1){this.linear(e)}contrast(e=1){this.linear(e,-(.5*e)+.5)}linear(e=1,t=0){this.r=this.clamp(this.r*e+t*255),this.g=this.clamp(this.g*e+t*255),this.b=this.clamp(this.b*e+t*255)}invert(e=1){this.r=this.clamp((e+this.r/255*(1-2*e))*255),this.g=this.clamp((e+this.g/255*(1-2*e))*255),this.b=this.clamp((e+this.b/255*(1-2*e))*255)}multiply(e){const t=this.clamp(this.r*e[0]+this.g*e[1]+this.b*e[2]),a=this.clamp(this.r*e[3]+this.g*e[4]+this.b*e[5]),o=this.clamp(this.r*e[6]+this.g*e[7]+this.b*e[8]);this.r=t,this.g=a,this.b=o}hsl(){const e=this.r/255,t=this.g/255,a=this.b/255,o=Math.max(e,t,a),r=Math.min(e,t,a),s=o-r;let i=0,l=0;const c=(o+r)/2;if(s!==0){switch(l=c>.5?s/(2-o-r):s/(o+r),o){case e:i=(t-a)/s+(t<a?6:0);break;case t:i=(a-e)/s+2;break;default:i=(e-t)/s+4;break}i/=6}return{h:i*100,s:l*100,l:c*100}}clamp(e){return Math.max(0,Math.min(255,e))}}class Ro{constructor(e){F(this,"target");F(this,"targetHsl");F(this,"reusedColor");this.target=e,this.targetHsl=e.hsl(),this.reusedColor=new At(0,0,0)}solve(){const e=this.solveWide(),t=this.solveNarrow(e),a=this.solveAdaptive(t),o=this.colorFromFilters(a.values);return{values:a.values,loss:a.loss,filterValue:this.filterValue(a.values),css:this.css(a.values),colorCss:o.toCssRgb()}}solveWide(){const a=[60,180,18e3,600,1.2,1.2],o=[50,20,3750,50,100,100];let r={loss:Number.POSITIVE_INFINITY,values:o};for(let s=0;s<7&&r.loss>2.5;s+=1){const i=this.spsa(5,a,15,o.slice(),1200);i.loss<r.loss&&(r=i)}return r}solveNarrow(e){let t={...e,values:e.values.slice()};for(let a=0;a<4;a+=1){const o=t.loss,r=2,s=o+1,i=[.25*s,.25*s,s,.25*s,.2*s,.2*s],l=this.spsa(o,i,r,t.values.slice(),600);if(l.loss<t.loss&&(t=l),t.loss<.8)break}return t}solveAdaptive(e){let t={...e,values:e.values.slice()};if(t.loss<=6)return t;const a=t.loss>12?3:2,o=t.loss>12?900:700;for(let r=0;r<a;r+=1){const s=t.loss+1,i=1.5,l=[.22*s,.22*s,.95*s,.22*s,.18*s,.18*s],c=this.spsa(s,l,i,t.values.slice(),o);if(c.loss<t.loss&&(t=c),t.loss<3)break}return t}spsa(e,t,a,o,r){const i=.16666666666666666;let l=Number.POSITIVE_INFINITY,c=o.slice();const d=new Array(6).fill(0),u=new Array(6).fill(0),m=new Array(6).fill(0);for(let p=0;p<r;p+=1){const h=a/Math.pow(p+1,i);for(let C=0;C<6;C+=1)d[C]=Math.random()>.5?1:-1,u[C]=o[C]+h*d[C],m[C]=o[C]-h*d[C];const f=this.loss(u)-this.loss(m);for(let C=0;C<6;C+=1){const x=f/(2*h)*d[C],S=t[C]/Math.pow(e+p+1,1);o[C]=this.fix(o[C]-S*x,C)}const g=this.loss(o);g<l&&(l=g,c=o.slice())}return{values:c,loss:l}}fix(e,t){let a=100;return t===2?a=7500:(t===4||t===5)&&(a=200),t===3?e>a?e%a:e<0?a+e%a:e:Math.max(0,Math.min(a,e))}loss(e){const t=this.colorFromFilters(e),a=t.hsl();return Math.abs(t.r-this.target.r)+Math.abs(t.g-this.target.g)+Math.abs(t.b-this.target.b)+Math.abs(a.h-this.targetHsl.h)+Math.abs(a.s-this.targetHsl.s)+Math.abs(a.l-this.targetHsl.l)}colorFromFilters(e){const t=this.reusedColor;return t.set(0,0,0),t.invert(e[0]/100),t.sepia(e[1]/100),t.saturate(e[2]/100),t.hueRotate(e[3]*3.6),t.brightness(e[4]/100),t.contrast(e[5]/100),t}filterValue(e){return[`invert(${Math.round(e[0])}%)`,`sepia(${Math.round(e[1])}%)`,`saturate(${Math.round(e[2])}%)`,`hue-rotate(${Math.round(e[3]*3.6)}deg)`,`brightness(${Math.round(e[4])}%)`,`contrast(${Math.round(e[5])}%)`].join(" ")}css(e){return`filter: ${this.filterValue(e)};`}}function rt(n){const e=String(n??"").trim();return/^#?[0-9a-f]{3}([0-9a-f]{3})?$/i.test(e)?e.startsWith("#")?e.toUpperCase():`#${e.toUpperCase()}`:e}function ko(n){return n<1?"Resultado excelente.":n<4?"Resultado muy cercano al color objetivo.":n<10?"Resultado bueno, con una ligera desviacion.":"Resultado util, pero algo alejado del color objetivo."}const $i={Color:At,Solver:Ro,normalizeHexInputValue:rt,getLossMessage:ko};window.HexToFilterCore=$i;let st=!1,Ho=()=>!1;function qi(n){const e=n.querySelector(".target"),t=n.querySelector(".filter-copy-btn"),a=n.querySelector(".target-color-swatch"),o=n.querySelector(".target-color-swatch-fill"),r=n.querySelector(".filter-target-picker"),s=n.querySelector(".filter-tool-feedback"),i=n.querySelector(".filter-code-output"),l=n.querySelector(".lossDetail"),c=n.querySelector(".filterPixel"),d=n.querySelector(".filter-source-icon-after");return!e||!t||!a||!o||!r||!s||!i||!l||!c||!d?null:{textInput:e,copyButton:t,swatchButton:a,swatchFill:o,colorPicker:r,feedback:s,filterCodeOutput:i,lossDetail:l,filterPreviewPixel:c,filterPreviewImage:d,copyTooltip:t.querySelector(".tooltip")}}function Ta(){var S,I,B,z;if(st)return;const n=document.getElementById("hex_to_code");if(!n)return;const e=qi(n);if(!e)return;const t=Array.isArray(L.DEFAULT_TARGET_COLORS)?L.DEFAULT_TARGET_COLORS:["#9EBB89"],a=((S=_.getDefaultActiveColor)==null?void 0:S.call(_))||((I=_.getState)==null?void 0:I.call(_).activeColor)||L.DEFAULT_COLOR_BASE||t[0];st=!0;const o=((B=e.copyTooltip)==null?void 0:B.textContent)??"Copiar CSS a portapapeles";let r=null,s=null,i="";function l(y){const P=rt(y);if(!P)return null;const M=en.parseCssColor(P);return M?{hex:M.hex,css:M.css,rgb:M.rgb,inputValue:P}:null}function c(){e.textInput.classList.remove("is-invalid"),e.feedback.textContent=""}function d(){e.textInput.classList.add("is-invalid"),e.feedback.textContent="No se ha detectado un color valido. Usa HEX, rgb(), hsl() o un nombre CSS reconocido."}function u(y,P={}){e.swatchFill.style.backgroundColor=y.css,e.colorPicker.value=y.hex,P.publish!==!1&&_.setActiveColor(y.hex,{source:P.source||"hex-to-filter"})}function m(y){const P=l(y);return P&&en.getReadableTextColor(P.hex)==="#000000"?"var(--primary)":"var(--on-accent)"}function p(){if(!e.copyTooltip)return;const y=i||e.filterPreviewPixel.style.backgroundColor||"var(--accent)",P=m(y);e.copyTooltip.style.setProperty("--tooltip-feedback-bg",y),e.copyTooltip.style.setProperty("--tooltip-feedback-fg",P),e.copyTooltip.textContent="¡Copiado!",e.copyTooltip.classList.add("is-copied-feedback"),e.copyButton.classList.add("show-feedback"),s&&window.clearTimeout(s),s=window.setTimeout(()=>{e.copyTooltip&&(e.copyTooltip.textContent=o,e.copyTooltip.classList.remove("is-copied-feedback"),e.copyButton.classList.remove("show-feedback"),e.copyTooltip.style.removeProperty("--tooltip-feedback-bg"),e.copyTooltip.style.removeProperty("--tooltip-feedback-fg"))},1400)}function h(y){i=y.colorCss,e.filterCodeOutput.textContent=y.css,e.lossDetail.textContent=`Loss: ${y.loss.toFixed(1)}. ${ko(y.loss)}`,e.filterPreviewPixel.style.backgroundColor=y.colorCss,e.filterPreviewImage.style.filter=y.filterValue}function f(y={}){const P=y.normalizedColor||l(e.textInput.value);if(!P)return d(),null;e.textInput.value!==P.inputValue&&(e.textInput.value=P.inputValue),c(),u(P,y);const M=new At(P.rgb[0],P.rgb[1],P.rgb[2]),j=new Ro(M).solve();return h(j),j}function g(y,P={}){const M=l(y);return M?(e.textInput.value=M.inputValue,!!f({normalizedColor:M,publish:P.publish,source:P.source})):!1}function C(){r&&window.clearTimeout(r),r=window.setTimeout(()=>{const y=l(e.textInput.value);y&&f({normalizedColor:y})},220)}Ho=g,e.textInput.addEventListener("input",()=>{const y=l(e.textInput.value);y&&(e.textInput.value!==y.inputValue&&(e.textInput.value=y.inputValue),c(),u(y,{publish:!1}),C())}),e.textInput.addEventListener("blur",()=>{const y=rt(e.textInput.value);y&&e.textInput.value!==y&&(e.textInput.value=y)}),e.textInput.addEventListener("keydown",y=>{y.key==="Enter"&&(y.preventDefault(),f())}),e.swatchButton.addEventListener("click",()=>{if(typeof e.colorPicker.showPicker=="function"){e.colorPicker.showPicker();return}e.colorPicker.click()}),e.colorPicker.addEventListener("input",()=>{const y=e.colorPicker.value.toUpperCase();g(y,{source:"hex-to-filter"})}),e.copyButton.addEventListener("click",async()=>{var y;try{await _a.writeText(((y=e.filterCodeOutput.textContent)==null?void 0:y.trim())||""),p()}catch{}}),e.textInput.value=a,e.colorPicker.value=a;const x=l(e.textInput.value)||l(a);x&&f({normalizedColor:x,publish:!1}),(z=_.subscribe)==null||z.call(_,(y={})=>{const{type:P,state:M,metadata:$}=y;P!=="activeColor"||!(M!=null&&M.activeColor)||($==null?void 0:$.source)!=="hex-to-filter"&&g(String(M.activeColor),{publish:!1})})}function Wi(){const n={initialize:Ta,setTargetColor(e){return st||Ta(),Ho(e,{source:"hex-to-filter"})}};return window.HexToFilterApp=n,lt.register("hex-to-filter",n),n}function Yi(n){if(document.querySelector(`script[data-legacy-script="${n.id}"]`))return;const e=document.createElement("script");e.type="text/javascript",e.dataset.legacyScript=n.id,e.text=`${n.code}
//# sourceURL=${n.id}`,document.body.appendChild(e)}function Xi(n){n.forEach(Yi)}const Zi=`// COLOR NAMES CUSTOM LIST
...
`,Ji=`\uFEFF// Palette generator core: shared state helpers, adjustments, scoring and commit flow.
...
`,Qi=`// Palette generator image analysis: sampling, clustering and derived candidates.
...
`,el=`function getImageBasedCandidateColor(
...
`,nl=`function getRandomSteppedValue(min = 0, max = 100, step = 5) {
...
`,al=`function setPaletteAdjustPanelOpen(shouldOpen) {
...
`,rl=`// Palette generator card helpers: color utilities, accessibility and shared button UI.
...
`,sl=`// Palette generator card naming and palette copy helpers.
...
`,il=`// Palette generator card actions and card DOM wiring.
...
updateHistoryNavigationButtons();
`,cl=`// Public API for the palette generator mini-app.
...
`,dl=[{id:"shared-color-names.js",code:Zi},{id:"palette-generator-state.js",code:Ki},{id:"palette-generator-core.js",code:Ji},{id:"palette-generator-image-analysis.js",code:Qi},{id:"palette-generator-image-palette.js",code:el},{id:"palette-generator-temperature.js",code:nl},{id:"palette-generator-color-mode.js",code:tl},{id:"palette-generator-image-ui.js",code:al},{id:"palette-generator-controls.js",code:ol},{id:"palette-generator-card-helpers.js",code:rl},{id:"palette-generator-card-names.js",code:sl},{id:"palette-generator-cards.js",code:il},{id:"palette-generator-history.js",code:ll},{id:"palette-generator-app.js",code:cl}];function ul(){const e=document.getElementById("footerYear");if(!e)return;const t=new Date().getFullYear();e.textContent=t===2026?String(2026):`2026–${t}`}async function ml(){Gi(),ji(),Wi(),Xi(dl),Ui()}function Ea(){ul(),ml()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ea,{once:!0}):Ea();
