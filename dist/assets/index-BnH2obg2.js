var ir=Object.defineProperty;var lr=(t,e,n)=>e in t?ir(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var F=(t,e,n)=>lr(t,typeof e!="symbol"?e+"":e,n);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function n(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(o){if(o.ep)return;o.ep=!0;const r=n(o);fetch(o.href,r)}})();const L={DISALLOWED_COLORS:new Set,HEX_6_REGEX:/^#[0-9A-F]{6}$/,MAX_UNIQUE_COLOR_ATTEMPTS:500,MAX_PALETTE_COLORS:24,DEFAULT_TARGET_COLORS:["#9EBB89","#6EC5CE","#E7AA6E","#B1BDCD","#6BBDB6","#B88965","#DCC9B3","#A8AA98","#6B8F71","#29A9CA","#B86346","#5BAB9C"],CARD_COPY_TOOLTIP_DEFAULT:"Copiar HEX",HISTORY_COPY_TOOLTIP_DEFAULT:"Copiar paleta",ADD_DISABLED_LABEL:"Esperemos, que con 24 colores la paleta esté completa☝️",DEFAULT_PALETTE_SIZE:9,DEFAULT_PALETTE_BASE_MODE:"color",DEFAULT_TEMPERATURE:{warm:!0,cool:!1},DEFAULT_COLOR_BASE:"#9EBB89",DEFAULT_COLOR_PALETTE_TYPE:"monochromatic",DEFAULT_MONOCHROMATIC_GENERATION_MODE:"automatic",DEFAULT_ANALOGOUS_SEPARATION_MODE:"medium",DEFAULT_BRIGHTNESS:65,DEFAULT_SATURATION:100,LOW_SATURATION_FALLBACK_THRESHOLD:15,LOW_SATURATION_TEMPERATURE_UNLOCK_BRIGHTNESS:30};window.AppConstants=L;const He=new Map;function ja(t,e){var n;return He.has(t)||He.set(t,new Set),(n=He.get(t))==null||n.add(e),()=>{Ua(t,e)}}function Ua(t,e){const n=He.get(t);n&&(n.delete(e),n.size===0&&He.delete(t))}function $a(t,e={}){const n=He.get(t);!n||n.size===0||n.forEach(a=>{try{a(e)}catch(o){console.error(`AppEventBus listener failed for "${t}".`,o)}})}const qa={on:ja,off:Ua,emit:$a};window.AppEventBus=qa;const hn=new Map;function cr(t,e={}){if(!t||typeof t!="string")throw new Error("AppRegistry.register requires a string id.");const n={id:t,...e||{}};return hn.set(t,n),n}function dr(t){return hn.get(t)||null}function ur(){return Array.from(hn.values())}const gn={register:cr,get:dr,list:ur};window.AppRegistry=gn;async function Wa(t){const e=String(t??"");if(navigator.clipboard&&typeof navigator.clipboard.writeText=="function")try{await navigator.clipboard.writeText(e);return}catch{}const n=document.createElement("textarea");n.value=e,n.style.position="fixed",n.style.left="-9999px",n.style.top="0",n.style.opacity="0",document.body.appendChild(n),n.focus(),n.select();const a=document.execCommand("copy");if(n.remove(),!a)throw new Error("Clipboard copy failed")}const Ya={writeText:Wa};window.AppClipboard=Ya;window.copyTextToClipboard=Wa;function We(t,e){let n=t.length,a,o,r=!1,s=!1;Array.isArray(t[0])?a=t:(a=[t],n=a.length,r=!0),Array.isArray(e[0])?o=e:(o=e.length>0?e.map(u=>[u]):[[]],s=!0);let i=o[0].length,l=o[0].map((u,d)=>o.map(p=>p[d])),c=a.map(u=>l.map(d=>{let p=0;if(!Array.isArray(u)){for(let h of d)p+=u*h;return p}for(let h=0;h<u.length;h++)p+=u[h]*(d[h]||0);return p}));return n===1&&r&&(c=c[0]),i===1&&s?n===1&&r?c[0]:c.map(u=>u[0]):c}function Ht(t,e){return t[0]*e[0]+t[1]*e[1]+t[2]*e[2]}function R(t,e,n=[0,0,0]){const a=Ht(t,e[0]),o=Ht(t,e[1]),r=Ht(t,e[2]);return n[0]=a,n[1]=o,n[2]=r,n}function Ge(t){return he(t)==="string"}function he(t){return(Object.prototype.toString.call(t).match(/^\[object\s+(.*?)\]$/)[1]||"").toLowerCase()}function fn(t,{precision:e=16,unit:n}){return B(t)?"none":(t=+Cn(t,e),t+(n??""))}function B(t){return t===null}function k(t){return B(t)?0:t}function Cn(t,e){if(t===0)return 0;let n=~~t,a=0;n&&e&&(a=~~Math.log10(Math.abs(n))+1);const o=10**(e-a);return Math.floor(t*o+.5)/o}function et(t,e,n){return isNaN(t)?e:isNaN(e)?t:t+(e-t)*n}function Xa(t,e,n){return(n-t)/(e-t)}function Xt(t,e,n){return!t||!e||t===e||t[0]===e[0]&&t[1]===e[1]||isNaN(n)||n===null?n:et(e[0],e[1],Xa(t[0],t[1],n))}function Mt(t,e,n){return Math.max(Math.min(n,e),t)}function vt(t,e){return Math.sign(t)===Math.sign(e)?t:-t}function z(t,e){return vt(Math.abs(t)**e,t)}function xn(t,e){return e===0?0:t/e}function Za(t,e,n=0,a=t.length){for(;n<a;){const o=n+a>>1;t[o]<e?n=o+1:a=o}return n}function ze(t,e){var a;if(t instanceof e)return!0;const n=e.name;for(;t;){const o=Object.getPrototypeOf(t),r=(a=o==null?void 0:o.constructor)==null?void 0:a.name;if(r===n)return!0;if(!r||r==="Object")return!1;t=o}return!1}var pr=Object.freeze({__proto__:null,bisectLeft:Za,clamp:Mt,copySign:vt,interpolate:et,interpolateInv:Xa,isInstance:ze,isNone:B,isString:Ge,mapRange:Xt,multiplyMatrices:We,multiply_v3_m3x3:R,serializeNumber:fn,skipNone:k,spow:z,toPrecision:Cn,type:he,zdiv:xn});class mr{add(e,n,a){if(typeof arguments[0]!="string"){for(var e in arguments[0])this.add(e,arguments[0][e],arguments[1]);return}(Array.isArray(e)?e:[e]).forEach(function(o){this[o]=this[o]||[],n&&this[o][a?"unshift":"push"](n)},this)}run(e,n){this[e]=this[e]||[],this[e].forEach(function(a){a.call(n&&n.context?n.context:n,n)})}}const fe=new mr;var Na,Da,_a,Q={gamut_mapping:"css",precision:5,deltaE:"76",verbose:((_a=(Da=(Na=globalThis==null?void 0:globalThis.process)==null?void 0:Na.env)==null?void 0:Da.NODE_ENV)==null?void 0:_a.toLowerCase())!=="test",warn:function(e){var n,a;this.verbose&&((a=(n=globalThis==null?void 0:globalThis.console)==null?void 0:n.warn)==null||a.call(n,e))}};class zn{constructor(e,n){F(this,"type");F(this,"coordMeta");F(this,"coordRange");F(this,"range");if(typeof e=="object"&&(this.coordMeta=e),n&&(this.coordMeta=n,this.coordRange=n.range??n.refRange),typeof e=="string"){let a=e.trim().match(/^(?<type><[a-z]+>)(\[(?<min>-?[.\d]+),\s*(?<max>-?[.\d]+)\])?$/);if(!a)throw new TypeError(`Cannot parse ${e} as a type definition.`);this.type=a.groups.type;let{min:o,max:r}=a.groups;(o||r)&&(this.range=[+o,+r])}}get computedRange(){return this.range?this.range:this.type==="<percentage>"?this.percentageRange():this.type==="<angle>"?[0,360]:null}get unit(){return this.type==="<percentage>"?"%":this.type==="<angle>"?"deg":""}resolve(e){if(this.type==="<angle>")return e;let n=this.computedRange,a=this.coordRange;return this.type==="<percentage>"&&(a??(a=this.percentageRange())),Xt(n,a,e)}serialize(e,n){let a=this.type==="<percentage>"?this.percentageRange(100):this.computedRange,o=this.unit;return e=Xt(this.coordRange,a,e),fn(e,{unit:o,precision:n})}toString(){let e=this.type;if(this.range){let[n="",a=""]=this.range;e+=`[${n},${a}]`}return e}percentageRange(e=1){let n;return this.coordMeta&&this.coordMeta.range||this.coordRange&&this.coordRange[0]>=0?n=[0,1]:n=[-1,1],[n[0]*e,n[1]*e]}static get(e,n){return ze(e,this)?e:new this(e,n)}}const kt=Symbol("instance");class gt{constructor(e,n=e.space){F(this,"type");F(this,"name");F(this,"spaceCoords");F(this,"coords");F(this,"id");F(this,"alpha");e[kt]=this,this.type="function",this.name="color",Object.assign(this,e),this.space=n,this.type!=="custom"&&(this.spaceCoords=Object.values(n.coords),this.coords||(this.coords=this.spaceCoords.map(a=>{let o=["<number>","<percentage>"];return a.type==="angle"&&o.push("<angle>"),o})),this.coords=this.coords.map((a,o)=>{let r=this.spaceCoords[o];return typeof a=="string"&&(a=a.trim().split(/\s*\|\s*/)),a.map(s=>zn.get(s,r))}))}serializeCoords(e,n,a){return a=e.map((o,r)=>zn.get((a==null?void 0:a[r])??this.coords[r][0],this.spaceCoords[r])),e.map((o,r)=>a[r].serialize(o,n))}coerceCoords(e,n){return Object.entries(this.space.coords).map(([a,o],r)=>{let s=e[r];if(B(s)||isNaN(s))return s;let i=n[r],l=this.coords[r].find(c=>c.type==i);if(!l){let c=o.name||a;throw new TypeError(`${i??(s==null?void 0:s.raw)??s} not allowed for ${c} in ${this.name}()`)}return s=l.resolve(s),l.range&&(n[r]=l.toString()),s})}canSerialize(){return this.type==="function"||this.serialize}parse(e){return null}static get(e,...n){return!e||ze(e,this)?e:e[kt]?e[kt]:new gt(e,...n)}}const W={D50:[.3457/.3585,1,(1-.3457-.3585)/.3585],D65:[.3127/.329,1,(1-.3127-.329)/.329]};function Zt(t){return Array.isArray(t)?t:W[t]}function ft(t,e,n,a={}){if(t=Zt(t),e=Zt(e),!t||!e)throw new TypeError(`Missing white point to convert ${t?"":"from"}${!t&&!e?"/":""}${e?"":"to"}`);if(t===e)return n;let o={W1:t,W2:e,XYZ:n,options:a};if(fe.run("chromatic-adaptation-start",o),o.M||(o.W1===W.D65&&o.W2===W.D50?o.M=[[1.0479297925449969,.022946870601609652,-.05019226628920524],[.02962780877005599,.9904344267538799,-.017073799063418826],[-.009243040646204504,.015055191490298152,.7518742814281371]]:o.W1===W.D50&&o.W2===W.D65&&(o.M=[[.955473421488075,-.02309845494876471,.06325924320057072],[-.0283697093338637,1.0099953980813041,.021041441191917323],[.012314014864481998,-.020507649298898964,1.330365926242124]])),fe.run("chromatic-adaptation-end",o),o.M)return R(o.XYZ,o.M);throw new TypeError("Only Bradford CAT with white points D50 and D65 supported for now.")}function Ka(t,e){var r,s,i;let n={str:(r=String(t))==null?void 0:r.trim(),options:e};if(fe.run("parse-start",n),n.color)return n.color;n.parsed=gr(n.str);let a,o=n.options?n.options.parseMeta??n.options.meta:null;if(n.parsed){let l=n.parsed.name,c,u,d=n.parsed.args,p=d.map((g,f)=>{var C;return(C=n.parsed.argMeta[f])==null?void 0:C.type});if(l==="color"){let g=d.shift();p.shift();let f=g.startsWith("--")?g.substring(2):`--${g}`,C=[g,f];if(c=b.findFormat({name:l,id:C,type:"function"}),!c){let x,P=g in b.registry?g:f;if(P in b.registry){let I=(i=(s=b.registry[P].formats)==null?void 0:s.color)==null?void 0:i.id;I&&(x=`Did you mean ${t.replace("color("+g,"color("+I)}?`)}throw new TypeError(`Cannot parse ${n.str}. `+(x??"Missing a plugin?"))}u=c.space,c.id.startsWith("--")&&!g.startsWith("--")&&Q.warn(`${u.name} is a non-standard space and not currently supported in the CSS spec. Use prefixed color(${c.id}) instead of color(${g}).`),g.startsWith("--")&&!c.id.startsWith("--")&&Q.warn(`${u.name} is a standard space and supported in the CSS spec. Use color(${c.id}) instead of prefixed color(${g}).`)}else c=b.findFormat({name:l,type:"function"}),u=c.space;o&&Object.assign(o,{format:c,formatId:c.name,types:p,commas:n.parsed.commas});let h=1;n.parsed.lastAlpha&&(h=n.parsed.args.pop(),o&&(o.alphaType=p.pop()));let m=c.coords.length;if(d.length!==m)throw new TypeError(`Expected ${m} coordinates for ${u.id} in ${n.str}), got ${d.length}`);d=c.coerceCoords(d,p),a={spaceId:u.id,coords:d,alpha:h}}else e:for(let l of b.all)for(let c in l.formats){let u=l.formats[c];if(u.type!=="custom"||u.test&&!u.test(n.str))continue;let d=l.getFormat(u),p=d.parse(n.str);if(p){o&&Object.assign(o,{format:d,formatId:c}),a=p;break e}}if(!a)throw new TypeError(`Could not parse ${t} as a color. Missing a plugin?`);return a.alpha=B(a.alpha)?a.alpha:a.alpha===void 0?1:Mt(0,a.alpha,1),a}const Ja={"%":.01,deg:1,grad:.9,rad:180/Math.PI,turn:360},Ct={function:/^([a-z]+)\(((?:calc\(NaN\)|.)+?)\)$/i,number:/^([-+]?(?:[0-9]*\.)?[0-9]+(e[-+]?[0-9]+)?)$/i,unitValue:RegExp(`(${Object.keys(Ja).join("|")})$`),singleArgument:/\/?\s*(none|NaN|calc\(NaN\)|[-+\w.]+(?:%|deg|g?rad|turn)?)/g};function hr(t){var o;let e={},n=(o=t.match(Ct.unitValue))==null?void 0:o[0],a=e.raw=t;return n?(e.type=n==="%"?"<percentage>":"<angle>",e.unit=n,e.unitless=Number(a.slice(0,-n.length)),a=e.unitless*Ja[n]):Ct.number.test(a)?(a=Number(a),e.type="<number>"):a==="none"?a=null:a==="NaN"||a==="calc(NaN)"?(a=NaN,e.type="<number>"):e.type="<ident>",{value:a,meta:e}}function gr(t){if(!t)return;t=t.trim();let e=t.match(Ct.function);if(e){let n=[],a=[],o=!1,r=e[1].toLowerCase(),s=e[2].replace(Ct.singleArgument,(i,l)=>{let{value:c,meta:u}=hr(l);return(i.startsWith("/")||r!=="color"&&n.length===3)&&(o=!0),n.push(c),a.push(u),""});return{name:r,args:n,argMeta:a,lastAlpha:o,commas:s.includes(","),rawName:e[1],rawArgs:e[2]}}}function A(t,e){if(Array.isArray(t))return t.map(a=>A(a,e));if(!t)throw new TypeError("Empty color reference");Ge(t)&&(t=Ka(t,e));let n=t.space||t.spaceId;return typeof n=="string"&&(t.space=b.get(n)),t.alpha===void 0&&(t.alpha=1),t}const fr=75e-6,Z=class Z{constructor(e){var o;this.id=e.id,this.name=e.name,this.base=e.base?Z.get(e.base):null,this.aliases=e.aliases,this.base&&(this.fromBase=e.fromBase,this.toBase=e.toBase);let n=e.coords??this.base.coords;for(let r in n)"name"in n[r]||(n[r].name=r);this.coords=n;let a=e.white??this.base.white??"D65";this.white=Zt(a),this.formats=e.formats??{};for(let r in this.formats){let s=this.formats[r];s.type||(s.type="function"),s.name||(s.name=r)}(o=this.formats.color)!=null&&o.id||(this.formats.color={...this.formats.color??{},id:e.cssId||this.id}),e.gamutSpace?this.gamutSpace=e.gamutSpace==="self"?this:Z.get(e.gamutSpace):this.isPolar?this.gamutSpace=this.base:this.gamutSpace=this,this.gamutSpace.isUnbounded&&(this.inGamut=(r,s)=>!0),this.referred=e.referred,Object.defineProperty(this,"path",{value:Cr(this).reverse(),writable:!1,enumerable:!0,configurable:!0}),fe.run("colorspace-init-end",this)}inGamut(e,{epsilon:n=fr}={}){if(!this.equals(this.gamutSpace))return e=this.to(this.gamutSpace,e),this.gamutSpace.inGamut(e,{epsilon:n});let a=Object.values(this.coords);return e.every((o,r)=>{let s=a[r];if(s.type!=="angle"&&s.range){if(B(o))return!0;let[i,l]=s.range;return(i===void 0||o>=i-n)&&(l===void 0||o<=l+n)}return!0})}get isUnbounded(){return Object.values(this.coords).every(e=>!("range"in e))}get cssId(){var e,n;return((n=(e=this.formats)==null?void 0:e.color)==null?void 0:n.id)||this.id}get isPolar(){for(let e in this.coords)if(this.coords[e].type==="angle")return!0;return!1}getFormat(e){if(!e)return null;e==="default"?e=Object.values(this.formats)[0]:typeof e=="string"&&(e=this.formats[e]);let n=gt.get(e,this);return n!==e&&e.name in this.formats&&(this.formats[e.name]=n),n}equals(e){return e?this===e||this.id===e||this.id===e.id:!1}to(e,n){if(arguments.length===1){const i=A(e);[e,n]=[i.space,i.coords]}if(e=Z.get(e),this.equals(e))return n;n=n.map(i=>B(i)?0:i);let a=this.path,o=e.path,r,s;for(let i=0;i<a.length&&a[i].equals(o[i]);i++)r=a[i],s=i;if(!r)throw new Error(`Cannot convert between color spaces ${this} and ${e}: no connection space was found`);for(let i=a.length-1;i>s;i--)n=a[i].toBase(n);for(let i=s+1;i<o.length;i++)n=o[i].fromBase(n);return n}from(e,n){if(arguments.length===1){const a=A(e);[e,n]=[a.space,a.coords]}return e=Z.get(e),e.to(this,n)}toString(){return`${this.name} (${this.id})`}getMinCoords(){let e=[];for(let n in this.coords){let a=this.coords[n],o=a.range||a.refRange;e.push((o==null?void 0:o.min)??0)}return e}static get all(){return[...new Set(Object.values(Z.registry))]}static register(e,n){if(arguments.length===1&&(n=arguments[0],e=n.id),n=this.get(n),this.registry[e]&&this.registry[e]!==n)throw new Error(`Duplicate color space registration: '${e}'`);if(this.registry[e]=n,arguments.length===1&&n.aliases)for(let a of n.aliases)this.register(a,n);return n}static get(e,...n){if(!e||ze(e,this))return e;if(he(e)==="string"){let o=Z.registry[e.toLowerCase()];if(!o)throw new TypeError(`No color space found with id = "${e}"`);return o}if(n.length)return Z.get(...n);throw new TypeError(`${e} is not a valid color space`)}static findFormat(e,n=Z.all){if(!e)return null;typeof e=="string"&&(e={name:e});for(let a of n)for(let[o,r]of Object.entries(a.formats)){r.name??(r.name=o),r.type??(r.type="function");let s=(!e.name||r.name===e.name)&&(!e.type||r.type===e.type);if(e.id){let i=r.ids||[r.id],l=Array.isArray(e.id)?e.id:[e.id];s&&(s=l.some(c=>i.includes(c)))}if(s){let i=gt.get(r,a);return i!==r&&(a.formats[r.name]=i),i}}return null}static resolveCoord(e,n){var l;let a=he(e),o,r;if(a==="string"?e.includes(".")?[o,r]=e.split("."):[o,r]=[,e]:Array.isArray(e)?[o,r]=e:(o=e.space,r=e.coordId),o=Z.get(o),o||(o=n),!o)throw new TypeError(`Cannot resolve coordinate reference ${e}: No color space specified and relative references are not allowed here`);if(a=he(r),a==="number"||a==="string"&&r>=0){let c=Object.entries(o.coords)[r];if(c)return{space:o,id:c[0],index:r,...c[1]}}o=Z.get(o);let s=r.toLowerCase(),i=0;for(let c in o.coords){let u=o.coords[c];if(c.toLowerCase()===s||((l=u.name)==null?void 0:l.toLowerCase())===s)return{space:o,id:c,index:i,...u};i++}throw new TypeError(`No "${r}" coordinate found in ${o.name}. Its coordinates are: ${Object.keys(o.coords).join(", ")}`)}};F(Z,"registry",{}),F(Z,"DEFAULT_FORMAT",{type:"functions",name:"color"});let b=Z;function Cr(t){let e=[t];for(let n=t;n=n.base;)e.push(n);return e}var V=new b({id:"xyz-d65",name:"XYZ D65",coords:{x:{refRange:[0,1],name:"X"},y:{refRange:[0,1],name:"Y"},z:{refRange:[0,1],name:"Z"}},white:"D65",formats:{color:{ids:["xyz-d65","xyz"]}},aliases:["xyz"]});class U extends b{constructor(e){e.coords||(e.coords={r:{range:[0,1],name:"Red"},g:{range:[0,1],name:"Green"},b:{range:[0,1],name:"Blue"}}),e.base||(e.base=V),e.toXYZ_M&&e.fromXYZ_M&&(e.toBase??(e.toBase=n=>{let a=R(n,e.toXYZ_M);return this.white!==this.base.white&&(a=ft(this.white,this.base.white,a)),a}),e.fromBase??(e.fromBase=n=>(n=ft(this.base.white,this.white,n),R(n,e.fromXYZ_M)))),e.referred??(e.referred="display"),super(e)}}function Qa(t,e={}){if(Array.isArray(t))return t.map(l=>Qa(l,e));let{cssProperty:n="background-color",element:a,...o}=e,r=null;try{return A(t,o)}catch(l){r=l}let{CSS:s,getComputedStyle:i}=globalThis;if(Ge(t)&&a&&s&&i&&s.supports(n,t)){let l=a.style[n];t!==l&&(a.style[n]=t);let c=i(a).getPropertyValue(n);if(t!==l&&(a.style[n]=l),c!==t)try{return A(c,o)}catch(u){r=u}else r={message:"Color value is a valid CSS color, but it could not be resolved :("}}return e.errorMeta&&(e.errorMeta.error=r),null}function ot(t,e){t=A(t);let n=b.get(e,e==null?void 0:e.space),a=e==null?void 0:e.precision,o;return!n||t.space.equals(n)?o=t.coords.slice():o=n.from(t),a===void 0?o:o.map(r=>Cn(r,a))}function K(t,e){if(t=A(t),e==="alpha")return t.alpha??1;let{space:n,index:a}=b.resolveCoord(e,t.space);return ot(t,n)[a]}function bn(t,e,n,a){return t=A(t),Array.isArray(e)&&([e,n,a]=[t.space,e,n]),e=b.get(e),t.coords=e===t.space?n.slice():e.to(t.space,n),a!==void 0&&(t.alpha=a),t}bn.returns="color";function ue(t,e,n){if(t=A(t),arguments.length===2&&he(arguments[1])==="object"){let a=arguments[1];for(let o in a)ue(t,o,a[o])}else if(typeof n=="function"&&(n=n(K(t,e))),e==="alpha")t.alpha=n;else{let{space:a,index:o}=b.resolveCoord(e,t.space),r=ot(t,a);r[o]=n,bn(t,a,r)}return t}ue.returns="color";var yn=new b({id:"xyz-d50",name:"XYZ D50",white:"D50",base:V,fromBase:t=>ft(V.white,"D50",t),toBase:t=>ft("D50",V.white,t)});const xr=216/24389,Fn=24/116,st=24389/27;let zt=W.D50;var J=new b({id:"lab",name:"Lab",coords:{l:{refRange:[0,100],name:"Lightness"},a:{refRange:[-125,125]},b:{refRange:[-125,125]}},white:zt,base:yn,fromBase(t){let n=t.map((s,i)=>s/zt[i]).map(s=>s>xr?Math.cbrt(s):(st*s+16)/116),a=116*n[1]-16,o=500*(n[0]-n[1]),r=200*(n[1]-n[2]);return[a,o,r]},toBase(t){let[e,n,a]=t,o=[];return o[1]=(e+16)/116,o[0]=n/500+o[1],o[2]=o[1]-a/200,[o[0]>Fn?Math.pow(o[0],3):(116*o[0]-16)/st,t[0]>8?Math.pow((t[0]+16)/116,3):t[0]/st,o[2]>Fn?Math.pow(o[2],3):(116*o[2]-16)/st].map((s,i)=>s*zt[i])},formats:{lab:{coords:["<percentage> | <number>","<number> | <percentage>","<number> | <percentage>"]}}});function ae(t){return typeof t!="number"?t:(t%360+360)%360}function eo(t,e){let[n,a]=e,o=B(n),r=B(a);if(o&&r)return[n,a];if(o?n=a:r&&(a=n),t==="raw")return e;n=ae(n),a=ae(a);let s=a-n;return t==="increasing"?s<0&&(a+=360):t==="decreasing"?s>0&&(n+=360):t==="longer"?-180<s&&s<180&&(s>0?n+=360:a+=360):t==="shorter"&&(s>180?n+=360:s<-180&&(a+=360)),[n,a]}var ee=new b({id:"lch",name:"LCH",coords:{l:{refRange:[0,100],name:"Lightness"},c:{refRange:[0,150],name:"Chroma"},h:{refRange:[0,360],type:"angle",name:"Hue"}},base:J,fromBase(t){if(this.ε===void 0){let i=Object.values(this.base.coords)[1].refRange,l=i[1]-i[0];this.ε=l/1e5}let[e,n,a]=t,o=Math.abs(n)<this.ε&&Math.abs(a)<this.ε,r=o?null:ae(Math.atan2(a,n)*180/Math.PI),s=o?0:Math.sqrt(n**2+a**2);return[e,s,r]},toBase(t){let[e,n,a]=t,o=null,r=null;return B(a)||(n=n<0?0:n,o=n*Math.cos(a*Math.PI/180),r=n*Math.sin(a*Math.PI/180)),[e,o,r]},formats:{lch:{coords:["<percentage> | <number>","<number> | <percentage>","<number> | <angle>"]}}});const Nn=25**7,xt=Math.PI,Dn=180/xt,we=xt/180;function _n(t){const e=t*t;return e*e*e*t}function to(t,e,{kL:n=1,kC:a=1,kH:o=1}={}){[t,e]=A([t,e]);let[r,s,i]=J.from(t),l=ee.from(J,[r,s,i])[1],[c,u,d]=J.from(e),p=ee.from(J,[c,u,d])[1];l<0&&(l=0),p<0&&(p=0);let h=(l+p)/2,m=_n(h),g=.5*(1-Math.sqrt(m/(m+Nn))),f=(1+g)*s,C=(1+g)*u,x=Math.sqrt(f**2+i**2),P=Math.sqrt(C**2+d**2),I=f===0&&i===0?0:Math.atan2(i,f),v=C===0&&d===0?0:Math.atan2(d,C);I<0&&(I+=2*xt),v<0&&(v+=2*xt),I*=Dn,v*=Dn;let O=c-r,y=P-x,S=v-I,M=I+v,$=Math.abs(S),j;x*P===0?j=0:$<=180?j=S:S>180?j=S-360:S<-180?j=S+360:Q.warn("the unthinkable has happened");let oe=2*Math.sqrt(P*x)*Math.sin(j*we/2),ie=(r+c)/2,re=(x+P)/2,ye=_n(re),q;x*P===0?q=M:$<=180?q=M/2:M<360?q=(M+360)/2:q=(M-360)/2;let ve=(ie-50)**2,Be=1+.015*ve/Math.sqrt(20+ve),pe=1+.045*re,le=1;le-=.17*Math.cos((q-30)*we),le+=.24*Math.cos(2*q*we),le+=.32*Math.cos((3*q+6)*we),le-=.2*Math.cos((4*q-63)*we);let me=1+.015*re*le,je=30*Math.exp(-1*((q-275)/25)**2),Te=2*Math.sqrt(ye/(ye+Nn)),ce=-1*Math.sin(2*je*we)*Te,Y=(O/(n*Be))**2;return Y+=(y/(a*pe))**2,Y+=(oe/(o*me))**2,Y+=ce*(y/(a*pe))*(oe/(o*me)),Math.sqrt(Y)}const br=[[.819022437996703,.3619062600528904,-.1288737815209879],[.0329836539323885,.9292868615863434,.0361446663506424],[.0481771893596242,.2642395317527308,.6335478284694309]],yr=[[1.2268798758459243,-.5578149944602171,.2813910456659647],[-.0405757452148008,1.112286803280317,-.0717110580655164],[-.0763729366746601,-.4214933324022432,1.5869240198367816]],Pr=[[.210454268309314,.7936177747023054,-.0040720430116193],[1.9779985324311684,-2.42859224204858,.450593709617411],[.0259040424655478,.7827717124575296,-.8086757549230774]],ge=[[1,.3963377773761749,.2158037573099136],[1,-.1055613458156586,-.0638541728258133],[1,-.0894841775298119,-1.2914855480194092]];var se=new b({id:"oklab",name:"Oklab",coords:{l:{refRange:[0,1],name:"Lightness"},a:{refRange:[-.4,.4]},b:{refRange:[-.4,.4]}},white:"D65",base:V,fromBase(t){let e=R(t,br);return e[0]=Math.cbrt(e[0]),e[1]=Math.cbrt(e[1]),e[2]=Math.cbrt(e[2]),R(e,Pr,e)},toBase(t){let e=R(t,ge);return e[0]=e[0]**3,e[1]=e[1]**3,e[2]=e[2]**3,R(e,yr,e)},formats:{oklab:{coords:["<percentage> | <number>","<number> | <percentage>","<number> | <percentage>"]}}});function Kt(t,e){[t,e]=A([t,e]);let[n,a,o]=se.from(t),[r,s,i]=se.from(e),l=n-r,c=a-s,u=o-i;return Math.sqrt(l**2+c**2+u**2)}const Sr=75e-6;function Se(t,e,{epsilon:n=Sr}={}){t=A(t),e||(e=t.space),e=b.get(e);let a=t.coords;return e!==t.space&&(a=e.from(t)),e.inGamut(a,{epsilon:n})}function Fe(t){return{space:t.space,coords:t.coords.slice(),alpha:t.alpha}}function no(t,e,n="lab"){n=b.get(n);let a=n.from(t),o=n.from(e);return Math.sqrt(a.reduce((r,s,i)=>{let l=o[i];return B(s)||B(l)?r:r+(l-s)**2},0))}function Ir(t,e){return no(t,e,"lab")}const Ar=Math.PI,Vn=Ar/180;function Mr(t,e,{l:n=2,c:a=1}={}){[t,e]=A([t,e]);let[o,r,s]=J.from(t),[,i,l]=ee.from(J,[o,r,s]),[c,u,d]=J.from(e),p=ee.from(J,[c,u,d])[1];i<0&&(i=0),p<0&&(p=0);let h=o-c,m=i-p,g=r-u,f=s-d,C=g**2+f**2-m**2,x=.511;o>=16&&(x=.040975*o/(1+.01765*o));let P=.0638*i/(1+.0131*i)+.638,I;B(l)&&(l=0),l>=164&&l<=345?I=.56+Math.abs(.2*Math.cos((l+168)*Vn)):I=.36+Math.abs(.4*Math.cos((l+35)*Vn));let v=Math.pow(i,4),O=Math.sqrt(v/(v+1900)),y=P*(O*I+1-O),S=(h/(n*x))**2;return S+=(m/(a*P))**2,S+=C/y**2,Math.sqrt(S)}const Gn=203;var Pn=new b({id:"xyz-abs-d65",cssId:"--xyz-abs-d65",name:"Absolute XYZ D65",coords:{x:{refRange:[0,9504.7],name:"Xa"},y:{refRange:[0,1e4],name:"Ya"},z:{refRange:[0,10888.3],name:"Za"}},base:V,fromBase(t){return t.map(e=>e*Gn)},toBase(t){return t.map(e=>e/Gn)}});const it=1.15,lt=.66,jn=2610/2**14,vr=2**14/2610,Un=3424/2**12,$n=2413/2**7,qn=2392/2**7,Br=1.7*2523/2**5,Wn=2**5/(1.7*2523),ct=-.56,Ft=16295499532821565e-27,Tr=[[.41478972,.579999,.014648],[-.20151,1.120649,.0531008],[-.0166008,.2648,.6684799]],Er=[[1.9242264357876067,-1.0047923125953657,.037651404030618],[.35031676209499907,.7264811939316552,-.06538442294808501],[-.09098281098284752,-.3127282905230739,1.5227665613052603]],wr=[[.5,.5,0],[3.524,-4.066708,.542708],[.199076,1.096799,-1.295875]],Lr=[[1,.13860504327153927,.05804731615611883],[1,-.1386050432715393,-.058047316156118904],[1,-.09601924202631895,-.811891896056039]];var ao=new b({id:"jzazbz",name:"Jzazbz",coords:{jz:{refRange:[0,1],name:"Jz"},az:{refRange:[-.21,.21]},bz:{refRange:[-.21,.21]}},base:Pn,fromBase(t){let[e,n,a]=t,o=it*e-(it-1)*a,r=lt*n-(lt-1)*e,i=R([o,r,a],Tr).map(function(p){let h=Un+$n*z(p/1e4,jn),m=1+qn*z(p/1e4,jn);return z(h/m,Br)}),[l,c,u]=R(i,wr);return[(1+ct)*l/(1+ct*l)-Ft,c,u]},toBase(t){let[e,n,a]=t,o=(e+Ft)/(1+ct-ct*(e+Ft)),s=R([o,n,a],Lr).map(function(p){let h=Un-z(p,Wn),m=qn*z(p,Wn)-$n;return 1e4*z(h/m,vr)}),[i,l,c]=R(s,Er),u=(i+(it-1)*c)/it,d=(l+(lt-1)*u)/lt;return[u,d,c]},formats:{jzazbz:{coords:["<percentage> | <number>","<number> | <percentage>","<number> | <percentage>"]}}}),Jt=new b({id:"jzczhz",name:"JzCzHz",coords:{jz:{refRange:[0,1],name:"Jz"},cz:{refRange:[0,.26],name:"Chroma"},hz:{refRange:[0,360],type:"angle",name:"Hue"}},base:ao,fromBase:ee.fromBase,toBase:ee.toBase,formats:{jzczhz:{coords:["<percentage> | <number>","<number> | <percentage>","<number> | <angle>"]}}});function Rr(t,e){[t,e]=A([t,e]);let[n,a,o]=Jt.from(t),[r,s,i]=Jt.from(e),l=n-r,c=a-s;B(o)&&B(i)?(o=0,i=0):B(o)?o=i:B(i)&&(i=o);let u=o-i,d=2*Math.sqrt(a*s)*Math.sin(u/2*(Math.PI/180));return Math.sqrt(l**2+c**2+d**2)}const oo=3424/4096,ro=2413/128,so=2392/128,Yn=2610/16384,Or=2523/32,Hr=16384/2610,Xn=32/2523,kr=[[.3592832590121217,.6976051147779502,-.035891593232029],[-.1920808463704993,1.100476797037432,.0753748658519118],[.0070797844607479,.0748396662186362,.8433265453898765]],zr=[[2048/4096,2048/4096,0],[6610/4096,-13613/4096,7003/4096],[17933/4096,-17390/4096,-543/4096]],Fr=[[.9999999999999998,.0086090370379328,.111029625003026],[.9999999999999998,-.0086090370379328,-.1110296250030259],[.9999999999999998,.5600313357106791,-.3206271749873188]],Nr=[[2.0701522183894223,-1.3263473389671563,.2066510476294053],[.3647385209748072,.6805660249472273,-.0453045459220347],[-.0497472075358123,-.0492609666966131,1.1880659249923042]];var Qt=new b({id:"ictcp",name:"ICTCP",coords:{i:{refRange:[0,1],name:"I"},ct:{refRange:[-.5,.5],name:"CT"},cp:{refRange:[-.5,.5],name:"CP"}},base:Pn,fromBase(t){let e=R(t,kr);return Dr(e)},toBase(t){let e=_r(t);return R(e,Nr)},formats:{ictcp:{coords:["<percentage> | <number>","<number> | <percentage>","<number> | <percentage>"]}}});function Dr(t){let e=t.map(function(n){let a=oo+ro*(n/1e4)**Yn,o=1+so*(n/1e4)**Yn;return(a/o)**Or});return R(e,zr)}function _r(t){return R(t,Fr).map(function(a){let o=Math.max(a**Xn-oo,0),r=ro-so*a**Xn;return 1e4*(o/r)**Hr})}function Vr(t,e){[t,e]=A([t,e]);let[n,a,o]=Qt.from(t),[r,s,i]=Qt.from(e);return 720*Math.sqrt((n-r)**2+.25*(a-s)**2+(o-i)**2)}function Gr(t,e){[t,e]=A([t,e]);let n=2,[a,o,r]=se.from(t),[s,i,l]=se.from(e),c=a-s,u=n*(o-i),d=n*(r-l);return Math.sqrt(c**2+u**2+d**2)}const jr=W.D65,io=.42,Zn=1/io,Nt=2*Math.PI,lo=[[.401288,.650173,-.051461],[-.250268,1.204414,.045854],[-.002079,.048952,.953127]],Ur=[[1.8620678550872327,-1.0112546305316843,.14918677544445175],[.38752654323613717,.6214474419314753,-.008973985167612518],[-.015841498849333856,-.03412293802851557,1.0499644368778496]],$r=[[460,451,288],[460,-891,-261],[460,-220,-6300]],qr={dark:[.8,.525,.8],dim:[.9,.59,.9],average:[1,.69,1]},Pe={h:[20.14,90,164.25,237.53,380.14],e:[.8,.7,1,1.2,.8],H:[0,100,200,300,400]},Wr=180/Math.PI,Kn=Math.PI/180;function co(t,e){return t.map(a=>{const o=z(e*Math.abs(a)*.01,io);return 400*vt(o,a)/(o+27.13)})}function Yr(t,e){const n=100/e*27.13**Zn;return t.map(a=>{const o=Math.abs(a);return vt(n*z(o/(400-o),Zn),a)})}function Xr(t){let e=ae(t);e<=Pe.h[0]&&(e+=360);const n=Za(Pe.h,e)-1,[a,o]=Pe.h.slice(n,n+2),[r,s]=Pe.e.slice(n,n+2),i=Pe.H[n],l=(e-a)/r;return i+100*l/(l+(o-e)/s)}function Zr(t){let e=(t%400+400)%400;const n=Math.floor(.01*e);e=e%100;const[a,o]=Pe.h.slice(n,n+2),[r,s]=Pe.e.slice(n,n+2);return ae((e*(s*a-r*o)-100*a*s)/(e*(s-r)-100*s))}function uo(t,e,n,a,o){const r={};r.discounting=o,r.refWhite=t,r.surround=a;const s=t.map(f=>f*100);r.la=e,r.yb=n;const i=s[1],l=R(s,lo);let c=qr[r.surround];const u=c[0];r.c=c[1],r.nc=c[2];const p=(1/(5*r.la+1))**4;r.fl=p*r.la+.1*(1-p)*(1-p)*Math.cbrt(5*r.la),r.flRoot=r.fl**.25,r.n=r.yb/i,r.z=1.48+Math.sqrt(r.n),r.nbb=.725*r.n**-.2,r.ncb=r.nbb;const h=Math.max(Math.min(u*(1-1/3.6*Math.exp((-r.la-42)/92)),1),0);r.dRgb=l.map(f=>et(1,i/f,h)),r.dRgbInv=r.dRgb.map(f=>1/f);const m=l.map((f,C)=>f*r.dRgb[C]),g=co(m,r.fl);return r.aW=r.nbb*(2*g[0]+g[1]+.05*g[2]),r}const Jn=uo(jr,64/Math.PI*.2,20,"average",!1);function en(t,e){if(!(t.J!==void 0^t.Q!==void 0))throw new Error("Conversion requires one and only one: 'J' or 'Q'");if(!(t.C!==void 0^t.M!==void 0^t.s!==void 0))throw new Error("Conversion requires one and only one: 'C', 'M' or 's'");if(!(t.h!==void 0^t.H!==void 0))throw new Error("Conversion requires one and only one: 'h' or 'H'");if(t.J===0||t.Q===0)return[0,0,0];let n=0;t.h!==void 0?n=ae(t.h)*Kn:n=Zr(t.H)*Kn;const a=Math.cos(n),o=Math.sin(n);let r=0;t.J!==void 0?r=z(t.J,1/2)*.1:t.Q!==void 0&&(r=.25*e.c*t.Q/((e.aW+4)*e.flRoot));let s=0;t.C!==void 0?s=t.C/r:t.M!==void 0?s=t.M/e.flRoot/r:t.s!==void 0&&(s=4e-4*t.s**2*(e.aW+4)/e.c);const i=z(s*Math.pow(1.64-Math.pow(.29,e.n),-.73),10/9),l=.25*(Math.cos(n+2)+3.8),c=e.aW*z(r,2/e.c/e.z),u=5e4/13*e.nc*e.ncb*l,d=c/e.nbb,p=23*(d+.305)*xn(i,23*u+i*(11*a+108*o)),h=p*a,m=p*o,g=Yr(R([d,h,m],$r).map(f=>f*1/1403),e.fl);return R(g.map((f,C)=>f*e.dRgbInv[C]),Ur).map(f=>f/100)}function po(t,e){const n=t.map(P=>P*100),a=co(R(n,lo).map((P,I)=>P*e.dRgb[I]),e.fl),o=a[0]+(-12*a[1]+a[2])/11,r=(a[0]+a[1]-2*a[2])/9,s=(Math.atan2(r,o)%Nt+Nt)%Nt,i=.25*(Math.cos(s+2)+3.8),l=5e4/13*e.nc*e.ncb*xn(i*Math.sqrt(o**2+r**2),a[0]+a[1]+1.05*a[2]+.305),c=z(l,.9)*Math.pow(1.64-Math.pow(.29,e.n),.73),u=e.nbb*(2*a[0]+a[1]+.05*a[2]),d=z(u/e.aW,.5*e.c*e.z),p=100*z(d,2),h=4/e.c*d*(e.aW+4)*e.flRoot,m=c*d,g=m*e.flRoot,f=ae(s*Wr),C=Xr(f),x=50*z(e.c*c/(e.aW+4),1/2);return{J:p,C:m,h:f,s:x,Q:h,M:g,H:C}}var Kr=new b({id:"cam16-jmh",cssId:"--cam16-jmh",name:"CAM16-JMh",coords:{j:{refRange:[0,100],name:"J"},m:{refRange:[0,105],name:"Colorfulness"},h:{refRange:[0,360],type:"angle",name:"Hue"}},base:V,fromBase(t){this.ε===void 0&&(this.ε=Object.values(this.coords)[1].refRange[1]/1e5);const e=po(t,Jn),n=Math.abs(e.M)<this.ε;return[e.J,n?0:e.M,n?null:e.h]},toBase(t){return en({J:t[0],M:t[1],h:t[2]},Jn)}});const Jr=W.D65,Qr=216/24389,mo=24389/27;function es(t){return 116*(t>Qr?Math.cbrt(t):(mo*t+16)/116)-16}function tn(t){return t>8?Math.pow((t+16)/116,3):t/mo}function ts(t,e){let[n,a,o]=t,r=[],s=0;if(o===0)return[0,0,0];let i=tn(o);o>0?s=.00379058511492914*o**2+.608983189401032*o+.9155088574762233:s=9514440756550361e-21*o**2+.08693057439788597*o-21.928975842194614;const l=2e-12,c=15;let u=0,d=1/0;for(;u<=c;){r=en({J:s,C:a,h:n},e);const p=Math.abs(r[1]-i);if(p<d){if(p<=l)return r;d=p}s=s-(r[1]-i)*s/(2*r[1]),u+=1}return en({J:s,C:a,h:n},e)}function ns(t,e){const n=es(t[1]);if(n===0)return[0,0,0];const a=po(t,Sn);return[ae(a.h),a.C,n]}const Sn=uo(Jr,200/Math.PI*tn(50),tn(50)*100,"average",!1);var tt=new b({id:"hct",name:"HCT",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},c:{refRange:[0,145],name:"Colorfulness"},t:{refRange:[0,100],name:"Tone"}},base:V,fromBase(t){this.ε===void 0&&(this.ε=Object.values(this.coords)[1].refRange[1]/1e5);let e=ns(t);return e[1]<this.ε&&(e[1]=0,e[0]=null),e},toBase(t){return ts(t,Sn)},formats:{color:{id:"--hct",coords:["<number> | <angle>","<percentage> | <number>","<percentage> | <number>"]}}});const as=Math.PI/180,Qn=[1,.007,.0228];function ea(t){t[1]<0&&(t=tt.fromBase(tt.toBase(t)));const e=Math.log(Math.max(1+Qn[2]*t[1]*Sn.flRoot,1))/Qn[2],n=t[0]*as,a=e*Math.cos(n),o=e*Math.sin(n);return[t[2],a,o]}function os(t,e){[t,e]=A([t,e]);let[n,a,o]=ea(tt.from(t)),[r,s,i]=ea(tt.from(e));return Math.sqrt((n-r)**2+(a-s)**2+(o-i)**2)}var Ne={deltaE76:Ir,deltaECMC:Mr,deltaE2000:to,deltaEJz:Rr,deltaEITP:Vr,deltaEOK:Kt,deltaEOK2:Gr,deltaEHCT:os};function rs(t){const e=t?Math.floor(Math.log10(Math.abs(t))):0;return Math.max(parseFloat(`1e${e-2}`),1e-6)}const ta={hct:{method:"hct.c",jnd:2,deltaEMethod:"hct",blackWhiteClamp:{}},"hct-tonal":{method:"hct.c",jnd:0,deltaEMethod:"hct",blackWhiteClamp:{channel:"hct.t",min:0,max:100}}};function Ce(t,{method:e=Q.gamut_mapping,space:n=void 0,deltaEMethod:a="",jnd:o=2,blackWhiteClamp:r=void 0}={}){if(t=A(t),Ge(arguments[1])?n=arguments[1]:n||(n=t.space),n=b.get(n),Se(t,n,{epsilon:0}))return t;let s;if(e==="css")s=ss(t,{space:n});else{if(e!=="clip"&&!Se(t,n)){Object.prototype.hasOwnProperty.call(ta,e)&&({method:e,jnd:o,deltaEMethod:a,blackWhiteClamp:r}=ta[e]);let i=to;if(a!==""){for(let c in Ne)if("deltae"+a.toLowerCase()===c.toLowerCase()){i=Ne[c];break}}o===0&&(o=1e-16);let l=Ce(w(t,n),{method:"clip",space:n});if(i(t,l)>o){if(r&&Object.keys(r).length===3){let x=b.resolveCoord(r.channel),P=K(w(t,x.space),x.id);if(B(P)&&(P=0),P>=r.max)return w({space:"xyz-d65",coords:W.D65},t.space);if(P<=r.min)return w({space:"xyz-d65",coords:[0,0,0]},t.space)}let c=b.resolveCoord(e),u=c.space,d=c.id,p=w(t,u);p.coords.forEach((x,P)=>{B(x)&&(p.coords[P]=0)});let m=(c.range||c.refRange)[0],g=rs(o),f=m,C=K(p,d);for(;C-f>g;){let x=Fe(p);x=Ce(x,{space:n,method:"clip"}),i(p,x)-o<g?f=K(p,d):C=K(p,d),ue(p,d,(f+C)/2)}s=w(p,n)}else s=l}else s=w(t,n);if(e==="clip"||!Se(s,n,{epsilon:0})){let i=Object.values(n.coords).map(l=>l.range||[]);s.coords=s.coords.map((l,c)=>{let[u,d]=i[c];return u!==void 0&&(l=Math.max(u,l)),d!==void 0&&(l=Math.min(l,d)),l})}}return n!==t.space&&(s=w(s,t.space)),t.coords=s.coords,t}Ce.returns="color";const na={WHITE:{space:se,coords:[1,0,0],alpha:1},BLACK:{space:se,coords:[0,0,0],alpha:1}};function ss(t,{space:e}={}){t=A(t),e||(e=t.space),e=b.get(e);const o=b.get("oklch");if(e.isUnbounded)return w(t,e);const r=w(t,o);let s=r.coords[0];if(s>=1){const m=w(na.WHITE,e);return m.alpha=t.alpha,w(m,e)}if(s<=0){const m=w(na.BLACK,e);return m.alpha=t.alpha,w(m,e)}if(Se(r,e,{epsilon:0}))return w(r,e);function i(m){const g=w(m,e),f=Object.values(e.coords);return g.coords=g.coords.map((C,x)=>{if("range"in f[x]){const[P,I]=f[x].range;return Mt(P,C,I)}return C}),g}let l=0,c=r.coords[1],u=!0,d=Fe(r),p=i(d),h=Kt(p,d);if(h<.02)return p;for(;c-l>1e-4;){const m=(l+c)/2;if(d.coords[1]=m,u&&Se(d,e,{epsilon:0}))l=m;else if(p=i(d),h=Kt(p,d),h<.02){if(.02-h<1e-4)break;u=!1,l=m}else c=m}return p}function w(t,e,{inGamut:n}={}){t=A(t),e=b.get(e);let a=e.from(t),o={space:e,coords:a,alpha:t.alpha};return n&&(o=Ce(o,n===!0?void 0:n)),o}w.returns="color";function Ze(t,e={}){var h;let{precision:n=Q.precision,format:a,inGamut:o=!0,coords:r,alpha:s,commas:i}=e,l,c=A(t),u=a,d=c.parseMeta;d&&!a&&(d.format.canSerialize()&&(a=d.format,u=d.formatId),r??(r=d.types),s??(s=d.alphaType),i??(i=d.commas)),u&&(a=c.space.getFormat(a)??b.findFormat(u)),a||(a=c.space.getFormat("default")??b.DEFAULT_FORMAT,u=a.name),a&&a.space&&a.space!==c.space&&(c=w(c,a.space));let p=c.coords.slice();if(o||(o=a.toGamut),o&&!Se(c)&&(p=Ce(Fe(c),o===!0?void 0:o).coords),a.type==="custom")if(a.serialize)l=a.serialize(p,c.alpha,e);else throw new TypeError(`format ${u} can only be used to parse colors, not for serialization`);else{let m=a.name||"color",g=a.serializeCoords(p,n,r);if(m==="color"){let I=a.id||((h=a.ids)==null?void 0:h[0])||c.space.cssId||c.space.id;g.unshift(I)}let f=c.alpha;s!==void 0&&typeof s!="object"&&(s=typeof s=="string"?{type:s}:{include:s});let C=(s==null?void 0:s.type)??"<number>",x=(s==null?void 0:s.include)===!0||a.alpha===!0||(s==null?void 0:s.include)!==!1&&a.alpha!==!1&&f<1,P="";if(i??(i=a.commas),x){if(n!==null){let I;C==="<percentage>"&&(I="%",f*=100),f=fn(f,{precision:n,unit:I})}P=`${i?",":" /"} ${f}`}l=`${m}(${g.join(i?", ":" ")}${P})`}return l}const is=[[.6369580483012914,.14461690358620832,.1688809751641721],[.2627002120112671,.6779980715188708,.05930171646986196],[0,.028072693049087428,1.060985057710791]],ls=[[1.716651187971268,-.355670783776392,-.25336628137366],[-.666684351832489,1.616481236634939,.0157685458139111],[.017639857445311,-.042770613257809,.942103121235474]];var nt=new U({id:"rec2020-linear",cssId:"--rec2020-linear",name:"Linear REC.2020",white:"D65",toXYZ_M:is,fromXYZ_M:ls}),ho=new U({id:"rec2020",name:"REC.2020",base:nt,toBase(t){return t.map(function(e){let n=e<0?-1:1,a=e*n;return n*Math.pow(a,2.4)})},fromBase(t){return t.map(function(e){let n=e<0?-1:1,a=e*n;return n*Math.pow(a,1/2.4)})}});const cs=[[.4865709486482162,.26566769316909306,.1982172852343625],[.2289745640697488,.6917385218365064,.079286914093745],[0,.04511338185890264,1.043944368900976]],ds=[[2.493496911941425,-.9313836179191239,-.40271078445071684],[-.8294889695615747,1.7626640603183463,.023624685841943577],[.03584583024378447,-.07617238926804182,.9568845240076872]];var go=new U({id:"p3-linear",cssId:"display-p3-linear",name:"Linear P3",white:"D65",toXYZ_M:cs,fromXYZ_M:ds});const us=[[.41239079926595934,.357584339383878,.1804807884018343],[.21263900587151027,.715168678767756,.07219231536073371],[.01933081871559182,.11919477979462598,.9505321522496607]],N=[[3.2409699419045226,-1.537383177570094,-.4986107602930034],[-.9692436362808796,1.8759675015077202,.04155505740717559],[.05563007969699366,-.20397695888897652,1.0569715142428786]];var fo=new U({id:"srgb-linear",name:"Linear sRGB",white:"D65",toXYZ_M:us,fromXYZ_M:N}),aa={aliceblue:[240/255,248/255,1],antiquewhite:[250/255,235/255,215/255],aqua:[0,1,1],aquamarine:[127/255,1,212/255],azure:[240/255,1,1],beige:[245/255,245/255,220/255],bisque:[1,228/255,196/255],black:[0,0,0],blanchedalmond:[1,235/255,205/255],blue:[0,0,1],blueviolet:[138/255,43/255,226/255],brown:[165/255,42/255,42/255],burlywood:[222/255,184/255,135/255],cadetblue:[95/255,158/255,160/255],chartreuse:[127/255,1,0],chocolate:[210/255,105/255,30/255],coral:[1,127/255,80/255],cornflowerblue:[100/255,149/255,237/255],cornsilk:[1,248/255,220/255],crimson:[220/255,20/255,60/255],cyan:[0,1,1],darkblue:[0,0,139/255],darkcyan:[0,139/255,139/255],darkgoldenrod:[184/255,134/255,11/255],darkgray:[169/255,169/255,169/255],darkgreen:[0,100/255,0],darkgrey:[169/255,169/255,169/255],darkkhaki:[189/255,183/255,107/255],darkmagenta:[139/255,0,139/255],darkolivegreen:[85/255,107/255,47/255],darkorange:[1,140/255,0],darkorchid:[153/255,50/255,204/255],darkred:[139/255,0,0],darksalmon:[233/255,150/255,122/255],darkseagreen:[143/255,188/255,143/255],darkslateblue:[72/255,61/255,139/255],darkslategray:[47/255,79/255,79/255],darkslategrey:[47/255,79/255,79/255],darkturquoise:[0,206/255,209/255],darkviolet:[148/255,0,211/255],deeppink:[1,20/255,147/255],deepskyblue:[0,191/255,1],dimgray:[105/255,105/255,105/255],dimgrey:[105/255,105/255,105/255],dodgerblue:[30/255,144/255,1],firebrick:[178/255,34/255,34/255],floralwhite:[1,250/255,240/255],forestgreen:[34/255,139/255,34/255],fuchsia:[1,0,1],gainsboro:[220/255,220/255,220/255],ghostwhite:[248/255,248/255,1],gold:[1,215/255,0],goldenrod:[218/255,165/255,32/255],gray:[128/255,128/255,128/255],green:[0,128/255,0],greenyellow:[173/255,1,47/255],grey:[128/255,128/255,128/255],honeydew:[240/255,1,240/255],hotpink:[1,105/255,180/255],indianred:[205/255,92/255,92/255],indigo:[75/255,0,130/255],ivory:[1,1,240/255],khaki:[240/255,230/255,140/255],lavender:[230/255,230/255,250/255],lavenderblush:[1,240/255,245/255],lawngreen:[124/255,252/255,0],lemonchiffon:[1,250/255,205/255],lightblue:[173/255,216/255,230/255],lightcoral:[240/255,128/255,128/255],lightcyan:[224/255,1,1],lightgoldenrodyellow:[250/255,250/255,210/255],lightgray:[211/255,211/255,211/255],lightgreen:[144/255,238/255,144/255],lightgrey:[211/255,211/255,211/255],lightpink:[1,182/255,193/255],lightsalmon:[1,160/255,122/255],lightseagreen:[32/255,178/255,170/255],lightskyblue:[135/255,206/255,250/255],lightslategray:[119/255,136/255,153/255],lightslategrey:[119/255,136/255,153/255],lightsteelblue:[176/255,196/255,222/255],lightyellow:[1,1,224/255],lime:[0,1,0],limegreen:[50/255,205/255,50/255],linen:[250/255,240/255,230/255],magenta:[1,0,1],maroon:[128/255,0,0],mediumaquamarine:[102/255,205/255,170/255],mediumblue:[0,0,205/255],mediumorchid:[186/255,85/255,211/255],mediumpurple:[147/255,112/255,219/255],mediumseagreen:[60/255,179/255,113/255],mediumslateblue:[123/255,104/255,238/255],mediumspringgreen:[0,250/255,154/255],mediumturquoise:[72/255,209/255,204/255],mediumvioletred:[199/255,21/255,133/255],midnightblue:[25/255,25/255,112/255],mintcream:[245/255,1,250/255],mistyrose:[1,228/255,225/255],moccasin:[1,228/255,181/255],navajowhite:[1,222/255,173/255],navy:[0,0,128/255],oldlace:[253/255,245/255,230/255],olive:[128/255,128/255,0],olivedrab:[107/255,142/255,35/255],orange:[1,165/255,0],orangered:[1,69/255,0],orchid:[218/255,112/255,214/255],palegoldenrod:[238/255,232/255,170/255],palegreen:[152/255,251/255,152/255],paleturquoise:[175/255,238/255,238/255],palevioletred:[219/255,112/255,147/255],papayawhip:[1,239/255,213/255],peachpuff:[1,218/255,185/255],peru:[205/255,133/255,63/255],pink:[1,192/255,203/255],plum:[221/255,160/255,221/255],powderblue:[176/255,224/255,230/255],purple:[128/255,0,128/255],rebeccapurple:[102/255,51/255,153/255],red:[1,0,0],rosybrown:[188/255,143/255,143/255],royalblue:[65/255,105/255,225/255],saddlebrown:[139/255,69/255,19/255],salmon:[250/255,128/255,114/255],sandybrown:[244/255,164/255,96/255],seagreen:[46/255,139/255,87/255],seashell:[1,245/255,238/255],sienna:[160/255,82/255,45/255],silver:[192/255,192/255,192/255],skyblue:[135/255,206/255,235/255],slateblue:[106/255,90/255,205/255],slategray:[112/255,128/255,144/255],slategrey:[112/255,128/255,144/255],snow:[1,250/255,250/255],springgreen:[0,1,127/255],steelblue:[70/255,130/255,180/255],tan:[210/255,180/255,140/255],teal:[0,128/255,128/255],thistle:[216/255,191/255,216/255],tomato:[1,99/255,71/255],turquoise:[64/255,224/255,208/255],violet:[238/255,130/255,238/255],wheat:[245/255,222/255,179/255],white:[1,1,1],whitesmoke:[245/255,245/255,245/255],yellow:[1,1,0],yellowgreen:[154/255,205/255,50/255]};let oa=Array(3).fill("<percentage> | <number>[0, 255]"),ra=Array(3).fill("<number>[0, 255]");var Ie=new U({id:"srgb",name:"sRGB",base:fo,fromBase:t=>t.map(e=>{let n=e<0?-1:1,a=e*n;return a>.0031308?n*(1.055*a**(1/2.4)-.055):12.92*e}),toBase:t=>t.map(e=>{let n=e<0?-1:1,a=e*n;return a<=.04045?e/12.92:n*((a+.055)/1.055)**2.4}),formats:{rgb:{coords:oa},rgb_number:{name:"rgb",commas:!0,coords:ra,alpha:!1},color:{},rgba:{coords:oa,commas:!0,alpha:!0},rgba_number:{name:"rgba",commas:!0,coords:ra},hex:{type:"custom",toGamut:!0,test:t=>/^#(([a-f0-9]{2}){3,4}|[a-f0-9]{3,4})$/i.test(t),parse(t){t.length<=5&&(t=t.replace(/[a-f0-9]/gi,"$&$&"));let e=[];return t.replace(/[a-f0-9]{2}/gi,n=>{e.push(parseInt(n,16)/255)}),{spaceId:"srgb",coords:e.slice(0,3),alpha:e.slice(3)[0]}},serialize:(t,e,{collapse:n=!0,alpha:a}={})=>{(a!==!1&&e<1||a===!0)&&t.push(e),t=t.map(s=>Math.round(s*255));let o=n&&t.every(s=>s%17===0);return"#"+t.map(s=>o?(s/17).toString(16):s.toString(16).padStart(2,"0")).join("")}},keyword:{type:"custom",test:t=>/^[a-z]+$/i.test(t),parse(t){t=t.toLowerCase();let e={spaceId:"srgb",coords:null,alpha:1};if(t==="transparent"?(e.coords=aa.black,e.alpha=0):e.coords=aa[t],e.coords)return e}}}}),Co=new U({id:"p3",cssId:"display-p3",name:"P3",base:go,fromBase:Ie.fromBase,toBase:Ie.toBase});Q.display_space=Ie;let ps;if(typeof CSS<"u"&&CSS.supports)for(let t of[J,ho,Co]){let e=t.getMinCoords(),a=Ze({space:t,coords:e,alpha:1});if(CSS.supports("color",a)){Q.display_space=t;break}}function ms(t,{space:e=Q.display_space,...n}={}){t=A(t);let a=Ze(t,n);if(typeof CSS>"u"||CSS.supports("color",a)||!Q.display_space)a=new String(a),a.color=t;else{let o=t;if((t.coords.some(B)||B(t.alpha))&&!(ps??(ps=CSS.supports("color","hsl(none 50% 50%)")))&&(o=Fe(t),o.coords=o.coords.map(k),o.alpha=k(o.alpha),a=Ze(o,n),CSS.supports("color",a)))return a=new String(a),a.color=o,a;o=w(o,e),a=new String(Ze(o,n)),a.color=o}return a}function hs(t,e,{space:n,hue:a="shorter"}={}){t=A(t),n||(n=t.space),n=b.get(n);let o=Object.values(n.coords);[t,e]=[t,e].map(c=>w(c,n));let[r,s]=[t,e].map(c=>c.coords),i=r.map((c,u)=>{let d=o[u],p=s[u];return d.type==="angle"&&([c,p]=eo(a,[c,p])),sa(c,p)}),l=sa(t.alpha,e.alpha);return{space:n,coords:i,alpha:l}}function sa(t,e){return B(t)||B(e)?t===e?null:0:t-e}function gs(t,e){return t=A(t),e=A(e),t.space===e.space&&t.alpha===e.alpha&&t.coords.every((n,a)=>n===e.coords[a])}function xe(t){return K(t,[V,"y"])}function xo(t,e){ue(t,[V,"y"],e)}function fs(t){Object.defineProperty(t.prototype,"luminance",{get(){return xe(this)},set(e){xo(this,e)}})}var Cs=Object.freeze({__proto__:null,getLuminance:xe,register:fs,setLuminance:xo});function xs(t,e){t=A(t),e=A(e);let n=Math.max(xe(t),0),a=Math.max(xe(e),0);return a>n&&([n,a]=[a,n]),(n+.05)/(a+.05)}const bs=.56,ys=.57,Ps=.62,Ss=.65,ia=.022,Is=1.414,As=.1,Ms=5e-4,vs=1.14,la=.027,Bs=1.14;function ca(t){return t>=ia?t:t+(ia-t)**Is}function Le(t){let e=t<0?-1:1,n=Math.abs(t);return e*Math.pow(n,2.4)}function Ts(t,e){e=A(e),t=A(t);let n,a,o,r,s,i;e=w(e,"srgb"),[r,s,i]=e.coords.map(h=>B(h)?0:h);let l=Le(r)*.2126729+Le(s)*.7151522+Le(i)*.072175;t=w(t,"srgb"),[r,s,i]=t.coords.map(h=>B(h)?0:h);let c=Le(r)*.2126729+Le(s)*.7151522+Le(i)*.072175,u=ca(l),d=ca(c),p=d>u;return Math.abs(d-u)<Ms?a=0:p?(n=d**bs-u**ys,a=n*vs):(n=d**Ss-u**Ps,a=n*Bs),Math.abs(a)<As?o=0:a>0?o=a-la:o=a+la,o*100}function Es(t,e){t=A(t),e=A(e);let n=Math.max(xe(t),0),a=Math.max(xe(e),0);a>n&&([n,a]=[a,n]);let o=n+a;return o===0?0:(n-a)/o}const ws=5e4;function Ls(t,e){t=A(t),e=A(e);let n=Math.max(xe(t),0),a=Math.max(xe(e),0);return a>n&&([n,a]=[a,n]),a===0?ws:(n-a)/a}function Rs(t,e){t=A(t),e=A(e);let n=K(t,[J,"l"]),a=K(e,[J,"l"]);return Math.abs(n-a)}const Os=216/24389,da=24/116,dt=24389/27;let Dt=W.D65;var nn=new b({id:"lab-d65",name:"Lab D65",coords:{l:{refRange:[0,100],name:"Lightness"},a:{refRange:[-125,125]},b:{refRange:[-125,125]}},white:Dt,base:V,fromBase(t){let n=t.map((a,o)=>a/Dt[o]).map(a=>a>Os?Math.cbrt(a):(dt*a+16)/116);return[116*n[1]-16,500*(n[0]-n[1]),200*(n[1]-n[2])]},toBase(t){let e=[];return e[1]=(t[0]+16)/116,e[0]=t[1]/500+e[1],e[2]=e[1]-t[2]/200,[e[0]>da?Math.pow(e[0],3):(116*e[0]-16)/dt,t[0]>8?Math.pow((t[0]+16)/116,3):t[0]/dt,e[2]>da?Math.pow(e[2],3):(116*e[2]-16)/dt].map((a,o)=>a*Dt[o])},formats:{"lab-d65":{coords:["<number> | <percentage>","<number> | <percentage>","<number> | <percentage>"]}}});const _t=Math.pow(5,.5)*.5+.5;function Hs(t,e){t=A(t),e=A(e);let n=K(t,[nn,"l"]),a=K(e,[nn,"l"]),o=Math.abs(Math.pow(n,_t)-Math.pow(a,_t)),r=Math.pow(o,1/_t)*Math.SQRT2-40;return r<7.5?0:r}var ht=Object.freeze({__proto__:null,contrastAPCA:Ts,contrastDeltaPhi:Hs,contrastLstar:Rs,contrastMichelson:Es,contrastWCAG21:xs,contrastWeber:Ls});function ks(t,e,n){Ge(n)&&(n={algorithm:n});let{algorithm:a,...o}=n||{};if(!a){let r=Object.keys(ht).map(s=>s.replace(/^contrast/,"")).join(", ");throw new TypeError(`contrast() function needs a contrast algorithm. Please specify one of: ${r}`)}t=A(t),e=A(e);for(let r in ht)if("contrast"+a.toLowerCase()===r.toLowerCase())return ht[r](t,e,o);throw new TypeError(`Unknown contrast algorithm: ${a}`)}function Bt(t){let[e,n,a]=ot(t,V),o=e+15*n+3*a;return[4*e/o,9*n/o]}function bo(t){let[e,n,a]=ot(t,V),o=e+n+a;return[e/o,n/o]}function zs(t){Object.defineProperty(t.prototype,"uv",{get(){return Bt(this)}}),Object.defineProperty(t.prototype,"xy",{get(){return bo(this)}})}var Fs=Object.freeze({__proto__:null,register:zs,uv:Bt,xy:bo});function Ye(t,e,n={}){Ge(n)&&(n={method:n});let{method:a=Q.deltaE,...o}=n;for(let r in Ne)if("deltae"+a.toLowerCase()===r.toLowerCase())return Ne[r](t,e,o);throw new TypeError(`Unknown deltaE method: ${a}`)}function yo(t,e=.25){let a=[b.get("oklch","lch"),"l"];return ue(t,a,o=>o*(1+e))}function Po(t,e=.25){let a=[b.get("oklch","lch"),"l"];return ue(t,a,o=>o*(1-e))}yo.returns="color";Po.returns="color";var Ns=Object.freeze({__proto__:null,darken:Po,lighten:yo});function So(t,e,n,a={}){return[t,e]=[A(t),A(e)],he(n)==="object"&&([n,a]=[.5,n]),rt(t,e,a)(n??.5)}function Io(t,e,n={}){let a;In(t)&&([a,n]=[t,e],[t,e]=a.rangeArgs.colors);let{maxDeltaE:o,deltaEMethod:r,steps:s=2,maxSteps:i=1e3,...l}=n;a||([t,e]=[A(t),A(e)],a=rt(t,e,l));let c=Ye(t,e),u=o>0?Math.max(s,Math.ceil(c/o)+1):s,d=[];if(i!==void 0&&(u=Math.min(u,i)),u===1)d=[{p:.5,color:a(.5)}];else{let p=1/(u-1);d=Array.from({length:u},(h,m)=>{let g=m*p;return{p:g,color:a(g)}})}if(o>0){let p=d.reduce((h,m,g)=>{if(g===0)return 0;let f=Ye(m.color,d[g-1].color,r);return Math.max(h,f)},0);for(;p>o;){p=0;for(let h=1;h<d.length&&d.length<i;h++){let m=d[h-1],g=d[h],f=(g.p+m.p)/2,C=a(f);p=Math.max(p,Ye(C,m.color),Ye(C,g.color)),d.splice(h,0,{p:f,color:a(f)}),h++}}}return d=d.map(p=>p.color),d}function rt(t,e,n={}){if(In(t)){let[l,c]=[t,e];return rt(...l.rangeArgs.colors,{...l.rangeArgs.options,...c})}let{space:a,outputSpace:o,progression:r,premultiplied:s}=n;t=A(t),e=A(e),t=Fe(t),e=Fe(e);let i={colors:[t,e],options:n};if(a?a=b.get(a):a=b.registry[Q.interpolationSpace]||t.space,o=o?b.get(o):a,t=w(t,a),e=w(e,a),t=Ce(t),e=Ce(e),a.coords.h&&a.coords.h.type==="angle"){let l=n.hue=n.hue||"shorter",c=[a,"h"],[u,d]=[K(t,c),K(e,c)];B(u)&&!B(d)?u=d:B(d)&&!B(u)&&(d=u),[u,d]=eo(l,[u,d]),ue(t,c,u),ue(e,c,d)}return s&&(t.coords=t.coords.map(l=>l*t.alpha),e.coords=e.coords.map(l=>l*e.alpha)),Object.assign(l=>{l=r?r(l):l;let c=t.coords.map((p,h)=>{let m=e.coords[h];return et(p,m,l)}),u=et(t.alpha,e.alpha,l),d={space:a,coords:c,alpha:u};return s&&(d.coords=d.coords.map(p=>p/u)),o!==a&&(d=w(d,o)),d},{rangeArgs:i})}function In(t){return he(t)==="function"&&!!t.rangeArgs}Q.interpolationSpace="lab";function Ds(t){t.defineFunction("mix",So,{returns:"color"}),t.defineFunction("range",rt,{returns:"function<color>"}),t.defineFunction("steps",Io,{returns:"array<color>"})}var _s=Object.freeze({__proto__:null,isRange:In,mix:So,range:rt,register:Ds,steps:Io}),Vs=new b({id:"hsl",name:"HSL",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},s:{range:[0,100],name:"Saturation"},l:{range:[0,100],name:"Lightness"}},base:Ie,fromBase:t=>{let e=Math.max(...t),n=Math.min(...t),[a,o,r]=t,[s,i,l]=[null,0,(n+e)/2],c=e-n;if(c!==0){switch(i=l===0||l===1?0:(e-l)/Math.min(l,1-l),e){case a:s=(o-r)/c+(o<r?6:0);break;case o:s=(r-a)/c+2;break;case r:s=(a-o)/c+4}s=s*60}return i<0&&(s+=180,i=Math.abs(i)),s>=360&&(s-=360),[s,i*100,l*100]},toBase:t=>{let[e,n,a]=t;e=e%360,e<0&&(e+=360),n/=100,a/=100;function o(r){let s=(r+e/30)%12,i=n*Math.min(a,1-a);return a-i*Math.max(-1,Math.min(s-3,9-s,1))}return[o(0),o(8),o(4)]},formats:{hsl:{coords:["<number> | <angle>","<percentage> | <number>","<percentage> | <number>"]},hsla:{coords:["<number> | <angle>","<percentage> | <number>","<percentage> | <number>"],commas:!0,alpha:!0}}}),Ao=new b({id:"hsv",name:"HSV",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},s:{range:[0,100],name:"Saturation"},v:{range:[0,100],name:"Value"}},base:Ie,fromBase(t){let e=Math.max(...t),n=Math.min(...t),[a,o,r]=t,[s,i,l]=[null,0,e],c=e-n;if(c!==0){switch(e){case a:s=(o-r)/c+(o<r?6:0);break;case o:s=(r-a)/c+2;break;case r:s=(a-o)/c+4}s=s*60}return l&&(i=c/l),s>=360&&(s-=360),[s,i*100,l*100]},toBase(t){let[e,n,a]=t;e=e%360,e<0&&(e+=360),n/=100,a/=100;function o(r){let s=(r+e/60)%6;return a-a*n*Math.max(0,Math.min(s,4-s,1))}return[o(5),o(3),o(1)]},formats:{color:{id:"--hsv",coords:["<number> | <angle>","<percentage> | <number>","<percentage> | <number>"]}}}),Gs=new b({id:"hwb",name:"HWB",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},w:{range:[0,100],name:"Whiteness"},b:{range:[0,100],name:"Blackness"}},base:Ao,fromBase(t){let[e,n,a]=t;return[e,a*(100-n)/100,100-a]},toBase(t){let[e,n,a]=t;n/=100,a/=100;let o=n+a;if(o>=1){let i=n/o;return[e,0,i*100]}let r=1-a,s=r===0?0:1-n/r;return[e,s*100,r*100]},formats:{hwb:{coords:["<number> | <angle>","<percentage> | <number>","<percentage> | <number>"]}}});const js=[[.5766690429101305,.1855582379065463,.1882286462349947],[.29734497525053605,.6273635662554661,.07529145849399788],[.02703136138641234,.07068885253582723,.9913375368376388]],Us=[[2.0415879038107465,-.5650069742788596,-.34473135077832956],[-.9692436362808795,1.8759675015077202,.04155505740717557],[.013444280632031142,-.11836239223101838,1.0151749943912054]];var Mo=new U({id:"a98rgb-linear",cssId:"--a98-rgb-linear",name:"Linear Adobe® 98 RGB compatible",white:"D65",toXYZ_M:js,fromXYZ_M:Us}),$s=new U({id:"a98rgb",cssId:"a98-rgb",name:"Adobe® 98 RGB compatible",base:Mo,toBase:t=>t.map(e=>Math.pow(Math.abs(e),563/256)*Math.sign(e)),fromBase:t=>t.map(e=>Math.pow(Math.abs(e),256/563)*Math.sign(e))});const qs=[[.7977666449006423,.13518129740053308,.0313477341283922],[.2880748288194013,.711835234241873,8993693872564e-17],[0,0,.8251046025104602]],Ws=[[1.3457868816471583,-.25557208737979464,-.05110186497554526],[-.5446307051249019,1.5082477428451468,.02052744743642139],[0,0,1.2119675456389452]];var vo=new U({id:"prophoto-linear",cssId:"--prophoto-rgb-linear",name:"Linear ProPhoto",white:"D50",base:yn,toXYZ_M:qs,fromXYZ_M:Ws});const Ys=1/512,Xs=16/512;var Zs=new U({id:"prophoto",cssId:"prophoto-rgb",name:"ProPhoto",base:vo,toBase(t){return t.map(e=>{let n=e<0?-1:1,a=e*n;return a<Xs?e/16:n*a**1.8})},fromBase(t){return t.map(e=>{let n=e<0?-1:1,a=e*n;return a>=Ys?n*a**(1/1.8):16*e})}});const ut=1.09929682680944,ua=.018053968510807;var Ks=new U({id:"--rec2020-oetf",name:"REC.2020_Scene_Referred",base:nt,referred:"scene",toBase(t){return t.map(function(e){let n=e<0?-1:1,a=e*n;return a<ua*4.5?e/4.5:n*Math.pow((a+ut-1)/ut,1/.45)})},fromBase(t){return t.map(function(e){let n=e<0?-1:1,a=e*n;return a>=ua?n*(ut*Math.pow(a,.45)-(ut-1)):4.5*e})}}),Js=new b({id:"oklch",name:"OkLCh",coords:{l:{refRange:[0,1],name:"Lightness"},c:{refRange:[0,.4],name:"Chroma"},h:{refRange:[0,360],type:"angle",name:"Hue"}},white:"D65",base:se,fromBase:ee.fromBase,toBase:ee.toBase,formats:{oklch:{coords:["<percentage> | <number>","<number> | <percentage>","<number> | <angle>"]}}});const De=2*Math.PI,bt=[[4.076741636075958,-3.307711539258063,.2309699031821043],[-1.2684379732850315,2.609757349287688,-.341319376002657],[-.0041960761386756,-.7034186179359362,1.7076146940746117]],yt=[[[-1.8817031,-.80936501],[1.19086277,1.76576728,.59662641,.75515197,.56771245]],[[1.8144408,-1.19445267],[.73956515,-.45954404,.08285427,.12541073,-.14503204]],[[.13110758,1.81333971],[1.35733652,-.00915799,-1.1513021,-.50559606,.00692167]]],Vt=Number.MAX_VALUE,Ke=.206,An=.03,Xe=(1+Ke)/(1+An);function D(t,e){let n=t.length;if(n!==e.length)throw new Error(`Vectors of size ${n} and ${e.length} are not aligned`);let a=0;return t.forEach((o,r)=>{a+=o*e[r]}),a}function Je(t){return .5*(Xe*t-Ke+Math.sqrt((Xe*t-Ke)*(Xe*t-Ke)+4*An*Xe*t))}function ke(t){return(t**2+Ke*t)/(Xe*(t+An))}function Mn(t){let[e,n]=t;return[n/e,n/(1-e)]}function Qs(t,e){let n=.11516993+1/(7.4477897+4.1590124*e+t*(-2.19557347+1.75198401*e+t*(-2.13704948-10.02301043*e+t*(-4.24894561+5.38770819*e+4.69891013*t)))),a=.11239642+1/(1.6132032-.68124379*e+t*(.40370612+.90148123*e+t*(-.27087943+.6122399*e+t*(.00299215-.45399568*e-.14661872*t))));return[n,a]}function vn(t,e){let n=R(t,ge);return n[0]=n[0]**3,n[1]=n[1]**3,n[2]=n[2]**3,R(n,e,n)}function Tt(t,e,n,a){let o=ti(t,e,n,a),r=vn([1,o*t,o*e],n),s=z(1/Math.max(...r),1/3),i=s*o;return[s,i]}function ei(t,e,n,a,o,r,s,i){let l;if(i===void 0&&(i=Tt(t,e,r,s)),(n-o)*i[1]-(i[0]-o)*a<=0)l=i[1]*o/(a*i[0]+i[1]*(o-n));else{l=i[1]*(o-1)/(a*(i[0]-1)+i[1]*(o-n));let c=n-o,u=a,d=D(ge[0].slice(1),[t,e]),p=D(ge[1].slice(1),[t,e]),h=D(ge[2].slice(1),[t,e]),m=c+u*d,g=c+u*p,f=c+u*h,C=o*(1-l)+l*n,x=l*a,P=C+x*d,I=C+x*p,v=C+x*h,O=P**3,y=I**3,S=v**3,M=3*m*P**2,$=3*g*I**2,j=3*f*v**2,oe=6*m**2*P,ie=6*g**2*I,re=6*f**2*v,ye=D(r[0],[O,y,S])-1,q=D(r[0],[M,$,j]),ve=D(r[0],[oe,ie,re]),Be=q/(q*q-.5*ye*ve),pe=-ye*Be,le=D(r[1],[O,y,S])-1,me=D(r[1],[M,$,j]),je=D(r[1],[oe,ie,re]),Te=me/(me*me-.5*le*je),ce=-le*Te,Y=D(r[2],[O,y,S])-1,Ue=D(r[2],[M,$,j]),Ot=D(r[2],[oe,ie,re]),de=Ue/(Ue*Ue-.5*Y*Ot),$e=-Y*de;pe=Be>=0?pe:Vt,ce=Te>=0?ce:Vt,$e=de>=0?$e:Vt,l+=Math.min(pe,Math.min(ce,$e))}return l}function Bo(t,e,n){let[a,o,r]=t,s=Tt(o,r,e,n),i=ei(o,r,a,1,a,e,n,s),l=Mn(s),c=i/Math.min(a*l[0],(1-a)*l[1]),u=Qs(o,r),d=a*u[0],p=(1-a)*u[1],h=.9*c*Math.sqrt(Math.sqrt(1/(1/d**4+1/p**4)));return d=a*.4,p=(1-a)*.8,[Math.sqrt(1/(1/d**2+1/p**2)),h,i]}function ti(t,e,n,a){let o,r,s,i,l,c,u,d;D(a[0][0],[t,e])>1?([o,r,s,i,l]=a[0][1],[c,u,d]=n[0]):D(a[1][0],[t,e])>1?([o,r,s,i,l]=a[1][1],[c,u,d]=n[1]):([o,r,s,i,l]=a[2][1],[c,u,d]=n[2]);let p=o+r*t+s*e+i*t**2+l*t*e,h=D(ge[0].slice(1),[t,e]),m=D(ge[1].slice(1),[t,e]),g=D(ge[2].slice(1),[t,e]),f=1+p*h,C=1+p*m,x=1+p*g,P=f**3,I=C**3,v=x**3,O=3*h*f**2,y=3*m*C**2,S=3*g*x**2,M=6*h**2*f,$=6*m**2*C,j=6*g**2*x,oe=c*P+u*I+d*v,ie=c*O+u*y+d*S,re=c*M+u*$+d*j;return p=p-oe*ie/(ie**2-.5*oe*re),p}function ni(t,e,n){let[a,o,r]=t,s=ke(r),i=null,l=null;if(a=ae(a)/360,s!==0&&s!==1&&o!==0){let c=Math.cos(De*a),u=Math.sin(De*a),[d,p,h]=Bo([s,c,u],e,n),m=.8,g=1.25,f,C,x,P;o<m?(f=g*o,C=0,x=m*d,P=1-x/p):(f=5*(o-.8),C=p,x=.2*p**2*1.25**2/d,P=1-x/(h-p));let I=C+f*x/(1-P*f);i=I*c,l=I*u}return[s,i,l]}function ai(t,e,n){let a=1e-7,o=1e-4,r=t[0],s=0,i=Je(r),l=Math.sqrt(t[1]**2+t[2]**2),c=.5+Math.atan2(-t[2],-t[1])/De;if(i!==0&&i!==1&&l!==0){let d=t[1]/l,p=t[2]/l,[h,m,g]=Bo([r,d,p],e,n),f=.8,C=1.25,x,P,I,v;l<m?(P=f*h,I=1-P/m,v=l/(P+I*l),s=v*f):(x=m,P=.2*m**2*C**2/h,I=1-P/(g-m),v=(l-x)/(P+I*(l-x)),s=f+.2*v)}const u=Math.abs(s)<o;return u||i===0||Math.abs(1-i)<a?(c=null,u||(s=0)):c=ae(c*360),[c,s,i]}var oi=new b({id:"okhsl",name:"Okhsl",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},s:{range:[0,1],name:"Saturation"},l:{range:[0,1],name:"Lightness"}},base:se,gamutSpace:"self",fromBase(t){return ai(t,bt,yt)},toBase(t){return ni(t,bt,yt)},formats:{color:{id:"--okhsl",coords:["<number> | <angle>","<percentage> | <number>","<percentage> | <number>"]}}}),To=new b({id:"oklrab",name:"Oklrab",coords:{l:{refRange:[0,1],name:"Lightness"},a:{refRange:[-.4,.4]},b:{refRange:[-.4,.4]}},white:"D65",base:se,fromBase(t){return[Je(t[0]),t[1],t[2]]},toBase(t){return[ke(t[0]),t[1],t[2]]},formats:{color:{coords:["<percentage> | <number>","<number> | <percentage>[-1,1]","<number> | <percentage>[-1,1]"]}}}),ri=new b({id:"oklrch",name:"Oklrch",coords:{l:{refRange:[0,1],name:"Lightness"},c:{refRange:[0,.4],name:"Chroma"},h:{refRange:[0,360],type:"angle",name:"Hue"}},white:"D65",base:To,fromBase:ee.fromBase,toBase:ee.toBase,formats:{color:{coords:["<percentage> | <number>","<number> | <percentage>[0,1]","<number> | <angle>"]}}});function si(t,e,n){let[a,o,r]=t;a=ae(a)/360;let s=ke(r),i=null,l=null;if(s!==0&&o!==0){let c=Math.cos(De*a),u=Math.sin(De*a),d=Tt(c,u,e,n),[p,h]=Mn(d),m=.5,g=1-m/p,f=1-o*m/(m+h-h*g*o),C=o*h*m/(m+h-h*g*o);s=r*f;let x=r*C,P=ke(f),I=C*P/f,v=ke(s);x=x*v/s,s=v;let[O,y,S]=vn([P,c*I,u*I],e),M=z(1/Math.max(Math.max(O,y),Math.max(S,0)),1/3);s=s*M,x=x*M,i=x*c,l=x*u}return[s,i,l]}function ii(t,e,n){let a=1e-4,o=t[0],r=0,s=Je(o),i=Math.sqrt(t[1]**2+t[2]**2),l=.5+Math.atan2(-t[2],-t[1])/De;if(o!==0&&o!==1&&i!==0){let c=t[1]/i,u=t[2]/i,d=Tt(c,u,e,n),[p,h]=Mn(d),m=.5,g=1-m/p,f=h/(i+o*h),C=f*o,x=f*i,P=ke(C),I=x*P/C,[v,O,y]=vn([P,c*I,u*I],e),S=z(1/Math.max(Math.max(v,O),Math.max(y,0)),1/3);o=o/S,i=i/S,i=i*Je(o)/o,o=Je(o),s=o/C,r=(m+h)*x/(h*m+h*g*x)}return Math.abs(r)<a||s===0?l=null:l=ae(l*360),[l,r,s]}var li=new b({id:"okhsv",name:"Okhsv",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},s:{range:[0,1],name:"Saturation"},v:{range:[0,1],name:"Value"}},base:se,gamutSpace:"self",fromBase(t){return ii(t,bt,yt)},toBase(t){return si(t,bt,yt)},formats:{color:{id:"--okhsv",coords:["<number> | <angle>","<percentage> | <number>","<percentage> | <number>"]}}});let Eo=W.D65;const ci=216/24389,pa=24389/27,[ma,ha]=Bt({space:V,coords:Eo});var wo=new b({id:"luv",name:"Luv",coords:{l:{refRange:[0,100],name:"Lightness"},u:{refRange:[-215,215]},v:{refRange:[-215,215]}},white:Eo,base:V,fromBase(t){let e=[k(t[0]),k(t[1]),k(t[2])],n=e[1],[a,o]=Bt({space:V,coords:e});if(!Number.isFinite(a)||!Number.isFinite(o))return[0,0,0];let r=n<=ci?pa*n:116*Math.cbrt(n)-16;return[r,13*r*(a-ma),13*r*(o-ha)]},toBase(t){let[e,n,a]=t;if(e===0||B(e))return[0,0,0];n=k(n),a=k(a);let o=n/(13*e)+ma,r=a/(13*e)+ha,s=e<=8?e/pa:Math.pow((e+16)/116,3);return[s*(9*o/(4*r)),s,s*((12-3*o-20*r)/(4*r))]},formats:{color:{id:"--luv",coords:["<number> | <percentage>","<number> | <percentage>","<number> | <percentage>"]}}}),Bn=new b({id:"lchuv",name:"LChuv",coords:{l:{refRange:[0,100],name:"Lightness"},c:{refRange:[0,220],name:"Chroma"},h:{refRange:[0,360],type:"angle",name:"Hue"}},base:wo,fromBase:ee.fromBase,toBase:ee.toBase,formats:{color:{id:"--lchuv",coords:["<number> | <percentage>","<number> | <percentage>","<number> | <angle>"]}}});const di=216/24389,ui=24389/27,ga=N[0][0],fa=N[0][1],Gt=N[0][2],Ca=N[1][0],xa=N[1][1],jt=N[1][2],ba=N[2][0],ya=N[2][1],Ut=N[2][2];function Re(t,e,n){const a=e/(Math.sin(n)-t*Math.cos(n));return a<0?1/0:a}function Pt(t){const e=Math.pow(t+16,3)/1560896,n=e>di?e:t/ui,a=n*(284517*ga-94839*Gt),o=n*(838422*Gt+769860*fa+731718*ga),r=n*(632260*Gt-126452*fa),s=n*(284517*Ca-94839*jt),i=n*(838422*jt+769860*xa+731718*Ca),l=n*(632260*jt-126452*xa),c=n*(284517*ba-94839*Ut),u=n*(838422*Ut+769860*ya+731718*ba),d=n*(632260*Ut-126452*ya);return{r0s:a/r,r0i:o*t/r,r1s:a/(r+126452),r1i:(o-769860)*t/(r+126452),g0s:s/l,g0i:i*t/l,g1s:s/(l+126452),g1i:(i-769860)*t/(l+126452),b0s:c/d,b0i:u*t/d,b1s:c/(d+126452),b1i:(u-769860)*t/(d+126452)}}function Pa(t,e){const n=e/360*Math.PI*2,a=Re(t.r0s,t.r0i,n),o=Re(t.r1s,t.r1i,n),r=Re(t.g0s,t.g0i,n),s=Re(t.g1s,t.g1i,n),i=Re(t.b0s,t.b0i,n),l=Re(t.b1s,t.b1i,n);return Math.min(a,o,r,s,i,l)}var pi=new b({id:"hsluv",name:"HSLuv",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},s:{range:[0,100],name:"Saturation"},l:{range:[0,100],name:"Lightness"}},base:Bn,gamutSpace:Ie,fromBase(t){let[e,n,a]=[k(t[0]),k(t[1]),k(t[2])],o;if(e>99.9999999)o=0,e=100;else if(e<1e-8)o=0,e=0;else{let r=Pt(e),s=Pa(r,a);o=n/s*100}return[a,o,e]},toBase(t){let[e,n,a]=[k(t[0]),k(t[1]),k(t[2])],o;if(a>99.9999999)a=100,o=0;else if(a<1e-8)a=0,o=0;else{let r=Pt(a);o=Pa(r,e)/100*n}return[a,o,e]},formats:{color:{id:"--hsluv",coords:["<number> | <angle>","<percentage> | <number>","<percentage> | <number>"]}}});N[0][0];N[0][1];N[0][2];N[1][0];N[1][1];N[1][2];N[2][0];N[2][1];N[2][2];function Oe(t,e){return Math.abs(e)/Math.sqrt(Math.pow(t,2)+1)}function Sa(t){let e=Oe(t.r0s,t.r0i),n=Oe(t.r1s,t.r1i),a=Oe(t.g0s,t.g0i),o=Oe(t.g1s,t.g1i),r=Oe(t.b0s,t.b0i),s=Oe(t.b1s,t.b1i);return Math.min(e,n,a,o,r,s)}var mi=new b({id:"hpluv",name:"HPLuv",coords:{h:{refRange:[0,360],type:"angle",name:"Hue"},s:{range:[0,100],name:"Saturation"},l:{range:[0,100],name:"Lightness"}},base:Bn,gamutSpace:"self",fromBase(t){let[e,n,a]=[k(t[0]),k(t[1]),k(t[2])],o;if(e>99.9999999)o=0,e=100;else if(e<1e-8)o=0,e=0;else{let r=Pt(e),s=Sa(r);o=n/s*100}return[a,o,e]},toBase(t){let[e,n,a]=[k(t[0]),k(t[1]),k(t[2])],o;if(a>99.9999999)a=100,o=0;else if(a<1e-8)a=0,o=0;else{let r=Pt(a);o=Sa(r)/100*n}return[a,o,e]},formats:{color:{id:"--hpluv",coords:["<number> | <angle>","<percentage> | <number>","<percentage> | <number>"]}}}),Tn=new U({id:"rec2100-linear",name:"Linear REC.2100",white:"D65",toBase:nt.toBase,fromBase:nt.fromBase});const Ia=203,Aa=2610/2**14,hi=2**14/2610,gi=2523/2**5,Ma=2**5/2523,va=3424/2**12,Ba=2413/2**7,Ta=2392/2**7;var fi=new U({id:"rec2100pq",cssId:"rec2100-pq",name:"REC.2100-PQ",base:Tn,toBase(t){return t.map(function(e){return(Math.max(e**Ma-va,0)/(Ba-Ta*e**Ma))**hi*1e4/Ia})},fromBase(t){return t.map(function(e){let n=Math.max(e*Ia/1e4,0),a=va+Ba*n**Aa,o=1+Ta*n**Aa;return(a/o)**gi})}});const Ea=.17883277,wa=.28466892,La=.55991073,$t=3.7743;var Ci=new U({id:"rec2100hlg",cssId:"rec2100-hlg",name:"REC.2100-HLG",referred:"scene",base:Tn,toBase(t){return t.map(function(e){return e<=.5?e**2/3*$t:(Math.exp((e-La)/Ea)+wa)/12*$t})},fromBase(t){return t.map(function(e){return e/=$t,e<=1/12?z(3*e,.5):Ea*Math.log(12*e-wa)+La})}});const Lo={};fe.add("chromatic-adaptation-start",t=>{t.options.method&&(t.M=Ro(t.W1,t.W2,t.options.method))});fe.add("chromatic-adaptation-end",t=>{t.M||(t.M=Ro(t.W1,t.W2,t.options.method))});function Et({id:t,toCone_M:e,fromCone_M:n}){Lo[t]=arguments[0]}function Ro(t,e,n="Bradford"){let a=Lo[n],[o,r,s]=We(a.toCone_M,t),[i,l,c]=We(a.toCone_M,e),u=[[i/o,0,0],[0,l/r,0],[0,0,c/s]],d=We(u,a.toCone_M);return We(a.fromCone_M,d)}Et({id:"von Kries",toCone_M:[[.40024,.7076,-.08081],[-.2263,1.16532,.0457],[0,0,.91822]],fromCone_M:[[1.8599363874558397,-1.1293816185800916,.21989740959619328],[.3611914362417676,.6388124632850422,-6370596838649899e-21],[0,0,1.0890636230968613]]});Et({id:"Bradford",toCone_M:[[.8951,.2664,-.1614],[-.7502,1.7135,.0367],[.0389,-.0685,1.0296]],fromCone_M:[[.9869929054667121,-.14705425642099013,.15996265166373122],[.4323052697233945,.5183602715367774,.049291228212855594],[-.00852866457517732,.04004282165408486,.96848669578755]]});Et({id:"CAT02",toCone_M:[[.7328,.4296,-.1624],[-.7036,1.6975,.0061],[.003,.0136,.9834]],fromCone_M:[[1.0961238208355142,-.27886900021828726,.18274517938277307],[.4543690419753592,.4735331543074117,.07209780371722911],[-.009627608738429355,-.00569803121611342,1.0153256399545427]]});Et({id:"CAT16",toCone_M:[[.401288,.650173,-.051461],[-.250268,1.204414,.045854],[-.002079,.048952,.953127]],fromCone_M:[[1.862067855087233,-1.0112546305316845,.14918677544445172],[.3875265432361372,.6214474419314753,-.008973985167612521],[-.01584149884933386,-.03412293802851557,1.0499644368778496]]});Object.assign(W,{A:[1.0985,1,.35585],C:[.98074,1,1.18232],D55:[.95682,1,.92149],D75:[.94972,1,1.22638],E:[1,1,1],F2:[.99186,1,.67393],F7:[.95041,1,1.08747],F11:[1.00962,1,.6435]});W.ACES=[.32168/.33767,1,(1-.32168-.33767)/.33767];const xi=[[.6624541811085053,.13400420645643313,.1561876870049078],[.27222871678091454,.6740817658111484,.05368951740793705],[-.005574649490394108,.004060733528982826,1.0103391003129971]],bi=[[1.6410233796943257,-.32480329418479,-.23642469523761225],[-.6636628587229829,1.6153315916573379,.016756347685530137],[.011721894328375376,-.008284441996237409,.9883948585390215]];var Oo=new U({id:"acescg",cssId:"--acescg",name:"ACEScg",coords:{r:{range:[0,65504],name:"Red"},g:{range:[0,65504],name:"Green"},b:{range:[0,65504],name:"Blue"}},referred:"scene",white:W.ACES,toXYZ_M:xi,fromXYZ_M:bi});const pt=2**-16,qt=-.35828683,mt=(Math.log2(65504)+9.72)/17.52;var yi=new U({id:"acescc",cssId:"--acescc",name:"ACEScc",coords:{r:{range:[qt,mt],name:"Red"},g:{range:[qt,mt],name:"Green"},b:{range:[qt,mt],name:"Blue"}},referred:"scene",base:Oo,toBase(t){const e=-.3013698630136986;return t.map(function(n){return n<=e?(2**(n*17.52-9.72)-pt)*2:n<mt?2**(n*17.52-9.72):65504})},fromBase(t){return t.map(function(e){return e<=0?(Math.log2(pt)+9.72)/17.52:e<pt?(Math.log2(pt+e*.5)+9.72)/17.52:(Math.log2(e)+9.72)/17.52})}}),Ra=Object.freeze({__proto__:null,A98RGB:$s,A98RGB_Linear:Mo,ACEScc:yi,ACEScg:Oo,CAM16_JMh:Kr,HCT:tt,HPLuv:mi,HSL:Vs,HSLuv:pi,HSV:Ao,HWB:Gs,ICTCP:Qt,JzCzHz:Jt,Jzazbz:ao,LCH:ee,LCHuv:Bn,Lab:J,Lab_D65:nn,Luv:wo,OKLCH:Js,OKLab:se,OKLrCH:ri,OKLrab:To,Okhsl:oi,Okhsv:li,P3:Co,P3_Linear:go,ProPhoto:Zs,ProPhoto_Linear:vo,REC_2020:ho,REC_2020_Linear:nt,REC_2020_Scene_Referred:Ks,REC_2100_HLG:Ci,REC_2100_Linear:Tn,REC_2100_PQ:fi,XYZ_ABS_D65:Pn,XYZ_D50:yn,XYZ_D65:V,sRGB:Ie,sRGB_Linear:fo});let H=class X{constructor(...e){let n;if(e.length===1){let s={};typeof e[0]=="object"&&Object.getPrototypeOf(e[0]).constructor===Object&&(e[0]={...e[0]}),n=A(e[0],{parseMeta:s}),s.format&&(this.parseMeta=s)}let a,o,r;n?(a=n.space||n.spaceId,o=n.coords,r=n.alpha):[a,o,r]=e,Object.defineProperty(this,"space",{value:b.get(a),writable:!1,enumerable:!0,configurable:!0}),this.coords=o?o.slice():[0,0,0],this.alpha=B(r)?r:r===void 0?1:Mt(0,r,1);for(let s in this.space.coords)Object.defineProperty(this,s,{get:()=>this.get(s),set:i=>this.set(s,i)})}get spaceId(){return this.space.id}clone(){return new X(this.space,this.coords,this.alpha)}toJSON(){return{spaceId:this.spaceId,coords:this.coords,alpha:this.alpha}}display(...e){let n=ms(this,...e);return n.color=new X(n.color),n}static get(e,...n){return ze(e,this)?e:new X(e,...n)}static try(e,n){if(ze(e,this))return e;let a=Qa(e,n);return a?new X(a):null}static defineFunction(e,n,a=n){let{instance:o=!0,returns:r}=a,s=function(...i){let l=n(...i);if(r==="color")l=X.get(l);else if(r==="function<color>"){let c=l;l=function(...u){let d=c(...u);return X.get(d)},Object.assign(l,c)}else r==="array<color>"&&(l=l.map(c=>X.get(c)));return l};e in X||(X[e]=s),o&&(X.prototype[e]=function(...i){return s(this,...i)})}static defineFunctions(e){for(let n in e)X.defineFunction(n,e[n],e[n])}static extend(e){if(e.register)e.register(X);else for(let n in e)X.defineFunction(n,e[n])}};H.defineFunctions({get:K,getAll:ot,set:ue,setAll:bn,to:w,equals:gs,inGamut:Se,toGamut:Ce,distance:no,deltas:hs,toString:Ze});Object.assign(H,{util:pr,hooks:fe,WHITES:W,Space:b,spaces:b.registry,parse:Ka,defaults:Q});for(let t of Object.keys(Ra))b.register(Ra[t]);for(let t in b.registry)an(t,b.registry[t]);fe.add("colorspace-init-end",t=>{var e;an(t.id,t),(e=t.aliases)==null||e.forEach(n=>{an(n,t)})});function an(t,e){let n=t.replace(/-/g,"_");Object.defineProperty(H.prototype,n,{get(){let a=this.getAll(t);if(typeof Proxy>"u")return a;let o=new Proxy(a,{has:(r,s)=>{try{return b.resolveCoord([e,s]),!0}catch{}return Reflect.has(r,s)},get:(r,s,i)=>{if(s&&typeof s!="symbol"&&!(s in r)&&s in o){let{index:l}=b.resolveCoord([e,s]);if(l>=0)return r[l]}return Reflect.get(r,s,i)},set:(r,s,i,l)=>{if(s&&typeof s!="symbol"&&!(s in r)||Number(s)>=0){let{index:c}=b.resolveCoord([e,s]);if(c>=0)return r[c]=i,this.setAll(t,r),!0}return Reflect.set(r,s,i,l)}});return o},set(a){this.setAll(t,a)},configurable:!0,enumerable:!0})}H.extend(Ne);H.extend({deltaE:Ye});Object.assign(H,{deltaEMethods:Ne});H.extend(Ns);H.extend({contrast:ks});H.extend(Fs);H.extend(Cs);H.extend(_s);H.extend(ht);function wt(t){return String(t??"").trim().toUpperCase()}function T(t,e,n){return Math.min(n,Math.max(e,t))}function Ae(t,e=0){const n=Number.isFinite(Number(t))?Number(t):Number(e);return Number.isFinite(n)?(n%360+360)%360:0}function G(t){if(t instanceof H)return t;if(t&&typeof t=="object"&&Number.isFinite(t.r)&&Number.isFinite(t.g)&&Number.isFinite(t.b))try{return new H("srgb",[T((t.r||0)/255,0,1),T((t.g||0)/255,0,1),T((t.b||0)/255,0,1)])}catch{return null}if(t&&typeof t=="object"&&Number.isFinite(t.h)&&Number.isFinite(t.s)&&Number.isFinite(t.l))try{return new H("hsl",[Ae(t.h),T(t.s,0,100),T(t.l,0,100)])}catch{return null}if(t&&typeof t=="object"&&typeof t.hex=="string")return G(t.hex);if(t&&typeof t=="object"&&typeof t.space<"u"&&Array.isArray(t.coords))try{return new H(t)}catch{return null}const e=String(t??"").trim();if(!e)return null;try{return new H(e)}catch{return null}}function be(t){const e=G(t);if(!e)return null;try{return wt(e.to("srgb").toString({format:"hex",alpha:!1,collapse:!1}))}catch{return null}}function Pi(t){const e=wt(t);return L.HEX_6_REGEX.test(e)&&be(e)===e}function Si(t){const e=String(t??"").trim();if(!e)return null;const n=G(e),a=be(n);if(!n||!a)return null;const o=n.to("srgb"),r=n.to("hsl"),s=n.to("oklch"),[i=0,l=0,c=0]=o.coords||[],[u=0,d=0,p=0]=r.coords||[],[h=0,m=0,g=Number.NaN]=s.coords||[];return{color:n,inputValue:e,css:a,hex:a,rgb:[Math.round(T(i,0,1)*255),Math.round(T(l,0,1)*255),Math.round(T(c,0,1)*255)],hsl:{h:Ae(u),s:T(d,0,100),l:T(p,0,100)},oklch:{l:T(h,0,1),c:T(m,0,.4),h:Ae(g,u)}}}function St(t){var r;if(t&&typeof t=="object"&&Number.isFinite(t.r)&&Number.isFinite(t.g)&&Number.isFinite(t.b))return{r:Math.round(T(t.r,0,255)),g:Math.round(T(t.g,0,255)),b:Math.round(T(t.b,0,255))};const e=(r=G(t))==null?void 0:r.to("srgb"),[n=0,a=0,o=0]=(e==null?void 0:e.coords)||[];return{r:Math.round(T(n,0,1)*255),g:Math.round(T(a,0,1)*255),b:Math.round(T(o,0,1)*255)}}function Ii(t){return t&&typeof t=="object"&&Number.isFinite(t.r)&&Number.isFinite(t.g)&&Number.isFinite(t.b)?wt(`#${[t.r,t.g,t.b].map(e=>T(Math.round(e),0,255).toString(16).padStart(2,"0")).join("")}`):be(t)}function Ai(t,e,n){return be(new H("hsl",[Ae(t),T(Number(e),0,100),T(Number(n),0,100)]))}function Mi(t){var r;const e=(r=G(t))==null?void 0:r.to("hsl"),[n=0,a=0,o=0]=(e==null?void 0:e.coords)||[];return{h:Ae(n),s:T(a,0,100),l:T(o,0,100)}}function En(t,e={}){var r,s,i;const n=G(t);if(!n)return null;const a=Number.isFinite(e.maxChroma)?Number(e.maxChroma):.4,o=Number.isFinite(e.fallbackHue)?Number(e.fallbackHue):((i=(s=(r=G(t))==null?void 0:r.to("hsl"))==null?void 0:s.coords)==null?void 0:i[0])||0;try{const l=n.to("oklch"),[c=0,u=0,d=Number.NaN]=l.coords||[];return{l:T(c,0,1),c:T(u,0,a),h:Ae(d,o)}}catch{return null}}function vi(t,e={}){return En(t,e)}function Bi(t,e,n,a={}){const o=Number.isFinite(a.minLightness)?Number(a.minLightness):0,r=Number.isFinite(a.maxLightness)?Number(a.maxLightness):1,s=Number.isFinite(a.maxChroma)?Number(a.maxChroma):.4,i=a.outputSpace||"srgb",l=a.gamutMethod||"oklch.c";let c=null;try{c=new H("oklch",[T(Number(t),o,r),T(Number(e),0,s),Ae(n,a.fallbackHue)])}catch{return null}if(typeof c.toGamut=="function")try{c=c.toGamut({space:i,method:l})}catch{return null}return be(c)}function Ti(t){const e=G(t);return e?e.luminance:0}function Ei(t){const e=En(t);if(e)return e.l;const{r:n,g:a,b:o}=St(t);return(n*299+a*587+o*114)/2550}function Ho(t,e){const n=St(t),a=St(e),o=n.r-a.r,r=n.g-a.g,s=n.b-a.b;return Math.sqrt(o*o+r*r+s*s)}function wi(t,e,n={}){const a=String(n.method||"deltae76").toLowerCase();if(a==="rgb")return Ho(t,e);const o=G(t),r=G(e);return!o||!r?Number.POSITIVE_INFINITY:a==="deltae2000"||a==="2000"?o.deltaE(r,"2000"):o.deltaE(r,"76")}function on(t,e){const n=G(t),a=G(e);return!n||!a?1:n.contrast(a,"WCAG21")}function Li(t,e={}){const n=e.lightColor||"#FFFFFF",a=e.darkColor||"#000000",o=on(n,t),r=on(a,t);return o>=r?n:a}function Ri(t,e,n,a={}){const o=G(t),r=G(e);if(!o||!r)return null;const s=o.range(r,{space:a.space||"srgb",outputSpace:"srgb"});return be(s(T(Number(n),0,1)))}function Oi(t,e,n,a={}){const o=G(t),r=G(e),s=Math.max(2,Math.round(Number(n)||0));return!o||!r?[]:o.steps(r,{space:a.space||"oklch",outputSpace:a.outputSpace||"srgb",steps:s}).map(i=>be(i)).filter(Boolean)}const _e={Color:H,createColor:G,parseCssColor:Si,colorToHex:be,normalizeHexColor:wt,isValidHexColor:Pi,hexToRgb:St,rgbToHex:Ii,hslToHex:Ai,hexToHsl:Mi,colorToOklch:En,hexToOklch:vi,oklchToHex:Bi,getRelativeLuminance:Ti,getPerceivedLightness:Ei,getRgbDistance:Ho,getColorDistance:wi,getContrastRatio:on,getReadableTextColor:Li,mixHexColors:Ri,getHexColorSteps:Oi};window.Color=H;window.AppColorUtils=_e;const{normalizeHexColor:Lt,isValidHexColor:Rt}=_e,Wt=Array.isArray(L.DEFAULT_TARGET_COLORS)?L.DEFAULT_TARGET_COLORS.map(t=>Lt(t)).filter(t=>Rt(t)):[],Oa=Lt(L.DEFAULT_COLOR_BASE||""),ko=Wt.length>0?Wt[Math.floor(Math.random()*Wt.length)]:Rt(Oa)?Oa:null;let te={palette:[],activeColor:ko,lastSource:null};function Ve(){return{palette:[...te.palette],activeColor:te.activeColor,lastSource:te.lastSource}}function zo(t,e={}){$a("shared-colors:changed",{type:t,state:Ve(),metadata:e})}function Hi(t){return Array.isArray(t)?t.map(e=>Lt(e)).filter(e=>Rt(e)):[]}function ki(t,e={}){const n=Hi(t);return(n.length!==te.palette.length||n.some((o,r)=>o!==te.palette[r]))&&(te={...te,palette:n,lastSource:String(e.source||te.lastSource||"")},zo("palette",e)),Ve()}function zi(t,e={}){const n=Lt(t),a=Rt(n)?n:null;return a===te.activeColor||(te={...te,activeColor:a,lastSource:String(e.source||te.lastSource||"")},zo("activeColor",e)),Ve()}function Fi(t){return ja("shared-colors:changed",t)}const _={getState:Ve,getDefaultActiveColor(){return ko},setPalette:ki,setActiveColor:zi,subscribe:Fi};window.AppSharedColors=_;const Ni="data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='24'%20height='24'%20viewBox='0%200%2024%2024'%20fill='none'%20stroke='%236a7282'%20stroke-width='2'%20stroke-linecap='round'%20stroke-linejoin='round'%20class='lucide%20lucide-copy%20size-4%20text-gray-800'%20data-fg-d3bl108='0.8:6.35049:/src/app/App.tsx:567:29:21719:41:e:Copy::::::CsY9'%3e%3crect%20width='14'%20height='14'%20x='8'%20y='8'%20rx='2'%20ry='2'%3e%3c/rect%3e%3cpath%20d='M4%2016c-1.1%200-2-.9-2-2V4c0-1.1.9-2%202-2h10c1.1%200%202%20.9%202%202'%3e%3c/path%3e%3c/svg%3e",Di="data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='24'%20height='24'%20viewBox='0%200%2024%2024'%20fill='none'%20stroke='%236a7282'%20stroke-width='2'%20stroke-linecap='round'%20stroke-linejoin='round'%20class='lucide%20lucide-trash2%20lucide-trash-2%20size-4%20text-gray-800'%20data-fg-d3bl116='0.8:6.35049:/src/app/App.tsx:585:31:22551:43:e:Trash2::::::c98'%3e%3cpath%20d='M3%206h18'%3e%3c/path%3e%3cpath%20d='M19%206v14c0%201-1%202-2%202H7c-1%200-2-1-2-2V6'%3e%3c/path%3e%3cpath%20d='M8%206V4c0-1%201-2%202-2h4c1%200%202%201%202%202v2'%3e%3c/path%3e%3cline%20x1='10'%20x2='10'%20y1='11'%20y2='17'%3e%3c/line%3e%3cline%20x1='14'%20x2='14'%20y1='11'%20y2='17'%3e%3c/line%3e%3c/svg%3e",_i="data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='24'%20height='24'%20viewBox='0%200%2024%2024'%20fill='none'%20stroke='%236a7282'%20stroke-width='2'%20stroke-linecap='round'%20stroke-linejoin='round'%20class='lucide%20lucide-square-pen%20size-4%20text-gray-800'%20data-fg-d3bl100='0.8:6.35049:/src/app/App.tsx:544:29:20600:41:e:Edit::::::C5F4'%3e%3cpath%20d='M12%203H5a2%202%200%200%200-2%202v14a2%202%200%200%200%202%202h14a2%202%200%200%200%202-2v-7'%3e%3c/path%3e%3cpath%20d='M18.375%202.625a1%201%200%200%201%203%203l-9.013%209.014a2%202%200%200%201-.853.505l-2.873.84a.5.5%200%200%201-.62-.62l.84-2.873a2%202%200%200%201%20.506-.852z'%3e%3c/path%3e%3c/svg%3e",Vi="data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='24'%20height='24'%20viewBox='0%200%2024%2024'%20fill='none'%20stroke='%23ffffff'%20stroke-width='2'%20stroke-linecap='round'%20stroke-linejoin='round'%20class='lucide%20lucide-wand-sparkles%20size-5%20text-white'%20data-fg-d3bl64='0.8:6.35049:/src/app/App.tsx:473:17:17181:39:e:Wand2::::::exk'%3e%3cpath%20d='m21.64%203.64-1.28-1.28a1.21%201.21%200%200%200-1.72%200L2.36%2018.64a1.21%201.21%200%200%200%200%201.72l1.28%201.28a1.2%201.2%200%200%200%201.72%200L21.64%205.36a1.2%201.2%200%200%200%200-1.72'%3e%3c/path%3e%3cpath%20d='m14%207%203%203'%3e%3c/path%3e%3cpath%20d='M5%206v4'%3e%3c/path%3e%3cpath%20d='M19%2014v4'%3e%3c/path%3e%3cpath%20d='M10%202v2'%3e%3c/path%3e%3cpath%20d='M7%208H3'%3e%3c/path%3e%3cpath%20d='M21%2016h-4'%3e%3c/path%3e%3cpath%20d='M11%203H9'%3e%3c/path%3e%3c/svg%3e",Gi="data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='24'%20height='24'%20viewBox='0%200%2024%2024'%20fill='none'%20stroke='%236a7282'%20stroke-width='2'%20stroke-linecap='round'%20stroke-linejoin='round'%20class='lucide%20lucide-refresh-cw%20size-4%20text-gray-800'%20data-fg-d3bl93='0.8:6.35049:/src/app/App.tsx:527:29:19807:46:e:RefreshCw::::::FaX'%3e%3cpath%20d='M3%2012a9%209%200%200%201%209-9%209.75%209.75%200%200%201%206.74%202.74L21%208'%3e%3c/path%3e%3cpath%20d='M21%203v5h-5'%3e%3c/path%3e%3cpath%20d='M21%2012a9%209%200%200%201-9%209%209.75%209.75%200%200%201-6.74-2.74L3%2016'%3e%3c/path%3e%3cpath%20d='M8%2016H3v5'%3e%3c/path%3e%3c/svg%3e",ji={icons:{regenerate:Gi,edit:_i,copy:Ni,delete:Di,magicWand:Vi}};window.AppAssetUrls=ji;const Ui=new Set(["automatic","monochromatic","complementary","analogous","triad","tetrad"]),$i=new Set(["color","temperature","image"]),qi=new Set(["automatic","shades","tints"]),Wi=new Set(["soft","medium","intense"]),{normalizeHexColor:Qe,isValidHexColor:wn}=_e,rn=new Set;function It(t,e){return Number.isFinite(t)?Math.min(100,Math.max(0,Number(t))):e}function sn(t){return Array.isArray(t)?t.map(e=>Qe(e)).filter(e=>wn(e)):[]}function Fo(t){return $i.has(t)?t:L.DEFAULT_PALETTE_BASE_MODE}function ln(t,e=L.DEFAULT_COLOR_PALETTE_TYPE){return Ui.has(t)?t:e}function No(t){return qi.has(t)?t:L.DEFAULT_MONOCHROMATIC_GENERATION_MODE}function Do(t){return Wi.has(t)?t:L.DEFAULT_ANALOGOUS_SEPARATION_MODE}function _o(t,e){const n=!!(t!=null&&t.warm),a=!!(t!=null&&t.cool);return!n&&!a?{...e}:{warm:n,cool:a}}function Yi(t){if(!t||typeof t!="object")return null;const e=String(t.dataUrl||"").trim();return e?{name:String(t.name||""),type:String(t.type||""),dataUrl:e,analysisCache:t.analysisCache??null}:null}function Xi(t){if(Array.isArray(t)){const r=sn(t);return r.length===0?null:{colors:r,createdAt:null,isAlternative:!1,pinnedIndexes:[],settings:null}}if(!t||typeof t!="object")return null;const e=t,n=sn(e.colors);if(n.length===0)return null;const a=e.createdAt,o=a instanceof Date?new Date(a.getTime()):typeof a=="string"?a:null;return{colors:n,createdAt:o,isAlternative:!!e.isAlternative,pinnedIndexes:Array.isArray(e.pinnedIndexes)?e.pinnedIndexes.map(r=>Number(r)).filter(r=>Number.isFinite(r)&&r>=0):[],settings:e.settings&&typeof e.settings=="object"?{...e.settings}:null}}function Zi(t){return Array.isArray(t)?t.map(Xi).filter(e=>!!e):[]}function Ki(t){return t?{...t,analysisCache:t.analysisCache&&typeof t.analysisCache=="object"?{...t.analysisCache}:t.analysisCache}:null}function Ji(t){return{colors:[...t.colors],createdAt:t.createdAt instanceof Date?new Date(t.createdAt.getTime()):t.createdAt??null,isAlternative:!!t.isAlternative,pinnedIndexes:[...t.pinnedIndexes],settings:t.settings&&typeof t.settings=="object"?{...t.settings}:null}}function Qi(t){return{...t,paletteHistory:t.paletteHistory.map(Ji),uploadedBaseImage:Ki(t.uploadedBaseImage),temperature:{...t.temperature},currentPalette:[...t.currentPalette],adjustments:{...t.adjustments}}}function el(t={}){const e=At();rn.forEach(n=>{n(e,t)})}var Va,Ga;const Ha=((Va=_.getDefaultActiveColor)==null?void 0:Va.call(_))||((Ga=_.getState)==null?void 0:Ga.call(_).activeColor)||L.DEFAULT_COLOR_BASE;let E={paletteSize:Number(L.DEFAULT_PALETTE_SIZE)||0,paletteHistory:[],paletteHistoryIndex:-1,paletteBaseMode:Fo(L.DEFAULT_PALETTE_BASE_MODE),uploadedBaseImage:null,prioritizeImageDominantColors:!0,imagePaletteVariantIndex:0,imageInspirationVariantIndex:0,colorPaletteVariantIndex:0,selectedPaletteBaseColor:wn(Qe(Ha))?Qe(Ha):Qe(L.DEFAULT_COLOR_BASE),selectedColorPaletteType:ln(L.DEFAULT_COLOR_PALETTE_TYPE),selectedMonochromaticGenerationMode:No(L.DEFAULT_MONOCHROMATIC_GENERATION_MODE),selectedAnalogousSeparationMode:Do(L.DEFAULT_ANALOGOUS_SEPARATION_MODE),resolvedAutomaticColorPaletteType:"triad",temperature:_o(L.DEFAULT_TEMPERATURE,{warm:!0,cool:!1}),currentPalette:[],adjustments:{brightness:It(L.DEFAULT_BRIGHTNESS,L.DEFAULT_BRIGHTNESS),saturation:It(L.DEFAULT_SATURATION,L.DEFAULT_SATURATION)}};function qe(t,e={}){var a,o;if(!t||typeof t!="object")return At();const n={...E,paletteSize:Number.isFinite(t.paletteSize)?Math.max(0,Number(t.paletteSize)):E.paletteSize,paletteHistory:Object.prototype.hasOwnProperty.call(t,"paletteHistory")?Zi(t.paletteHistory):E.paletteHistory,paletteHistoryIndex:Number.isFinite(t.paletteHistoryIndex)?Number(t.paletteHistoryIndex):E.paletteHistoryIndex,paletteBaseMode:Object.prototype.hasOwnProperty.call(t,"paletteBaseMode")?Fo(t.paletteBaseMode):E.paletteBaseMode,uploadedBaseImage:Object.prototype.hasOwnProperty.call(t,"uploadedBaseImage")?Yi(t.uploadedBaseImage):E.uploadedBaseImage,prioritizeImageDominantColors:Object.prototype.hasOwnProperty.call(t,"prioritizeImageDominantColors")?!!t.prioritizeImageDominantColors:E.prioritizeImageDominantColors,imagePaletteVariantIndex:Number.isFinite(t.imagePaletteVariantIndex)?Math.max(0,Number(t.imagePaletteVariantIndex)):E.imagePaletteVariantIndex,imageInspirationVariantIndex:Number.isFinite(t.imageInspirationVariantIndex)?Math.max(0,Number(t.imageInspirationVariantIndex)):E.imageInspirationVariantIndex,colorPaletteVariantIndex:Number.isFinite(t.colorPaletteVariantIndex)?Math.max(0,Number(t.colorPaletteVariantIndex)):E.colorPaletteVariantIndex,selectedPaletteBaseColor:Object.prototype.hasOwnProperty.call(t,"selectedPaletteBaseColor")?(()=>{const r=Qe(t.selectedPaletteBaseColor);return wn(r)?r:E.selectedPaletteBaseColor})():E.selectedPaletteBaseColor,selectedColorPaletteType:Object.prototype.hasOwnProperty.call(t,"selectedColorPaletteType")?ln(t.selectedColorPaletteType,E.selectedColorPaletteType):E.selectedColorPaletteType,selectedMonochromaticGenerationMode:Object.prototype.hasOwnProperty.call(t,"selectedMonochromaticGenerationMode")?No(t.selectedMonochromaticGenerationMode):E.selectedMonochromaticGenerationMode,selectedAnalogousSeparationMode:Object.prototype.hasOwnProperty.call(t,"selectedAnalogousSeparationMode")?Do(t.selectedAnalogousSeparationMode):E.selectedAnalogousSeparationMode,resolvedAutomaticColorPaletteType:Object.prototype.hasOwnProperty.call(t,"resolvedAutomaticColorPaletteType")?ln(t.resolvedAutomaticColorPaletteType,E.resolvedAutomaticColorPaletteType):E.resolvedAutomaticColorPaletteType,temperature:Object.prototype.hasOwnProperty.call(t,"temperature")?_o(t.temperature,E.temperature):{...E.temperature},currentPalette:Object.prototype.hasOwnProperty.call(t,"currentPalette")?sn(t.currentPalette):E.currentPalette,adjustments:{brightness:Object.prototype.hasOwnProperty.call(t,"adjustments")?It((a=t.adjustments)==null?void 0:a.brightness,E.adjustments.brightness):E.adjustments.brightness,saturation:Object.prototype.hasOwnProperty.call(t,"adjustments")?It((o=t.adjustments)==null?void 0:o.saturation,E.adjustments.saturation):E.adjustments.saturation}};return n.paletteHistory.length===0?n.paletteHistoryIndex=-1:n.paletteHistoryIndex=Math.max(-1,Math.min(n.paletteHistoryIndex,n.paletteHistory.length-1)),E=n,el(e),At()}function At(){return Qi(E)}function tl(t){return typeof t!="function"?()=>{}:(rn.add(t),()=>{rn.delete(t)})}const nl={getState:At,patchState:qe,syncFromLegacy(t,e={}){return qe(t,{...e,source:e.source||"legacy"})},syncCurrentPalette(t,e={}){return qe({currentPalette:t},e)},syncHistory(t,e,n={}){return qe({paletteHistory:t,paletteHistoryIndex:e},n)},syncAdjustments(t,e={}){return qe({adjustments:t},e)},subscribe:tl};window.PaletteGeneratorStore=nl;const{normalizeHexColor:cn,isValidHexColor:al,hexToOklch:Ln,oklchToHex:ol,getColorDistance:Yt}=_e;function ne(t,e,n){return Math.min(n,Math.max(e,Number(t)))}function rl(t,e,n){const a=Number(t)||0,o=Number(e)||0,r=Number(n)||0;return a+(o-a)*r}function at(t={},e={}){return{brightness:Number.isFinite(t==null?void 0:t.brightness)?Number(t.brightness):Number.isFinite(e==null?void 0:e.brightness)?Number(e.brightness):0,saturation:Number.isFinite(t==null?void 0:t.saturation)?Number(t.saturation):Number.isFinite(e==null?void 0:e.saturation)?Number(e.saturation):0}}function sl(t={},e={},n={}){const a=at(t,n),o=at(e,n);return{brightnessDelta:a.brightness-o.brightness,saturationDelta:a.saturation-o.saturation}}function dn(t,e={}){const n=Number.isFinite(e.minLightness)?Number(e.minLightness):.18,a=Number.isFinite(e.maxLightness)?Number(e.maxLightness):.94,o=Number.isFinite(e.gamma)?Number(e.gamma):.84,r=ne((Number(t)||0)/100,0,1);return n+(a-n)*r**o}function un(t,e={}){const n=Number.isFinite(e.minChroma)?Number(e.minChroma):.0015,a=Number.isFinite(e.maxChroma)?Number(e.maxChroma):.24,o=Number.isFinite(e.gamma)?Number(e.gamma):1.7,r=ne((Number(t)||0)/100,0,1);return n+(a-n)*r**o}function il(t,e={}){const n=cn(t),a=Ln(n);if(!a)return n;const o=Number.isFinite(e.variantIndex)?Number(e.variantIndex):0,r=at(e.settings,e.fallbackSettings),s=at(e.baseSettings,e.fallbackSettings),i=[0,-.014,.014,-.028,.028,-.04,.04],l=[0],c=[1,.99,1.01,.97,1.03],u=i[o%i.length],d=l[Math.floor(o/i.length)%l.length],p=c[Math.floor(o/(i.length*l.length))%c.length],h={minChroma:.001,maxChroma:.24,gamma:1.35},m=dn(s.brightness),g=dn(r.brightness),f=un(s.saturation,h),C=un(r.saturation,h),x=(g-m)*.7,P=f>1e-4?C/f:1,I=ne(a.l+x+u,.14,.96),v=Math.max(a.c,.003)*p,O=ne(v*ne(P,.02,1.25),.001,.28);return cn(ol(I,O,a.h+d,{minLightness:.14,maxLightness:.96,maxChroma:.28})||n)}function Me(t){return Array.isArray(t)?t.map(e=>cn(e)).filter(e=>al(e)):[]}function Vo(t,e){const n=Me(t),a=Me(e);if(n.length===0||a.length===0)return{exactMatch:!1,sharedColorCount:0,nextCount:n.length,referenceCount:a.length};const o=n.length===a.length&&n.every((i,l)=>i===a[l]),r=new Set(a),s=n.reduce((i,l)=>i+(r.has(l)?1:0),0);return{exactMatch:o,sharedColorCount:s,nextCount:n.length,referenceCount:a.length}}function ll(t,e){const n=Me(t),a=Me(e),o=Math.min(n.length,a.length);let r=0;for(let s=0;s<o;s+=1)n[s]===a[s]&&(r+=1);return{samePositionCount:r,comparableCount:o,nextCount:n.length,referenceCount:a.length}}function cl(t,e){const n=Vo(t,e);return n.exactMatch||n.sharedColorCount>=Math.max(n.nextCount-1,3)}function dl(t,e){return e?t.samePositionCount!==e.samePositionCount?(t.samePositionCount||0)<(e.samePositionCount||0):t.isTooSimilar!==e.isTooSimilar?!t.isTooSimilar:(t.score||0)>(e.score||0):!0}function ul(t){const e=Me(t);if(e.length===0)return-1/0;if(e.length===1)return 0;const n=e.map(d=>Ln(d));let a=0,o=0,r=0;for(let d=0;d<e.length;d+=1)for(let p=d+1;p<e.length;p+=1){const h=(Yt==null?void 0:Yt(e[d],e[p],{method:"deltae2000"}))||0;a+=Math.min(h/34,1),h<10&&(r+=(10-h)/10),o+=1}const s=o>0?a/o:0,i=n.reduce((d,p)=>d+ne(((p==null?void 0:p.c)??0)/.24*100,0,100),0)/n.length,l=n.reduce((d,p)=>d+ne(((p==null?void 0:p.l)??.5)*100,0,100),0)/n.length,c=1-Math.min(Math.abs(i-42)/42,1),u=1-Math.min(Math.abs(l-58)/58,1);return s*2.1+c*.75+u*.7-r*.9}function pl(t){const e=Me(t);if(e.length===0)return-1/0;const n=e.map(m=>Ln(m)),a=n.reduce((m,g)=>m+ne(((g==null?void 0:g.c)??0)/.24*100,0,100),0)/n.length,o=n.reduce((m,g)=>m+ne(((g==null?void 0:g.l)??.5)*100,0,100),0)/n.length,r=n.reduce((m,g)=>{const f=ne(((g==null?void 0:g.c)??0)/.24*100,0,100);return m+Math.abs(f-a)},0)/n.length,s=n.reduce((m,g)=>{const f=ne(((g==null?void 0:g.l)??.5)*100,0,100);return m+Math.abs(f-o)},0)/n.length,i=n.filter(m=>((m==null?void 0:m.c)??0)/.24*100>62).length,l=n.filter(m=>{const g=((m==null?void 0:m.l)??.5)*100;return g<22||g>82}).length,c=n.filter(m=>{const g=((m==null?void 0:m.c)??0)/.24*100;return g>=18&&g<=52}).length,u=1-Math.min(Math.abs(a-36)/36,1),d=1-Math.min(Math.abs(o-58)/58,1),p=1-Math.min(Math.abs(r-12)/20,1),h=1-Math.min(Math.abs(s-13)/22,1);return u*.95+d*.85+p*.65+h*.6+c/n.length*.4-i/n.length*.85-l/n.length*.75}const ml={clampControlValue:ne,blendControlValue:rl,resolvePaletteAdjustmentSettings:at,getPaletteAdjustmentDeltas:sl,mapBrightnessValueToOklchLightness:dn,mapSaturationValueToOklchChroma:un,getAdjustedPaletteColor:il,normalizePaletteHexCollection:Me,getPaletteSimilarityMetrics:Vo,getPalettePositionalSimilarityMetrics:ll,arePalettesTooSimilar:cl,isBetterPaletteFallbackCandidate:dl,scorePaletteHarmony:ul,scorePaletteElegance:pl};window.PaletteGeneratorCoreHelpers=ml;function hl(){if(window.AppDom)return window.AppDom;const t=document.getElementById("palette"),e=document.querySelector(".controls"),n=document.querySelector(".palette-section"),a=document.getElementById("history"),o=document.getElementById("paletteBaseControlGroup"),r=document.getElementById("paletteBaseModeSelect"),s=document.getElementById("colorBasePanel"),i=document.getElementById("temperatureBasePanel"),l=document.getElementById("imageBasePanel"),c=document.getElementById("paletteColorSwatchBtn"),u=document.getElementById("paletteColorSwatchFill"),d=document.getElementById("paletteColorTextInput"),p=document.getElementById("paletteColorInputFeedback"),h=document.getElementById("paletteColorPicker"),m=document.getElementById("paletteTypeOptions"),g=document.getElementById("paletteTypeResolvedLabel"),f=document.getElementById("monochromaticModeControl"),C=document.getElementById("monochromaticModeSelect"),x=document.getElementById("analogousSeparationControl"),P=document.getElementById("analogousSeparationSelect"),I=document.getElementById("paletteImageInput"),v=document.getElementById("paletteImageDropzonePanel"),O=document.getElementById("paletteImageDropzone"),y=document.getElementById("paletteImagePreview"),S=document.getElementById("paletteImagePreviewImg"),M=document.getElementById("paletteImageName"),$=document.getElementById("paletteImageDominantToggle"),j=document.getElementById("paletteImageReplaceBtn"),oe=document.getElementById("paletteIntensityControlGroup"),ie=document.getElementById("brightnessControlGroup"),re=document.getElementById("brightness"),ye=document.getElementById("saturation"),q=document.getElementById("saturationControlGroup"),ve=document.getElementById("paletteAdjustBtn"),Be=document.getElementById("paletteAdjustPanel"),pe=document.getElementById("paletteUndoBtn"),le=document.getElementById("paletteRedoBtn"),me=document.getElementById("paletteViewport"),je=document.getElementById("paletteLoadingOverlay"),Te=document.getElementById("paletteImageExtractionAlert"),ce=document.getElementById("addColorBtn"),Y=document.getElementById("colorPicker"),Ue=document.querySelector(".add-color"),Ot=document.getElementById("paletteGenerationButtons"),de=document.getElementById("copyHexBtn"),$e=document.getElementById("paletteRegenerateBtn"),$o=document.getElementById("paletteInspirationBtn"),qo=document.getElementById("generateBtn"),Wo=document.getElementById("surpriseBtn"),Yo=(de==null?void 0:de.querySelector(".tooltip"))??null,Xo=(de==null?void 0:de.querySelector("span"))??null,Zo=document.getElementById("resetPaletteBtn"),Ko=document.getElementById("warmBtn"),Jo=document.getElementById("coolBtn"),Qo=document.querySelectorAll(".size"),er=(ce==null?void 0:ce.querySelector("span"))??null,tr=document.getElementById("brightnessValue"),On=document.querySelectorAll(".brightness-labels .brightness-icon"),nr=On[0]||null,ar=On[1]||null,or=document.getElementById("saturationValue"),Hn=document.querySelectorAll(".saturation-labels .saturation-icon"),rr=Hn[0]||null,sr=Hn[1]||null;let Ee=document.querySelector(".card-edit-input");Ee||(Ee=document.createElement("input"),Ee.type="color",Ee.className="card-edit-input",document.body.appendChild(Ee)),Y&&(Y.disabled=!0,Y.tabIndex=-1,Y.style.pointerEvents="none",Y.setAttribute("aria-hidden","true"));const kn={paletteContainer:t,controlsPanel:e,paletteSection:n,historyContainer:a,paletteBaseControlGroup:o,paletteBaseModeSelect:r,colorBasePanel:s,temperatureBasePanel:i,imageBasePanel:l,paletteColorSwatchBtn:c,paletteColorSwatchFill:u,paletteColorTextInput:d,paletteColorInputFeedback:p,paletteColorPicker:h,paletteTypeOptions:m,paletteTypeResolvedLabel:g,monochromaticModeControl:f,monochromaticModeSelect:C,analogousSeparationControl:x,analogousSeparationSelect:P,paletteImageInput:I,paletteImageDropzonePanel:v,paletteImageDropzone:O,paletteImagePreview:y,paletteImagePreviewImg:S,paletteImageName:M,paletteImageDominantToggle:$,paletteImageReplaceBtn:j,paletteIntensityControlGroup:oe,brightnessControlGroup:ie,brightnessInput:re,saturationInput:ye,saturationControlGroup:q,paletteAdjustBtn:ve,paletteAdjustPanel:Be,paletteUndoBtn:pe,paletteRedoBtn:le,paletteViewport:me,paletteLoadingOverlay:je,paletteImageExtractionAlert:Te,addColorBtn:ce,colorPicker:Y,addColorElement:Ue,paletteGenerationButtons:Ot,copyHexBtn:de,paletteRegenerateBtn:$e,paletteInspirationBtn:$o,generateBtn:qo,surpriseBtn:Wo,copyHexBtnTooltip:Yo,copyHexBtnLabel:Xo,resetPaletteBtn:Zo,warmBtn:Ko,coolBtn:Jo,sizeButtons:Qo,addColorLabel:er,brightnessValueLabel:tr,darkBrightnessIcon:nr,lightBrightnessIcon:ar,saturationValueLabel:or,lowSaturationIcon:rr,highSaturationIcon:sr,globalEditPicker:Ee};return window.AppDom=kn,kn}let ka=!1;function gl(){if(ka)return window.AppShell;const t="palette_generator",e=Array.from(document.querySelectorAll(".view-tab")),n=Array.from(document.querySelectorAll("nav button")),a=document.querySelector(".logo img");function o(c){const u=String(c??"").trim();return e.some(p=>p.id===u)?u:t}function r(c){n.forEach(u=>{u.classList.toggle("active",u.getAttribute("data-view")===c)})}function s(c,u={}){const d=o(c);return e.forEach(p=>{p.classList.toggle("active",p.id===d)}),r(d),qa.emit("app:view-changed",{view:d,metadata:u}),d}function i(){return s(location.hash.replace("#",""),{source:"location"})}if(n.forEach(c=>{c.addEventListener("click",()=>{const u=c.getAttribute("data-view");if(!u)return;const d=s(u,{source:"nav"});history.replaceState(null,"",`#${d}`),window.scrollTo({top:0,behavior:"auto"})})}),window.addEventListener("hashchange",i),i(),a&&!matchMedia("(prefers-reduced-motion: reduce)").matches){const c=()=>{a.style.setProperty("--scroll-rotate",`${window.scrollY*.2}deg`)};window.addEventListener("scroll",c,{passive:!0}),c()}const l={showView:s,getCurrentView(){var c;return((c=document.querySelector(".view-tab.active"))==null?void 0:c.id)||t}};return window.AppShell=l,ka=!0,l}function fl(){gn.list().forEach(e=>{typeof(e==null?void 0:e.initialize)=="function"&&e.initialize()})}class Rn{constructor(e,n,a){F(this,"r");F(this,"g");F(this,"b");this.r=0,this.g=0,this.b=0,this.set(e,n,a)}set(e,n,a){this.r=this.clamp(e),this.g=this.clamp(n),this.b=this.clamp(a)}copyFrom(e){return this.set(e.r,e.g,e.b),this}toCssRgb(){return`rgb(${Math.round(this.r)}, ${Math.round(this.g)}, ${Math.round(this.b)})`}hueRotate(e=0){const n=e/180*Math.PI,a=Math.sin(n),o=Math.cos(n);this.multiply([.213+o*.787-a*.213,.715-o*.715-a*.715,.072-o*.072+a*.928,.213-o*.213+a*.143,.715+o*.285+a*.14,.072-o*.072-a*.283,.213-o*.213-a*.787,.715-o*.715+a*.715,.072+o*.928+a*.072])}grayscale(e=1){this.multiply([.2126+.7874*(1-e),.7152-.7152*(1-e),.0722-.0722*(1-e),.2126-.2126*(1-e),.7152+.2848*(1-e),.0722-.0722*(1-e),.2126-.2126*(1-e),.7152-.7152*(1-e),.0722+.9278*(1-e)])}sepia(e=1){this.multiply([.393+.607*(1-e),.769-.769*(1-e),.189-.189*(1-e),.349-.349*(1-e),.686+.314*(1-e),.168-.168*(1-e),.272-.272*(1-e),.534-.534*(1-e),.131+.869*(1-e)])}saturate(e=1){this.multiply([.213+.787*e,.715-.715*e,.072-.072*e,.213-.213*e,.715+.285*e,.072-.072*e,.213-.213*e,.715-.715*e,.072+.928*e])}brightness(e=1){this.linear(e)}contrast(e=1){this.linear(e,-(.5*e)+.5)}linear(e=1,n=0){this.r=this.clamp(this.r*e+n*255),this.g=this.clamp(this.g*e+n*255),this.b=this.clamp(this.b*e+n*255)}invert(e=1){this.r=this.clamp((e+this.r/255*(1-2*e))*255),this.g=this.clamp((e+this.g/255*(1-2*e))*255),this.b=this.clamp((e+this.b/255*(1-2*e))*255)}multiply(e){const n=this.clamp(this.r*e[0]+this.g*e[1]+this.b*e[2]),a=this.clamp(this.r*e[3]+this.g*e[4]+this.b*e[5]),o=this.clamp(this.r*e[6]+this.g*e[7]+this.b*e[8]);this.r=n,this.g=a,this.b=o}hsl(){const e=this.r/255,n=this.g/255,a=this.b/255,o=Math.max(e,n,a),r=Math.min(e,n,a),s=o-r;let i=0,l=0;const c=(o+r)/2;if(s!==0){switch(l=c>.5?s/(2-o-r):s/(o+r),o){case e:i=(n-a)/s+(n<a?6:0);break;case n:i=(a-e)/s+2;break;default:i=(e-n)/s+4;break}i/=6}return{h:i*100,s:l*100,l:c*100}}clamp(e){return Math.max(0,Math.min(255,e))}}class Go{constructor(e){F(this,"target");F(this,"targetHsl");F(this,"reusedColor");this.target=e,this.targetHsl=e.hsl(),this.reusedColor=new Rn(0,0,0)}solve(){const e=this.solveWide(),n=this.solveNarrow(e),a=this.solveAdaptive(n),o=this.colorFromFilters(a.values);return{values:a.values,loss:a.loss,filterValue:this.filterValue(a.values),css:this.css(a.values),colorCss:o.toCssRgb()}}solveWide(){const a=[60,180,18e3,600,1.2,1.2],o=[50,20,3750,50,100,100];let r={loss:Number.POSITIVE_INFINITY,values:o};for(let s=0;s<7&&r.loss>2.5;s+=1){const i=this.spsa(5,a,15,o.slice(),1200);i.loss<r.loss&&(r=i)}return r}solveNarrow(e){let n={...e,values:e.values.slice()};for(let a=0;a<4;a+=1){const o=n.loss,r=2,s=o+1,i=[.25*s,.25*s,s,.25*s,.2*s,.2*s],l=this.spsa(o,i,r,n.values.slice(),600);if(l.loss<n.loss&&(n=l),n.loss<.8)break}return n}solveAdaptive(e){let n={...e,values:e.values.slice()};if(n.loss<=6)return n;const a=n.loss>12?3:2,o=n.loss>12?900:700;for(let r=0;r<a;r+=1){const s=n.loss+1,i=1.5,l=[.22*s,.22*s,.95*s,.22*s,.18*s,.18*s],c=this.spsa(s,l,i,n.values.slice(),o);if(c.loss<n.loss&&(n=c),n.loss<3)break}return n}spsa(e,n,a,o,r){const i=.16666666666666666;let l=Number.POSITIVE_INFINITY,c=o.slice();const u=new Array(6).fill(0),d=new Array(6).fill(0),p=new Array(6).fill(0);for(let h=0;h<r;h+=1){const m=a/Math.pow(h+1,i);for(let C=0;C<6;C+=1)u[C]=Math.random()>.5?1:-1,d[C]=o[C]+m*u[C],p[C]=o[C]-m*u[C];const g=this.loss(d)-this.loss(p);for(let C=0;C<6;C+=1){const x=g/(2*m)*u[C],P=n[C]/Math.pow(e+h+1,1);o[C]=this.fix(o[C]-P*x,C)}const f=this.loss(o);f<l&&(l=f,c=o.slice())}return{values:c,loss:l}}fix(e,n){let a=100;return n===2?a=7500:(n===4||n===5)&&(a=200),n===3?e>a?e%a:e<0?a+e%a:e:Math.max(0,Math.min(a,e))}loss(e){const n=this.colorFromFilters(e),a=n.hsl();return Math.abs(n.r-this.target.r)+Math.abs(n.g-this.target.g)+Math.abs(n.b-this.target.b)+Math.abs(a.h-this.targetHsl.h)+Math.abs(a.s-this.targetHsl.s)+Math.abs(a.l-this.targetHsl.l)}colorFromFilters(e){const n=this.reusedColor;return n.set(0,0,0),n.invert(e[0]/100),n.sepia(e[1]/100),n.saturate(e[2]/100),n.hueRotate(e[3]*3.6),n.brightness(e[4]/100),n.contrast(e[5]/100),n}filterValue(e){return[`invert(${Math.round(e[0])}%)`,`sepia(${Math.round(e[1])}%)`,`saturate(${Math.round(e[2])}%)`,`hue-rotate(${Math.round(e[3]*3.6)}deg)`,`brightness(${Math.round(e[4])}%)`,`contrast(${Math.round(e[5])}%)`].join(" ")}css(e){return`filter: ${this.filterValue(e)};`}}function pn(t){const e=String(t??"").trim();return/^#?[0-9a-f]{3}([0-9a-f]{3})?$/i.test(e)?e.startsWith("#")?e.toUpperCase():`#${e.toUpperCase()}`:e}function jo(t){return t<1?"Resultado excelente.":t<4?"Resultado muy cercano al color objetivo.":t<10?"Resultado bueno, con una ligera desviacion.":"Resultado util, pero algo alejado del color objetivo."}const Cl={Color:Rn,Solver:Go,normalizeHexInputValue:pn,getLossMessage:jo};window.HexToFilterCore=Cl;let mn=!1,Uo=()=>!1;function xl(t){const e=t.querySelector(".target"),n=t.querySelector(".filter-copy-btn"),a=t.querySelector(".target-color-swatch"),o=t.querySelector(".target-color-swatch-fill"),r=t.querySelector(".filter-target-picker"),s=t.querySelector(".filter-tool-feedback"),i=t.querySelector(".filter-code-output"),l=t.querySelector(".lossDetail"),c=t.querySelector(".filterPixel"),u=t.querySelector(".filter-source-icon-after");return!e||!n||!a||!o||!r||!s||!i||!l||!c||!u?null:{textInput:e,copyButton:n,swatchButton:a,swatchFill:o,colorPicker:r,feedback:s,filterCodeOutput:i,lossDetail:l,filterPreviewPixel:c,filterPreviewImage:u,copyTooltip:n.querySelector(".tooltip")}}function za(){var P,I,v,O;if(mn)return;const t=document.getElementById("hex_to_code");if(!t)return;const e=xl(t);if(!e)return;const n=Array.isArray(L.DEFAULT_TARGET_COLORS)?L.DEFAULT_TARGET_COLORS:["#9EBB89"],a=((P=_.getDefaultActiveColor)==null?void 0:P.call(_))||((I=_.getState)==null?void 0:I.call(_).activeColor)||L.DEFAULT_COLOR_BASE||n[0];mn=!0;const o=((v=e.copyTooltip)==null?void 0:v.textContent)??"Copiar CSS a portapapeles";let r=null,s=null,i="";function l(y){const S=pn(y);if(!S)return null;const M=_e.parseCssColor(S);return M?{hex:M.hex,css:M.css,rgb:M.rgb,inputValue:S}:null}function c(){e.textInput.classList.remove("is-invalid"),e.feedback.textContent=""}function u(){e.textInput.classList.add("is-invalid"),e.feedback.textContent="No se ha detectado un color valido. Usa HEX, rgb(), hsl() o un nombre CSS reconocido."}function d(y,S={}){e.swatchFill.style.backgroundColor=y.css,e.colorPicker.value=y.hex,S.publish!==!1&&_.setActiveColor(y.hex,{source:S.source||"hex-to-filter"})}function p(y){const S=l(y);return S&&_e.getReadableTextColor(S.hex)==="#000000"?"var(--primary)":"var(--on-accent)"}function h(){if(!e.copyTooltip)return;const y=i||e.filterPreviewPixel.style.backgroundColor||"var(--accent)",S=p(y);e.copyTooltip.style.setProperty("--tooltip-feedback-bg",y),e.copyTooltip.style.setProperty("--tooltip-feedback-fg",S),e.copyTooltip.textContent="¡Copiado!",e.copyTooltip.classList.add("is-copied-feedback"),e.copyButton.classList.add("show-feedback"),s&&window.clearTimeout(s),s=window.setTimeout(()=>{e.copyTooltip&&(e.copyTooltip.textContent=o,e.copyTooltip.classList.remove("is-copied-feedback"),e.copyButton.classList.remove("show-feedback"),e.copyTooltip.style.removeProperty("--tooltip-feedback-bg"),e.copyTooltip.style.removeProperty("--tooltip-feedback-fg"))},1400)}function m(y){i=y.colorCss,e.filterCodeOutput.textContent=y.css,e.lossDetail.textContent=`Loss: ${y.loss.toFixed(1)}. ${jo(y.loss)}`,e.filterPreviewPixel.style.backgroundColor=y.colorCss,e.filterPreviewImage.style.filter=y.filterValue}function g(y={}){const S=y.normalizedColor||l(e.textInput.value);if(!S)return u(),null;e.textInput.value!==S.inputValue&&(e.textInput.value=S.inputValue),c(),d(S,y);const M=new Rn(S.rgb[0],S.rgb[1],S.rgb[2]),j=new Go(M).solve();return m(j),j}function f(y,S={}){const M=l(y);return M?(e.textInput.value=M.inputValue,!!g({normalizedColor:M,publish:S.publish,source:S.source})):!1}function C(){r&&window.clearTimeout(r),r=window.setTimeout(()=>{const y=l(e.textInput.value);y&&g({normalizedColor:y})},220)}Uo=f,e.textInput.addEventListener("input",()=>{const y=l(e.textInput.value);y&&(e.textInput.value!==y.inputValue&&(e.textInput.value=y.inputValue),c(),d(y,{publish:!1}),C())}),e.textInput.addEventListener("blur",()=>{const y=pn(e.textInput.value);y&&e.textInput.value!==y&&(e.textInput.value=y)}),e.textInput.addEventListener("keydown",y=>{y.key==="Enter"&&(y.preventDefault(),g())}),e.swatchButton.addEventListener("click",()=>{if(typeof e.colorPicker.showPicker=="function"){e.colorPicker.showPicker();return}e.colorPicker.click()}),e.colorPicker.addEventListener("input",()=>{const y=e.colorPicker.value.toUpperCase();f(y,{source:"hex-to-filter"})}),e.copyButton.addEventListener("click",async()=>{var y;try{await Ya.writeText(((y=e.filterCodeOutput.textContent)==null?void 0:y.trim())||""),h()}catch{}}),e.textInput.value=a,e.colorPicker.value=a;const x=l(e.textInput.value)||l(a);x&&g({normalizedColor:x,publish:!1}),(O=_.subscribe)==null||O.call(_,(y={})=>{const{type:S,state:M,metadata:$}=y;S!=="activeColor"||!(M!=null&&M.activeColor)||($==null?void 0:$.source)!=="hex-to-filter"&&f(String(M.activeColor),{publish:!1})})}function bl(){const t={initialize:za,setTargetColor(e){return mn||za(),Uo(e,{source:"hex-to-filter"})}};return window.HexToFilterApp=t,gn.register("hex-to-filter",t),t}function yl(t){if(document.querySelector(`script[data-legacy-script="${t.id}"]`))return;const e=document.createElement("script");e.type="text/javascript",e.dataset.legacyScript=t.id,e.text=`${t.code}
//# sourceURL=${t.id}`,document.body.appendChild(e)}function Pl(t){t.forEach(yl)}const Sl=`// COLOR NAMES CUSTOM LIST
...
`,Al=`\uFEFF// Palette generator core: shared state helpers, adjustments, scoring and commit flow.
...
`,Ml=`// Palette generator image analysis: sampling, clustering and derived candidates.
...
`,vl=`function getImageBasedCandidateColor(
...
`,Bl=`function getRandomSteppedValue(min = 0, max = 100, step = 5) {
...
`,Tl=`// Palette generator color mode: color parsing, harmony rules and generation.
...
`,El=`function setPaletteAdjustPanelOpen(shouldOpen) {
...
`,Ll=`// Palette generator card helpers: color utilities, accessibility and shared button UI.
...
`,Rl=`// Palette generator card naming and palette copy helpers.
...
`,Ol=`// Palette generator card actions and card DOM wiring.
...
updateHistoryNavigationButtons();
`,kl=`// Public API for the palette generator mini-app.
...
`,zl=[{id:"shared-color-names.js",code:Sl},{id:"palette-generator-state.js",code:Il},{id:"palette-generator-core.js",code:Al},{id:"palette-generator-image-analysis.js",code:Ml},{id:"palette-generator-image-palette.js",code:vl},{id:"palette-generator-temperature.js",code:Bl},{id:"palette-generator-color-mode.js",code:Tl},{id:"palette-generator-image-ui.js",code:El},{id:"palette-generator-controls.js",code:wl},{id:"palette-generator-card-helpers.js",code:Ll},{id:"palette-generator-card-names.js",code:Rl},{id:"palette-generator-cards.js",code:Ol},{id:"palette-generator-history.js",code:Hl},{id:"palette-generator-app.js",code:kl}];function Fl(){const e=document.getElementById("footerYear");if(!e)return;const n=new Date().getFullYear();e.textContent=n===2026?String(2026):`2026–${n}`}async function Nl(){hl(),gl(),bl(),Pl(zl),fl()}function Fa(){Fl(),Nl()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Fa,{once:!0}):Fa();
